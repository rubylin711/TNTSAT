...
#mfrs_cfg_all="symphony6_32user_32kernel.cfg symphony6_32user_32kernel_tee.cfg symphony6_32user_32kernel_tee_gst.cfg"
#mfrs_cfg_all="symphony6_32user_32kernel_gst.cfg symphony6_32user_32kernel_tee_gst.cfg"
mfrs_cfg_all="symphony6_32user_32kernel_tee_gst.cfg"
cfg_path="product/configs"

for mfrs_cfg in ${mfrs_cfg_all}; do

	#20260210: fix "jenkins" effect "symphony6_32user_32kernel_tee_loader.cfg" compile check issue!
	if [ "${mfrs_cfg}" = "symphony6_32user_32kernel_tee_loader.cfg" ]; then
