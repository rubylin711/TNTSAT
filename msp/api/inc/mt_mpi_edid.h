...
#ifndef __MT_MPI_EDID_H__
#define __MT_MPI_EDID_H__
...
#define MT_FATAL_EDID(fmt...) \
            MT_FATAL_PRINT(MT_ID_EDID, fmt)

#define MT_ERR_EDID(fmt...) \
            MT_ERR_PRINT(MT_ID_EDID, fmt)

#define MT_WARN_EDID(fmt...) \
            MT_WARN_PRINT(MT_ID_EDID, fmt)

#define MT_INFO_EDID(fmt...) \
            MT_INFO_PRINT(MT_ID_EDID, fmt)

#define MT_DBG_EDID(fmt...) \
                        MT_DBG_PRINT(MT_ID_EDID, fmt)
...
typedef struct tagEDID_CUSTOMER_TIMING_S		/* EDID CUSTOMER DEFINE TIMING*/
{
    ...
    mt_u32 u32DetailTimingNum;
    EDID_STEREO_VIEWING_TYPE_E   enStereoType;
    MT_UNF_EDID_DETAIL_TIMING_S stDetailTiming;
} EDID_DETAIL_TIMING_S;

typedef struct EDID_SIMPLE_TIMING_S
{
    struct list_head    head;
    MT_UNF_EDID_SIMPLE_TIMING_S stSimpleTiming;
...
typedef struct tagEDID_COLOR_CHARA_S				/* Color characteristics */
{
    mt_float floatRedX;
    mt_float floatRedY;
    mt_float floatGreenX;
    mt_float floatGreenY;
    mt_float floatBlueX;
    mt_float floatBlueY;
    mt_float floatWhiteX;
    mt_float floatWhiteY;
} EDID_COLOR_CHARA_S;

typedef struct tagEDID_SIGNAL_INFO_OTHER_S		/* Basic Display Parameters */
{
    MT_BOOL bBlank2Black;						/*display expects a blank-to-black setup*/
    MT_BOOL bSeparateSyncs;
    MT_BOOL bCompositeSync;
    MT_BOOL bGreenSync;							/*sync. on green video*/
    MT_BOOL bSerrationVsyncs;					/*serration of the Vsync.*/
    MT_BOOL bStandby;							/*bSuspend supported*/
    MT_BOOL bSuspend;							/*bSuspend supported*/
    MT_BOOL bActiveOff;							/*Active Off/Very Low Power*/
    MT_BOOL bsRGB;								/*Standard Default Color Space, sRGB*/
    MT_BOOL bPreferredTiming;					/*Preferred Timing*/
    MT_BOOL bDefaultGTF;						/*Default GTF supported*/
...
typedef struct tagEDID_BASE_PARA_S					/* Basic Display Parameters */
{
    ...
    mt_u8                               u32ImgeWMax;/*unit : cm*/
    mt_u8                               u32ImgeHMax;/*unit : cm*/
    mt_u32                            u32Gamma;   /*value*100 */
...
{
    mt_char	cMfName[3];						/*Manufacturer name*/
    mt_u16	u16ProductCode;
    mt_u32	u32SerialNum;		                            /* FIXME: byte order */
    mt_u8	u32MfWeek;
    mt_u32	u32MfYear;
    mt_char* pMonitorName;						/*monitor name*/
    mt_char*	pMonitorSerialNum;						/*monitor Serial number*/
...
{
    mt_u8                           u8Version;	    	/* Version Number: Set to 0x03 */
    mt_u16                          u16PixelsPerLine;           /*Maximum Active Pixels per Line*/
    mt_u8                           u8ARSupport;         /*Support Aspect Ratios*/
    mt_u8                           u8ScalingSupport;    /*Type of Display Scaling Supported*/
...
{
    mt_u16 u32VFreqMin_KHz;
    mt_u16 u32VFreqMax_KHz;
    mt_u16 u32HFreqMin_KHz;
    mt_u16 u32HFreqMax_KHz;
    mt_u32 u32PixClkMax_KHz;
...
typedef struct tagEDID_DETAILED_COLOR_POINT_S
{
    mt_float            floatWhiteX;
    mt_float            floatWhiteY;
    mt_float            floatGamma;								/* need to divide by 100 then add 1 */
...
{
    mt_u8 u8HSize;										/* need to multiply by 8 then add 248 */
    mt_u8 u8VfreqAspect;
...
typedef struct tagEDID_VIDEO_TIMING_S
{
    ...
    MT_UNF_EDID_TIMING_ATTR_E            enTimingAttr;
...
typedef struct tagEDID_AUDIO_S
{
    ...
    mt_u8 u8AudioChannel;                                /*audio_channel*/
    mt_u8 u8SampleRate;                                  /*sample rate*/
    mt_u8 u8SampleDepth;                                    /*sample bit depth*/
    mt_u16 u16BitRateMax;                             /*enter max bit rate*/
...
{
    MT_BOOL bSupportUnderScan;						/*sUnderscan is supported*/
    MT_BOOL bSupportAudiob;						    /*Basic Audio is supported*/
    MT_BOOL bSupportYPbPr444;						    /*supported YPbPr4:4:4*/
    MT_BOOL bSupportYPbPr422;						    /*supported YPbPr4:2:2*/

} EDID_NATIVE_FORMATS_S;

typedef struct tagEDID_LATENCY_PRESENT_S
{
    mt_u16  u16VideoLatency;     /**/
    mt_u16  u16AudioLatency;     /**/
...
typedef struct tagEDID_HDMI_PRESENT_S
{
    ...
    mt_u8   u8HDMI_3DLen;    /**/
    mt_u8   u8HDMI_VICLen;   /**/
    mt_u8*   pu8Data;        /*HDMI present EDID data address*/
...
{
    MT_BOOL                         bDVI_Dual;		/*Sink supports DVI dual-link operation*/
    MT_BOOL                         bDC_Y444;		/*Sink supports YCBCR 4:4:4 in Deep Color modes*/
    MT_BOOL                         bDC_30bit;		/*Sink supports 30 bits/pixel (10 bits/color)*/
    MT_BOOL                         bDC_36bit;		/*Sink supports 30 bits/pixel (12 bits/color)*/
    MT_BOOL                         bDC_48bit;		/*Sink supports 30 bits/pixel (16 bits/color)*/
    MT_BOOL                         bSupportsAI;	/*Sink supports ACP/ISRC1 or ISRC2 packets*/
    mt_u16                          u16TMDS_ClkMax;	/*maximum TMDS clock MHz*/
    MT_BOOL                         bCNC[4];         /*CNC0: Graphics; CNC1: Photo; CNC2: Cinema; CNC3: Game ; */
...
typedef struct tagEDID_EXTENSION_INFO
{
    ...
    mt_u8                           u8Version;
    mt_u16                          u16CEC_ID;
    mt_u16                          u8DetailedTimingNum;
    EDID_NATIVE_FORMATS_S    stNativeFormats;
    mt_u32							u32Speaker;             /*supported  u32Speaker*/
...
{
    MT_UNF_EDID_VIDEO_PORT_E        enVideoPort;                  /*gear into video port  */
    
    EDID_SIMPLE_TIMING_S*			pstSimpleTimingList;	/* Est. stTimings and mfg rsvd stTimings*/
    mt_u32                          u32SimpleTimingNum; 
...
mt_s32 MT_MPI_EDID_EdidParse(mt_u8 *u8Edid, mt_u32 u32EdidLength, EDID_INFO_S *pEdidInfo);
