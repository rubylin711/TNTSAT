...
#ifndef __MT_GO_WINC_H__
#define __MT_GO_WINC_H__
...
typedef enum
{
    MTGO_BUFFER_SINGLE = 0,  /**<The window uses a buffer.*//**<CNcomment:window使用单buffer*/
    MTGO_BUFFER_DOUBLE,     /**<The window uses dual buffers.*/ /**<CNcomment:window使用双buffer*/
    MTGO_BUFFER_BUTT
}MTGO_BUFFERTYPE_E;

/**Maximum number of window layers*//** CNcomment: 最大窗口层数 */
#define MTGO_WINTREE_NUM 16

typedef struct
{
    mt_handle hLayer; /**<Graphics layer on which a window is displayed*//**<CNcomment:窗口显示的图层*/
    MT_RECT rect;     /**<Window range*//**<CNcomment:窗口的范围*/
    mt_u32 LayerNum;     /**<Display level of a window, ranging from 0 to 15. The greater the number, the upper the position of the window.*//**<CNcomment:窗口显示的级别,序号为0-15。数字越大的窗口越在上面*/         
    MTGO_PF_E PixelFormat;/**<Pixel format of a window*//**<CNcomment:窗口的像素格式*/
    MTGO_BUFFERTYPE_E BufferType; /**<Number of surface buffers required by a window*/ /**<CNcomment:窗口需要的surface buffer个数的设置*/ 
    MT_BOOL bPubPallette;    /**<Window surface use single Palette or not*//**<CNcomment:窗口的surface是否使用单独的Palette;只有当窗口
                                            的内存模式为独立内存时该标志才有效*/
} MTGO_WNDINFO_S;
...
typedef enum
{
     MTGO_WNDMEM_SHARED = 0,  /**<All windows share memory*//**<CNcomment:所有window共享内存*/
     MTGO_WNDMEM_SEP,          /**<Window uses it's own memory*//**<CNcomment:单独使用一块内存*/
    MTGO_WNDMEM_BUTT,
}MTGO_WNDMEM_E;

typedef struct tag_MTGO_INVRGNLIST_S
{
    mt_handle hWindow;
    MT_REGION InvRgn;
}MTGO_INVRGN_S;
...
\retval ::MTGO_ERR_INVPF

\see \n
::MT_GO_DestroyWindow
*/
mt_s32 MT_GO_CreateWindowEx(const MTGO_WNDINFO_S* pInfo, mt_handle* pWindow);
...
::MT_GO_DestroyWindow
*/
mt_s32 MT_GO_CreateWindow(mt_handle hLayer, const MT_RECT* pRect,
                          mt_u32 LayerNum, MT_BOOL bHasPixelAlpha,
                          mt_handle* pWindow,MTGO_BUFFERTYPE_E eBufferType);
...
::MT_GO_CreateWindow
*/
mt_s32 MT_GO_DestroyWindow(mt_handle Window);
...
::MT_GO_ResizeWindow
*/
mt_s32 MT_GO_GetWindowRect(mt_handle Window, MT_RECT* pRect);
...
::MT_GO_GetWindowRect
*/
mt_s32 MT_GO_SetWindowPos(mt_handle Window, mt_s32 StartX, mt_s32 StartY);
...
::MT_GO_GetWindowRect
*/
mt_s32 MT_GO_ResizeWindow(mt_handle Window, mt_s32 Width, mt_s32 Height);
...
\see \n
::MT_GO_ChangeWindowZOrder
*/
mt_s32 MT_GO_GetWindowZOrder(mt_handle Window, mt_u32* pZOrder);
...
\retval ::MTGO_ERR_INVPARAM
\retval ::MTGO_ERR_INVHANDLE
\retval ::MTGO_ERR_INVZORDERTYPE
\retval ::MTGO_ERR_LOCKED

\see \n
::MT_GO_GetWindowZOrder
*/
mt_s32 MT_GO_ChangeWindowZOrder(mt_handle Window, MTGO_ZORDER_E EnType);
...
\see \n
::MT_GO_SetWindowOpacity
*/
mt_s32 MT_GO_GetWindowOpacity(mt_handle Window, mt_u8* pOpacity);
...
\see \n
::MT_GO_GetWindowOpacity
*/
mt_s32 MT_GO_SetWindowOpacity(mt_handle Window, mt_u8 Opacity);
...
N/A.CNcomment:无 CNend
*/
mt_s32 MT_GO_SetWindowColorkey(mt_handle Window, MT_COLOR ColorKey);

/**
\brief Obtains the surface handle of a window.CNcomment:获取窗口的surface句柄 CNend
\attention \n
If the window has dual buffers and you have called MT_GO_FlipWindowSurface, you need to call MT_GO_GetWindowSurface 
again to obtain another buffer for drawing.
CNcomment:如果是双buffer的window，MT_GO_FlipWindowSurface之后需要重新调用该接口，从而获取另外一块buffer进行绘制 CNend
...
\see \n
::MT_GO_FlipWindowSurface \n
*/
mt_s32 MT_GO_GetWindowSurface(mt_handle Window, mt_handle* pSurface);
...
N/A.CNcomment:无 CNend
*/
mt_s32 MT_GO_UpdateWindow(mt_handle Window, const MT_RECT* pRect);
...
N/A.CNcomment:无 CNend
*/
mt_s32 MT_GO_ChangeWindowLayer(mt_handle hWindow, mt_handle hNewLayer);
...
mt_s32 MT_GO_FlipWindowSurface(mt_handle hWindow);
    
/**
\brief Set window memory mode. CNcomment:设置窗口的内存模式 CNend
\attention \n
Must set the mode before Window create,Default mode is MTGO_WNDMEM_SEP.
...
N/A.CNcomment:无 CNend
*/
mt_s32 MT_GO_SetWindowMode(MTGO_WNDMEM_E enMode);
...
N/A.CNcomment:无 CNend
*/
mt_s32 MT_GO_GetWindowMode(MTGO_WNDMEM_E *penMode);

/**
\brief Get clip region of window. CNcomment:获取窗口的剪切域 CNend
\attention \n
In MTGO_WNDMEM_SHARED mode, Can use this API to get window clip region, and to draw. 
...
N/A.CNcomment:无 CNend
*/
mt_s32 MT_GO_GetWindowClipRgn(mt_handle hWindow,  MT_REGION **ppClipRgn, 
    mt_u32 *pu32Num);
...
N/A.CNcomment:无 CNend
*/ 
mt_s32 MT_GO_GetWindowInvRgn(mt_handle hWindow, MTGO_INVRGN_S **ppInvRgn, 
    mt_u32 *pu32Num);
/** @} */  /*! <!-- API declaration end */
