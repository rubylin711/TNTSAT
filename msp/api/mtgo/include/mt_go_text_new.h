...
/** \addtogroup      MTGO_TEXT */
/** @{ */ /** <!—[MTGO_TEXT] */

#define LAYOUT_LEFT MTGO_LAYOUT_LEFT /**<Horizontally left*/                      /**<CNcomment:水平居左*/
#define LAYOUT_RIGHT MTGO_LAYOUT_RIGHT /**<Horizontally right*/                   /**<CNcomment:水平居右*/
#define LAYOUT_HCENTER MTGO_LAYOUT_HCENTER /**<Horizontally center*/              /**<CNcomment:水平居中*/
#define LAYOUT_TOP MTGO_LAYOUT_TOP /**<Vertically top*/                           /**<CNcomment:垂直居顶*/
#define LAYOUT_BOTTOM MTGO_LAYOUT_BOTTOM /**<Vertically bottom*/                  /**<CNcomment:垂直居底*/
#define LAYOUT_VCENTER MTGO_LAYOUT_VCENTER /**<Vertically center*/                /**<CNcomment:垂直居中*/
#define LAYOUT_WRAP MTGO_LAYOUT_WRAP /**<Wrap*/                                   /**<CNcomment:自动换行*/
#define LAYOUT_WORDELLIPSIS MTGO_LAYOUT_WORDELLIPSIS /**<Ellipsis format*/        /**<CNcomment:使用省略号风格*/
#define LAYOUT_FORCE_LEFT MTGO_LAYOUT_FORCE_LEFT /**<Force Horizontally left*/    /**<CNcomment:强制水平居左*/
#define LAYOUT_FORCE_RIGHT MTGO_LAYOUT_FORCE_RIGHT /**<Force Horizontally right*/ /**<CNcomment:强制水平居右*/

/** */
typedef enum {
    MTGO_LAYOUT_LEFT = 0x0001,
    MTGO_LAYOUT_RIGHT = 0x0002,
    MTGO_LAYOUT_HCENTER = 0x0004,
    MTGO_LAYOUT_WRAP = 0x0008,
    MTGO_LAYOUT_WORDELLIPSIS = 0x0010,
    MTGO_LAYOUT_TOP = 0x0100,
    MTGO_LAYOUT_BOTTOM = 0x0200,
    MTGO_LAYOUT_VCENTER = 0x0400,
    MTGO_LAYOUT_FORCE_LEFT = 0x8000,
    MTGO_LAYOUT_FORCE_RIGHT = 0x10000,
    MTGO_LAYOUT_BUTT = 0x20000,
} MTGO_LAYOUT_E;
...
typedef enum {
    ...
    MTGO_CHARSET_UTF8,
    MTGO_CHARSET_UTF16,
    MTGO_CHARSET_UCS2 = MTGO_CHARSET_UTF16,
    MTGO_CHARSET_UTF32,
    MTGO_CHARSET_BUTT,
} MTGO_CHARSET_E;
...
typedef enum {
    MTGO_TEXT_DIR_NEUTRAL = 0,
    /**<neutral deirction*/ /**<CNcomment:中性方向，按内容查找强字符方向*/
    MTGO_TEXT_DIR_LTR,
    /**<Left to right*/ /**<CNcomment:从左到右方向 */
    MTGO_TEXT_DIR_RTL,
    /**<Right to left*/ /**<CNcomment:从右到左方向 */
    MTGO_TEXT_DIR_BUTT
} MTGO_TEXT_DIR_E;

typedef struct
{
    MTGO_CHARSET_E Charset; /**<Character set name*/ /**<CNcomment:字符集名称 */
    mt_u8 Height; /**<Font height*/                  /**<CNcomment:字体高度 */
    mt_u8 MaxWidth; /**<Maximum font width*/         /**<CNcomment:字体最大宽度 */
} MTGO_FONTATTR_S;

/** Attributes of a text output object*/ /** CNcomment: 文本输出对像属性 */
typedef struct
{
    MT_COLOR BgColor; /**<Background color*/                                           /**<CNcomment:背景色 */
    MT_COLOR FgColor; /**<Foreground color*/                                           /**<CNcomment:前景色 */
    MTGO_FONTATTR_S SbFontAttr; /**<Font attributes of the single-byte character set*/ /**<CNcomment:单字节字符集字体属性 */
    MTGO_FONTATTR_S MbFontAttr; /**<Font attributes of the multi-byte character set*/  /**<CNcomment:多字节字符集字体属性 */
} MTGO_TEXTOUTATTR_S;
...
::MT_GO_DestroyText
*/
mt_s32 MT_GO_CreateText(const mt_char *pSbFontFile, const mt_char *pMbFontFile, mt_handle *pTextOut);
...
\retval ::MT_SUCCESS
\retval ::MTGO_ERR_INVHANDLE
\retval ::MTGO_ERR_UNSUPPORT_CHARSET

\see \n
::MT_GO_CreateText
*/
mt_s32 MT_GO_SetInputCharSet(mt_handle TextOut, MTGO_CHARSET_E CharSet);
...
MT_TRUE, the background color is not displayed. The default value is MT_TRUE.CNcomment:文本输出对象背景色是否显示，为MT_TRUE, 则不显示，默认为MT_TRUE CNend
...
N/A.CNcomment: 无 CNend
*/
mt_s32 MT_GO_GetTextExtentEx(mt_handle TextOut, const mt_char *pText,
                             const MT_RECT *pRect, mt_u32 *pLen);

typedef enum {
    MTGO_TEXT_STYLE_NORMAL = 0x00,
    /*Normal font*/ /**<CNcomment:正常字体*/
    MTGO_TEXT_STYLE_ITALIC = 0x01,
    /*Italic font*/ /**<CNcomment:斜体字体*/
    MTGO_TEXT_STYLE_BOLD = 0x02,
    /*Bold font*/ /**<CNcomment:粗体字体*/
    MTGO_TEXT_STYLE_BUTT = 0x80,
} MTGO_TEXT_STYLE_E;

typedef struct
{
    const mt_char *pSbcFontFile;
    const mt_char *pMbcFontFile;
    mt_u32 u32Size; /*This value is ignored for the dot-matrix font.*/ /**<CNcomment:如果是点阵字体，则该值被忽略*/
} MTGO_TEXT_INFO_S;
...
\retval ::MT_SUCCESS A font is created successfully.CNcomment:字体创建成功 CNend
\retval ::MT_FAILURE A font fails to be created.CNcomment:字体创建失败 CNend
\retval ::MTGO_ERR_INVPARAM
\retval ::MTGO_ERR_NOMEM
\retval ::MTGO_ERR_INVHANDLE
...
\retval ::MT_SUCCESS Success.CNcomment: 成功 CNend
\retval ::MTGO_ERR_INVHANDLE Failure.CNcomment:失败 CNend

\see \n
N/A.CNcomment:无 CNend
*/

mt_s32 MT_GO_SetBaseDir(mt_handle TextOut, MTGO_TEXT_DIR_E eBaseDir);
/** 
...
N/A.CNcomment:无 CNend
*/
mt_s32 MT_GO_SetLineExtra(mt_handle hText, mt_u32 u32Distance);
...
\param N/A.CNcomment:无 CNend
\retval ::MT_SUCCESS Success.CNcomment:成功 CNend
\retval ::MTGO_ERR_NOTINIT Failure.CNcomment:失败 CNend
