...
extern const MTGO_BITFIELD_S s_BitField[12] ;
#else
...
struct _MTGO_LAYER_ADP_S
{
	...
	mt_s32  (*SetLayerSurface)(mt_handle LayerID, const MTGO_SURFACE_S *pSurface, MT_RECT *pRect);  /**刷新图层CANVAS BUFFER*/
    mt_s32  (*SetLayerSurface_Zoom)(mt_handle Layer, const MTGO_SURFACE_S *pSurface, MT_RECT *pRect, MT_RECT *pZoomRect); /**刷新图层CANVAS BUFFER到指定区域*/

	mt_s32  (*GetCanvasSurface)(mt_u32 LayerID, const MTGO_LAYER_INFO_S *pLayerInfo, mt_handle *pSurface); /**获取图层CANVAS BUFFER*/
	mt_s32 (*FreeCanvasSurface)(mt_handle Surface);
...
//    mt_s32  (*GetLayerShowState)(mt_u32 LayerID, MT_BOOL *pbVisbile);/**< 显示图层*/ 
   ...
   // mt_s32  (*GetPalette)(mt_u32 LayerID, HI_PALETTE pPalette);/**< 设置调色板 */
    ...
    mt_s32  (*SetLayerPalette)(mt_u32 LayerID, mt_u32 *pPalette, mt_u32 u32Start, mt_u32 u32Len); /**< 设置PALETTE函数 */
    mt_u32  LayerCount;
    mt_s32 (*WaitSync)(mt_void);
#endif    
};
