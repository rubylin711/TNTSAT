   ...
   extern "C" 
{
	...
	* others:	    : NA
	*****************************************************************************/
	mt_void JPEG_HDEC_WriteReg(volatile mt_char *pJpegRegVirAddr, const mt_s32 s32PhyOff, const mt_s32 s32Val);
	...
	* others:	    : NA
	*****************************************************************************/
	mt_s32 JPEG_HDEC_ReadReg(const volatile mt_char *pJpegRegVirAddr, const mt_s32 s32PhyOff);
	...
	* others:	    : NA
	*****************************************************************************/
	mt_void JPEG_HDEC_CpyData2Reg(volatile mt_char *pJpegRegVirAddr,const mt_void *pInMem,const mt_s32 s32PhyOff,const mt_u32 u32Bytes);
