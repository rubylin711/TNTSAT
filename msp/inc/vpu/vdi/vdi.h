...
int vdi_open_hw(unsigned long coreIdx);
int vdi_close_hw(unsigned long coreIdx);
...
int vdi_read_register_countdown(unsigned long coreIdx, unsigned int addr, unsigned int breakCond, unsigned int *val, unsigned int countdown);
int vdi_set_timing_opt(unsigned long core_idx);
int vdi_set_clock_freg(unsigned long core_idx, int Device, int OutFreqMHz);
int vdi_get_dma_memory_free_size(unsigned long coreIdx);
