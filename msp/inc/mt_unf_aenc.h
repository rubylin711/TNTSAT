...
#ifndef  __MT_UNF_AENC_H__
#define  __MT_UNF_AENC_H__
...
\attention \n
Call the interface before calling MT_UNF_AENC_Open. CNcomment:MT_UNF_AENC_Open接口前调用 CNend
\param N/A
...
N/A
\param N/A
\retval ::MT_ERR_AENC_CH_NOT_SUPPORT  Invalid operation CNcomment:MT_ERR_AENC_CH_NOT_SUPPORT 无效的操作 CNend
\retval ::MT_SUCCESS Success CNcomment:成功 CNend
\see \n
N/A
*/
...
\retval ::MT_SUCCESS Success CNcomment:成功 CNend
\retval ::MT_FAILURE Failure CNcomment:失败 CNend
\retval ::MT_ERR_AENC_NULL_PTR        The pointer is null. CNcomment:指针为空 CNend
\retval ::MT_ERR_AENC_CREATECH_FAIL   The encoder fails to be created. CNcomment:创建编码器失败 CNend
\see \n
N/A
*/
...
\retval ::MT_SUCCESS Success CNcomment:成功 CNend
\retval ::MT_ERR_AENC_CH_NOT_SUPPORT  The operation is invalid. CNcomment:无效的操作 CNend
\retval ::MT_ERR_AENC_INVALID_PARA    The parameter is invalid. CNcomment:无效的参数 CNend
\retval ::MT_ERR_AENC_CH_NOT_OPEN     The audio encoder is not opened. CNcomment:音频编码器没有打开 CNend
\see \n
N/A
*/
...
\retval ::MT_SUCCESS  Success CNcomment:成功 CNend
\retval ::MT_ERR_AENC_IN_BUF_FULL      The input buffer of the encoder is full. CNcomment:编码器输入缓冲满 CNend
\retval ::MT_ERR_AENC_INVALID_PARA     The parameter is invalid. CNcomment:无效的参数 CNend
\retval ::MT_ERR_AENC_CH_NOT_SUPPORT   The operation is invalid. CNcomment:无效的操作 CNend
\see \n
N/A
...
\retval ::MT_SUCCESS  Success CNcomment:成功 CNend
\retval ::MT_ERR_AENC_INVALID_PARA    The parameter is invalid. CNcomment:无效的参数 CNend
\retval ::MT_ERR_AENC_OUT_BUF_EMPTY   The output buffer of the encoder is empty. CNcomment:编码器输出缓冲为空 CNend
\retval ::MT_ERR_AENC_CH_NOT_SUPPORT  The operation is invalid. CNcomment:无效的操作 CNend
\see \n
N/A
*/
...
\attention \n
Call the interface after calling MT_UNF_AENC_ReceiveStream. CNcomment:在MT_UNF_AENC_ReceiveStream之后调用 CNend
...
\retval ::MT_SUCCESS  Success CNcomment:成功 CNend
\retval ::MT_ERR_AENC_INVALID_PARA   The parameter is invalid. CNcomment:无效的参数 CNend
\retval ::MT_ERR_AENC_OUT_BUF_BAD    The parameter is invalid. CNcomment:无效的参数 CNend
\retval ::MT_ERR_AENC_IN_BUF_UNEMPTY The input buffer is empty. CNcomment:输入缓冲非空 CNend
\retval ::MT_ERR_AENC_CH_NOT_SUPPORT The operation is invalid. CNcomment:无效的操作 CNend
\see \n
N/A
*/
...
N/A
*/
mt_s32 MT_UNF_AENC_RegisterEncoder(const mt_char *pEncoderDllName);
