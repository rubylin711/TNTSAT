...
#include <asm/arch-symphony6/mt_analog.h>
...
#ifndef CONFIG_TARGET_SYMPHONY6_LITE
...
{
	{0, 700, MT_USBPLL},		/* clk_usbpll_d7, 411.4MHz */
	{1, 250, MT_CLK_DDRPHY},	/* ddrphy 1/2.5 */
	{2, 275, MT_CLK_DDRPHY},	/* ddrphy 1/2.75 */
	{3, 300, MT_CLK_DDRPHY},	/* ddrphy 1/3 */
	{4, 350, MT_CLK_DDRPHY},	/* ddrphy 1/3.5 */
	{5, 600, MT_USBPLL},		/* clk_usbpll_d6, 480MHz (Only for test) */	/* A0 */
...
{
	{0, 200, MT_USB30PLL},	/* clk_usb30_rx_clk_d2, 125M */
...
{
	{0, 810000000},		/* clk_vsdpll_d4, reserved */
...
static struct mt_clk_map_table g_spi_high_rate[] =
{
	...
	{1, 160000000},			/* clk_usbpll_d18 */
	{2, 576000000},			/* clk_usbpll_d5 */
	{3, 720000000},			/* clk_usbpll_d4 */
	{4, 810000000},			/* clk_vsdpll_d4 */
...
static struct mt_clk_map_table g_pnand_high_rate[] =
{
	...
	{1, 640000000},			/* clk_usbpll_d4p5, reserved */
...
{
	{0, 667000000},			/* clk_ethpll_d3, reserved */
	{1, 615380000},			/* clk_ethpll_d3p25, reserved */
	{2, 576000000},			/* clk_usbpll_d5, MAX */
	{3, 500000000},			/* clk_ethpll_d4 */
	{4, 480000000}, 		/* clk_usbpll_d6 */
	{5, 360000000}, 		/* clk_usbpll_d8, default */
...
static struct mt_clk_map_table g_disposdc_rate[] =
{
	...
	{1, 247500000},		/* clk_vhdpll_d12 */
	{2, 206000000},		/* clk_usbpll_d14 */
	{3, 144000000},		/* clk_usbpll_d20 */
	{-1, -1}
};
...
static struct mt_clk_map_table g_dispdi_rate[] =
{
	...
	{3, 0, TOP_DISP_XTAL_MUX},		/* <CN>Òþº¬¾§Õñ */
	{-1, -1}
};
...
static struct mt_clk_map_table g_dispcore_rate[] =
{
	...
	{4, 130000000},		/* clk_usbpll_d22 */
	//{5, 60000000},		/* clk_usbpll_d48, <CN>Òþº¬¾§Õñ */
	{5, 0, TOP_DISP_XTAL_MUX},		/* clk_usbpll_d48, <CN>Òþº¬¾§Õñ */
	{-1, -1}
};
...
static struct mt_clk_map_table g_aout_rate[] =
{
	...
	{2, 206000000},		/* clk_usbpll_d14, 205714286 */
	//{3, 131000000},		/* clk_usbpll_d22, 130909091, <CN>Òþº¬¾§Õñ */
	{3, 0, TOP_AOUT_XTAL_MUX},		/* clk_usbpll_d22, <CN>Òþº¬¾§Õñ */
	{-1, -1}
};
...
{
	{0, 720000000},		/* clk_usbpll_d4, reserved */
	{1, 667000000},		/* clk_ethpll_d3, reserved */
	{2, 615380000},		/* clk_ethpll_d3p25, reserved */
	{3, 576000000},		/* clk_usbpll_d5 */
	{4, 480000000},		/* clk_usbpll_d6 */
	{5, 360000000},		/* clk_usbpll_d8, default */
	{6, 288000000},		/* clk_usbpll_d10 */	/* A0 */
	//{7, 120000000},		/* clk_usbpll_d24, <CN>Òþº¬¾§Õñ */
...
{
	{0, 400000000},		/* clk_ethpll_d5, reverved */
	{1, 320000000},		/* clk_usbpll_d9 */
	{2, 262000000},		/* clk_usbpll_d11 */
	//{3, 131000000},		/* clk_usbpll_d22, <CN>Òþº¬¾§Õñ */
...
{
	{0, 400000000},		/* clk_ethpll_d5, reserved */
	{1, 360000000},		/* clk_usbpll_d8, reserved */
	{2, 320000000},		/* clk_usbpll_d9, Max */
...
struct mt_clk_in mt_clk_table[] =
{
	...
	/* AXI */
	{
		...
		.flags = FLAG_CLK_DIV,
		/* A0 */
		.gate = MT_INIT_GATE(REG_SYS_CLKEN, 0,
							REG_SYS_SLOCK, REG_SYS_LOCK, 0),
...
/* A0 */
	...
	/* usb0_dig_clk */
	{
		.name = "usb0_dig_clk", 	/* Hide */
		.flags = FLAG_CLK_NONE,
		.gate = MT_INIT_GATE(REG_INTF_CLKEN, 13,
							REG_INTF_SLOCK, REG_INTF_LOCK, USB0_CLKEN_LOCK_SHIFT)
	},
#endif
	/* usb0_core_clk */
	{
		.name = USB0_CORE_CLK, 		/* Hide */
		.flags = FLAG_CLK_RATE,
		.gate = {0},
...
/* A0 */
		...
		.gate = {0},
#else
		.gate = MT_INIT_GATE(REG_VOUT_CLKEN, 4,
...
/* A0 */
	...
	/* DAI */
	{
		.name = MT_CLK_DAI,
		.flags = FLAG_CLK_NONE,
		.gate = MT_INIT_GATE(REG_DAI_CLKEN, DAI_CLKEN_SHIFT,
...
/* S6 A0 Chip has issue */
	...
	{ {(void*)(REG_PNAND_BASE+0xD008), 16, 5}, 0xA},			/* 16, 18, 20: 0 / 17, 19: 1 -- '01010' */
	/* SFLASH */
