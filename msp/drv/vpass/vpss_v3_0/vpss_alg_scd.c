...
mt_s32 SCDetection_core(SCDInput* pSCDInput,  SCDRls* pSCDRls, int flagTB)
{
    int i;
    ...
    mt_u64 normw, normh;
    mt_s32 k_histdiff;
    mt_s32 difhist, sumhist;
    mt_s32 scw_hist, scw_CF, scw_diff;
    mt_s32 gain_TF;

    mt_s32 K_HISTLPF; //register, in[0,10]
    mt_s32 nI0, nI1, nI2;
    mt_s32 nHist_LPF;

    mt_s32 BINNM, BINBIT;
    mt_s32 BINSTEP, BINBIT0, BINBIT1;

    mt_s32 s32SCHist_CFbuf[32];
...
mt_s32	SCDDetection(SCDInput* pSCDInput, SCDRls* pSCDRls)
{
