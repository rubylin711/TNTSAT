...
/********************************************************************************************/
#ifndef __VPSS_REG_S40V300_H__
#define __VPSS_REG_S40V300_H__
...
typedef union
{
    ...
    struct
    {
        unsigned int    Reserved_167          : 8   ; // [7..0]
        unsigned int    dir_inten_ver         : 4   ; // [11..8]
        unsigned int    Reserved_166          : 4   ; // [15..12]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_168          : 24  ; // [31..8]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    ck1_max_range          : 6   ; // [5..0]
        unsigned int    Reserved_171          : 2   ; // [7..6]
        unsigned int    ck1_range_gain         : 4   ; // [11..8]
        unsigned int    Reserved_170          : 4   ; // [15..12]
        unsigned int    ck1_gain               : 4   ; // [19..16]
        unsigned int    Reserved_169          : 12  ; // [31..20]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    ck2_max_range          : 6   ; // [5..0]
        unsigned int    Reserved_174          : 2   ; // [7..6]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_178          : 2   ; // [7..6]
        unsigned int    dir1_mult             : 6   ; // [13..8]
        unsigned int    Reserved_177          : 2   ; // [15..14]
        unsigned int    dir2_mult             : 6   ; // [21..16]
        unsigned int    Reserved_176          : 2   ; // [23..22]
        unsigned int    dir3_mult             : 6   ; // [29..24]
        unsigned int    Reserved_175          : 2   ; // [31..30]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_182          : 2   ; // [7..6]
        unsigned int    dir5_mult             : 6   ; // [13..8]
        unsigned int    Reserved_181          : 2   ; // [15..14]
        unsigned int    dir6_mult             : 6   ; // [21..16]
        unsigned int    Reserved_180          : 2   ; // [23..22]
        unsigned int    dir7_mult             : 6   ; // [29..24]
        unsigned int    Reserved_179          : 2   ; // [31..30]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_186          : 2   ; // [7..6]
        unsigned int    dir9_mult             : 6   ; // [13..8]
        unsigned int    Reserved_185          : 2   ; // [15..14]
        unsigned int    dir10_mult            : 6   ; // [21..16]
        unsigned int    Reserved_184          : 2   ; // [23..22]
        unsigned int    dir11_mult            : 6   ; // [29..24]
        unsigned int    Reserved_183          : 2   ; // [31..30]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_189          : 2   ; // [7..6]
        unsigned int    dir13_mult            : 6   ; // [13..8]
        unsigned int    Reserved_188          : 2   ; // [15..14]
        unsigned int    dir14_mult            : 6   ; // [21..16]
        unsigned int    Reserved_187          : 10  ; // [31..22]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_191          : 2   ; // [15..14]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_193          : 12  ; // [31..20]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_195          : 2   ; // [23..22]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_197          : 1   ; // [23]
        unsigned int    max_motion_iir_ratio  : 7   ; // [30..24]
        unsigned int    Reserved_196          : 1   ; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_198          : 1   ; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_203          : 10  ; // [31..22]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_210          : 14  ; // [23..10]
        unsigned int    mor_flt_en            : 1   ; // [24]
        unsigned int    Reserved_209          : 1   ; // [25]
        unsigned int    med_blend_en          : 1   ; // [26]
        unsigned int    Reserved_208          : 5   ; // [31..27]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_213          : 1   ; // [7]
        unsigned int    comb_chk_md_thd       : 5   ; // [12..8]
        unsigned int    Reserved_212          : 3   ; // [15..13]
        unsigned int    comb_chk_en           : 1   ; // [16]
        unsigned int    Reserved_211          : 15  ; // [31..17]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_214          : 1   ; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_216          : 1   ; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_222          : 1   ; // [23]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_229          : 2   ; // [15..14]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_230          : 6   ; // [31..26]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_237          : 16  ; // [31..16]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_238          : 20  ; // [31..12]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_239          : 8   ; // [31..24]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_241          : 24  ; // [31..8]
    } bits;
...
typedef struct
{
    ...
    volatile unsigned int           VPSS_DIEGLBMTNBIN[32];
    //volatile unsigned int           Reserved_233[31];
    volatile unsigned int           VPSS_DIELARGEMTNNUM;
    volatile unsigned int           VPSS_DIELARGEMTNSUM;
    volatile unsigned int           VPSS_DIESMALLMTNNUM;
    volatile unsigned int           VPSS_DIESMALLMTNSUM;
    volatile unsigned int           VPSS_DIEMIDDLMTNNUM;
    volatile unsigned int           VPSS_DIEMIDDLMTNSUM;
    ...
    volatile unsigned int           Reserved_245[2953];
    ...
    volatile unsigned int           Reserved_246[980];
    ...
    volatile unsigned int           Reserved_247[4];
    ...
    volatile unsigned int           Reserved_248;
...
mt_s32 VPSS_REG_SetDIR(mt_u32 u32AppAddr,mt_s32 s32MultDir[15]);
...
mt_s32 VPSS_REG_SetIntpSclRat(mt_u32 u32AppAddr,mt_s32 s32Rat[15]);
...
mt_s32 VPSS_REG_SetMotionDiffThd(mt_u32 u32AppAddr,mt_s32 s32Thd[8]);
...
mt_s32 VPSS_REG_SetRecFldStep(mt_u32 u32AppAddr,mt_s32 s32Step[2]);
mt_s32 VPSS_REG_SetRecFrmStep(mt_u32 u32AppAddr,mt_s32 s32Step[2]);
...
mt_s32 VPSS_REG_SetCombLimit(mt_u32 u32AppAddr,mt_s32  s32UpLimit,mt_s32  s32DownLimit);
...
mt_s32 VPSS_REG_SetDeiParaAddr(mt_u32 u32AppAddr,mt_u32 u32ParaAddr);
...
mt_s32 VPSS_REG_SetLBADispPosSize(mt_u32 u32AppAddr,VPSS_REG_PORT_E ePort,mt_u32 u32XFPos,mt_u32 u32YFPos,
...
mt_s32 VPSS_REG_SetRotation(mt_u32 u32AppAddr,mt_u32 u32Angle);
...
mt_s32 VPSS_REG_SetLBAVidPos(mt_u32 u32AppAddr,VPSS_REG_PORT_E ePort,mt_u32 u32XFPos,mt_u32 u32YFPos,
                            mt_u32 u32Height,mt_u32 u32Width);
mt_s32 VPSS_REG_SetOutCropVidPos(mt_u32 u32AppAddr,VPSS_REG_PORT_E ePort,mt_u32 u32XFPos,mt_u32 u32YFPos,
                            mt_u32 u32Height,mt_u32 u32Width);
