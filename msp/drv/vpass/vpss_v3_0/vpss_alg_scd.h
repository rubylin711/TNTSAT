...
{
    mt_s32 SCW_P1;
    mt_s32 s32SCHist_P1T[32];
    mt_s32 s32SCHist_P1B[32];
	mt_s32 s32SCHist_CF[32];
} SCDRls;
...
typedef struct hiSCDInput
{
    int  Width;
    int  Height;
    int  Field; //0:MT_DRV_FIELD_TOP 1:MT_DRV_FIELD_BOTTOM 2:MT_DRV_FIELD_ALL
...
/*--------------------------------------------------------------------------------*
Function        :SCDDetection(SCDInput* pSCDInput,SCDRls *pSCDRls,mt_s32 *pSCDReg)
