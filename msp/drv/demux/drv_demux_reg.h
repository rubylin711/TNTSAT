...
#define MT_CRG_BASE     0xbf200000
#define MT_PVR_BASE    0xbf260000

#define SYS_WRITE_REG(offset, value)   //printk("SYS_WRITE_REG >>>  offset =0x%x, value=0x%x\n",offset,value)// (*(volatile mt_u32*)((mt_u32)(MT_CRG_BASE) + (offset)) = (value))
#define SYS_READ_REG(offset)         printk("SYS_READ_REG :  offset=0x%x,",offset)//   (*(volatile mt_u32*)((mt_u32)(MT_CRG_BASE) + (offset)))

#define DMX_WRITE_REG(offset, value)  //printk("DMX_WRITE_REG >>>  offset =0x%x, value=0x%x\n",offset,value)// (*(volatile mt_u32*)((mt_u32)(MT_PVR_BASE) + (offset)) = (value))
#define DMX_READ_REG(offset)       offset// printk("DMX_READ_REG  : 0x%x,",offset) //  (*(volatile mt_u32*)((mt_u32)(MT_PVR_BASE) + (offset)))
...
typedef union
{
    struct
    {
        mt_u32  pvr_csa3_soft_rst   : 1;    // bit0
        mt_u32  reserved0           : 31;   // bit[31:1]
    } bits;
...
/******************************************************************************/
/*                      interface regeister definition              */
/******************************************************************************/
...
typedef union
{
    struct
    {
        mt_u32 mux_dvb_inf_sel           :4;    //[3:0]
        mt_u32 reserved                       :28;   //[31:4]
    }bits;
...
typedef union
{
    struct
    {
        mt_u32  tag_length                  : 4;    // [3:0]
        mt_u32  sync_mode_sel           : 1;    // [4]
        mt_u32  reserved                     : 26;    // [30:5]
        mt_u32  mux_work_en             : 1;    // [31]
    }bits;
...
typedef union
{
    struct 
    {
        mt_u32 dbg_ser_allsave          :1 ;  //[0]
        mt_u32 reserved1                     :7;   //[1:7]
        mt_u32 dbg_ser_bit_sel           :3;   //[8:10]
        mt_u32 reserved2                      :1;  //[11]
        mt_u32 dbg_ser_len_bypass     :1;  //[12]
        mt_u32 reserved                      :19; //[13:31]
    }bits;
...
typedef union
{
    struct
    {
        mt_u32  syncon_th           : 3;    // [2:0]
        mt_u32  reserved_0          : 1;    // [3]
        mt_u32  syncoff_th          : 2;    // [5:4]
        mt_u32  reserved_1          : 6;    // [11:6]
        mt_u32  ser_2bit_mode       : 1;    // [12]
        mt_u32  ser_2bit_rev        : 1;    // [13]
        mt_u32  ser_nosync          : 1;    // [14]
        mt_u32  reserved_2          : 1;    // [15]
        mt_u32  nosync_fixed_204    : 1;    // [16]
        mt_u32  reserved_3          : 3;    // [19:17]
        mt_u32  sync_mode           : 2;    // [21:20]
        mt_u32  err_bypass          : 1;    // [22]
        mt_u32  sync_pol            : 1;    // [23]
        mt_u32  vld_pol             : 1;    // [24]
        mt_u32  err_pol             : 1;    // [25]
        mt_u32  reserved_4          : 2;    // [27:26]
        mt_u32  sync_clear          : 1;    // [28]
        mt_u32  serial_sel          : 1;    // [29]
        mt_u32  bit_sel             : 1;    // [30]
        mt_u32  port_sel            : 1;    // [31]
    } bits;
...
typedef union
{
    struct
    {
        mt_u32  byte_endian             : 1;    // [0]
        mt_u32  sync_pos                : 1;    // [1]
        mt_u32  vld_mode                : 1;    // [2]
        mt_u32  dis                     : 1;    // [3]
        mt_u32  clkgt_mode              : 1;    // [4]
        mt_u32  spi_mode                : 1;    // [5]
        mt_u32  serial_bit_sel          : 1;    // [6]
        mt_u32  reserved_1              : 1;    // [7]
        mt_u32  tsout_source_sel        : 8;    // [15:8]
        mt_u32  reserved_2              : 16;   // [31:16]
    } bits;
    mt_u32  all;
} U_TSOUT_CFG;
...
typedef union
{
    struct
    {
        mt_u32  cw_word_id      : 2;    // [1:0]
        mt_u32  reserved0       : 6;    // [7:2]
        mt_u32  cw_odd_even     : 1;    // [8]
        mt_u32  cw_group_id     : 5;    // [13:9]
        mt_u32  reserved1       : 2;    // [15:14]
        mt_u32  cw_type         : 8;    // [23:16]
        mt_u32  cw_iv_sel       : 1;    // [24]
        mt_u32  reserved2       : 7;    // [31:25]
    } bits;
...
typedef union
{
    struct
    {
        mt_u32  ip_nosync_len1      : 8;    // [7:0]
        mt_u32  ip_nosync_len2      : 8;    // [15:8]
    #ifdef DMX_RAM_PORT_AUTO_SCAN_SUPPORT
        mt_u32  ip_nosync_region    : 8;    // [23:16]
        mt_u32  ip_nosync_step      : 2;    // [25:24]
        mt_u32  reserved0           : 6;    // [31:26]
    #else
        mt_u32  reserved0           : 16;   // [31:16]
    #endif
    } bits;
...
typedef union
{
    struct
    {
        mt_u32  flt_depth   : 5;    // [4:0]
        mt_u32  reserved_0  : 27;   // [31:5]
    } bits;
...
typedef union
{
    struct
    {
        mt_u32  flt_start               : 1;    // [0]
        mt_u32  flt_byte_mode           : 1;    // [1]
        mt_u32  reserved_0              : 2;    // [3:2]
        mt_u32  sec_stuff_nopusi_e      : 1;    // [4]
        mt_u32  reserved_1              : 2;    // [6:5]
        mt_u32  sec_short_crc           : 1;    // [7]
        mt_u32  minlen_discard_by_flt   : 1;    // [8]
        mt_u32  minlen_mask             : 1;    // [9]
        mt_u32  point_err_mode          : 1;    // [10]
        mt_u32  point_err_correct       : 1;    // [11]
        mt_u32  point_newsec            : 1;    // [12]
        mt_u32  reserved_2              : 19;   // [31:13]
    } bits;
...
typedef union
{
    struct
    {
        mt_u32  ipaful_clr_time : 24;   // [23:0]
#if    defined(CHIP_TYPE_hi3716cv200)   \
    || defined(CHIP_TYPE_hi3716mv400)   \
    || defined(CHIP_TYPE_hi3718cv100)   \
    || defined(CHIP_TYPE_hi3719cv100)   \
    ...
    || defined(CHIP_TYPE_hi3719mv100_a) 
        mt_u32  ipaful_clr_ena  : 7;    // [30:24]
        mt_u32  reserved        : 1;    // [31]
#else
        mt_u32  ipaful_clr_ena  : 4;    // [27:24]
        mt_u32  reserved        : 4;    // [31:28]
#endif
    } bits;
...
typedef union
{
    struct
    {
        mt_u32  rec_timestamp_mode : 14;   // [13:0]
        mt_u32  reserved           : 18;    // [31:14]
    } bits;
