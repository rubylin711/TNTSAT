...
#if defined(CHIP_TYPE_hi3798cv100) || defined(CHIP_TYPE_hi3798cv100_a) || defined(CHIP_TYPE_hi3796cv100) || defined(CHIP_TYPE_hi3796cv100_a)
...
typedef struct tagHWC_REG_S
{
    ...
    HI_U32 u32MaskInt;
    HI_U32 u32Int;
#if defined(CHIP_TYPE_hi3719mv100) || defined(CHIP_TYPE_hi3718mv100) || defined(CHIP_TYPE_hi3798cv100) || defined(CHIP_TYPE_hi3798cv100_a) || defined(CHIP_TYPE_hi3796cv100) || defined(CHIP_TYPE_hi3796cv100_a) || defined(CHIP_TYPE_hi3798mv100_a)
	HI_U32 u32Cnt;
	HI_U32 u32RCnt;
	HI_U32 u32WCnt;
	HI_U32 u32RLenCnt;
...
static HI_S32 InitFilterParam(HI_VOID)
{
    ...
    pVir = HI_GFX_Map(gs_u32HFilterParamAddr);
    if (NULL == pVir)
    {
