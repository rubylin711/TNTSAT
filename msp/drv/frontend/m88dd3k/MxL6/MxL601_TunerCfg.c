...
MXL601_REG_CTRL_INFO_T MxL601_OverwriteDefaults_dd3k[] = 
{
  {0x00, 0xFF, 0x01},
  {0x96, 0xFF, 0x00},
  {0x00, 0xFF, 0x00},
...
MXL601_REG_CTRL_INFO_T MxL601_AnalogNtsc_dd3k[] = 
{
  {0x0C, 0xFF, 0x08},
  {0x13, 0xFF, 0x00},
  {0x53, 0xFF, 0x3E},
...
MXL601_REG_CTRL_INFO_T MxL601_Ntsc_RfLutSwpHIF_dd3k[] = 
{
  {0x4A, 0xFF, 0x1B},
  {0x4B, 0xFF, 0x1A},
  {0x4C, 0xFF, 0x19},
...
MXL601_REG_CTRL_INFO_T MxL601_Ntsc_16MHzRfLutSwpLIF_dd3k[] = 
{
  {0x4A, 0xFF, 0x1B},
  {0x4B, 0xFF, 0x1A},
  {0x4C, 0xFF, 0x19},
...
MXL601_REG_CTRL_INFO_T MxL601_Ntsc_24MHzRfLutSwpLIF_dd3k[] = 
{
  {0x4A, 0xFF, 0x1C},
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
...
MXL601_REG_CTRL_INFO_T MxL601_Ntsc_HRCRfLutSwpLIF_dd3k[] = 
{
  {0x4A, 0xFF, 0x1C},
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
...
MXL601_REG_CTRL_INFO_T MxL601_Pal_RfLutSwpLIF_dd3k[] = 
{
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
  {0x4D, 0xFF, 0x19},
...
MXL601_REG_CTRL_INFO_T MxL601_PalD_RfLutSwpHIF_dd3k[] = 
{
  {0x4B, 0xFF, 0x14},
  {0x4C, 0xFF, 0x13},
  {0x4D, 0xFF, 0x15},
...
MXL601_REG_CTRL_INFO_T MxL601_PalI_RfLutSwpHIF_dd3k[] = 
{
  {0x4B, 0xFF, 0x16},
  {0x4C, 0xFF, 0x15},
  {0x4D, 0xFF, 0x14},
...
MXL601_REG_CTRL_INFO_T MxL601_PalBG_8MHzBW_RfLutSwpHIF_dd3k[] = 
{
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
  {0x4D, 0xFF, 0x19},
...
MXL601_REG_CTRL_INFO_T MxL601_PalBG_7MHzBW_RfLutSwpHIF_dd3k[] = 
{
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
  {0x4D, 0xFF, 0x15},
...
MXL601_REG_CTRL_INFO_T MxL601_AnalogPal_dd3k[] = 
{
  {0x13, 0xFF, 0x00},
  {0x53, 0xFF, 0x3E},
  {0x57, 0xFF, 0x91},
...
MXL601_REG_CTRL_INFO_T MxL601_AnalogSecam_dd3k[] = 
{
  {0x13, 0xFF, 0x00},
  {0x53, 0xFF, 0x3E},
  {0x57, 0xFF, 0x91},
...
MXL601_REG_CTRL_INFO_T MxL601_DigitalDvbc_dd3k[] = 
{
  {0x0C, 0xFF, 0x00},
  {0x13, 0xFF, 0x04},
  {0x53, 0xFF, 0x3E},
...
MXL601_REG_CTRL_INFO_T MxL601_DigitalIsdbtAtsc_dd3k[] = 
{
  {0x0C, 0xFF, 0x00},
  {0x13, 0xFF, 0x04},
  {0x53, 0xFF, 0xFE},
...
MXL601_REG_CTRL_INFO_T MxL601_DigitalDvbt_dd3k[] = 
{
  {0x13, 0xFF, 0x04},
  {0x0C, 0xFF, 0x00},
  {0x53, 0xFF, 0xFE},
...
MXL_STATUS Ctrl_SetRfFreqLutReg(UINT8 i2cAddress, UINT32 FreqInHz, PCHAN_DEPENDENT_FREQ_TABLE_T freqLutPtr)
{
  ...
  // Program registers
  for (idx = 0; idx < MxL601_SPUR_REGISTER_dd3k.SpurRegNum; idx++)
    status |= Ctrl_WriteRegister(i2cAddress, MxL601_SPUR_REGISTER_dd3k.SpurRegAddr[idx], regSetData[idx]);
