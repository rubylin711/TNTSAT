...
#ifndef __MT_FE_TN_MXL608I_H__
#define __MT_FE_TN_MXL608_H__
...
******************************************************************************/
extern const UINT8 MxLWare608DrvVersion_dd3k[];
...
MXL_STATUS MxLWare608_API_CfgDevOverwriteDefaults_dd3k(UINT8 devId, MXL_BOOL singleSupply_3_3V);
...
MXL_STATUS MxLWare608_API_ReqDevVersionInfo_dd3k(UINT8 devId, MXL608_VER_INFO_T* mxlDevVerInfoPtr);
MXL_STATUS MxLWare608_API_ReqDevGPOStatus_dd3k(UINT8 devId, MXL608_GPO_STATE_E* gpoStatusPtr);
MXL_STATUS MxLWare608_API_ReqDevPllState_dd3k(UINT8 devId, MXL608_PLL_STATE_E* PllStatePtr);

MXL_STATUS MxLWare608_API_CfgTunerMode_dd3k(UINT8 devId, MXL608_TUNER_MODE_CFG_T tunerModeCfg);
...
MXL_STATUS MxLWare608_API_CfgTunerChanTune_dd3k(UINT8 devId, MXL608_CHAN_TUNE_CFG_T chanTuneCfg);

MXL_STATUS MxLWare608_API_ReqTunerAGCLock_dd3k(UINT8 devId, MXL_BOOL* agcLockStatusPtr);
MXL_STATUS MxLWare608_API_ReqTunerLockStatus_dd3k(UINT8 devId, MXL_BOOL* rfLockPtr, MXL_BOOL* refLockPtr);
