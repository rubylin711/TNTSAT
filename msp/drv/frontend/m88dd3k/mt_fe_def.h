...
MT_FE_RET mt_fe_dmd_agc_hi_z__dd3k(MT_FE_DD_Device_Handle handle, MT_BOOL agc_hiz);
MT_FE_RET mt_fe_dmd_lab_enable_dd3k(MT_FE_DD_Device_Handle handle, MT_BOOL lab_enble);
