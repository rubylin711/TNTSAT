...
#define SONY_DEMOD_SUPPORT_ISDBC_CHBOND        /**< Driver supports ISDBC channel bonding (J.183) */
#define SONY_DEMOD_SUPPORT_ATSC3_CHBOND        /**< Driver supports ATSC 3.0 channel bonding */
#elif defined SONY_DRIVER_BUILD_OPTION_CXD6800 /* DVB-T/T2/C/C2, ISDB-T/C, J.83A/B/C (SiP) */
#define SONY_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONY_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC(J.83A). */
#define SONY_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2(J.382). */
...
#define SONY_DEMOD_SUPPORT_ISDBC               /**< Driver supports ISDBC(J.83C). */
#define SONY_DEMOD_SUPPORT_J83B                /**< Driver supports J.83B. */
#elif defined SONY_DRIVER_BUILD_OPTION_CXD6801 /* DVB-T/T2/C/C2, ISDB-T/C, J.83A/B/C, ATSC/ATSC 3.0 (SiP) */
#define SONY_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONY_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC(J.83A). */
#define SONY_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2(J.382). */
...
#define SONY_DEMOD_SUPPORT_ATSC                /**< Driver supports ASTC. */
#define SONY_DEMOD_SUPPORT_ATSC3               /**< Driver supports ATSC 3.0. */
#elif defined SONY_DRIVER_BUILD_OPTION_CXD6802 /* DVB-T/T2/C/C2, ISDB-T/C, J.83A/B/C, ATSC (SiP) */
#define SONY_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONY_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC(J.83A). */
#define SONY_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2(J.382). */
...
#include "dvb_cable/sony_dvbc2.h"
#endif

#ifdef SONY_DEMOD_SUPPORT_DVBS_S2
#include "dvb_sat/sony_dvbs.h"
#include "dvb_sat/sony_dvbs2.h"
#endif
...
#include "isdb_cable/sony_isdbc.h"
#endif

#ifdef SONY_DEMOD_SUPPORT_ISDBS
#include "isdb_sat/sony_isdbs.h"
#endif

#ifdef SONY_DEMOD_SUPPORT_ISDBS3
#include "isdb_sat/sony_isdbs3.h"
#endif

#ifdef SONY_DEMOD_SUPPORT_J83B
#include "j83b/sony_j83b.h"
#endif
...
#define SONY_DEMOD_CHIP_ID_2878_FAMILY(chipId) ((chipId == SONY_DEMOD_CHIP_ID_CXD2878) || \
                                                ...
                                                (chipId == SONY_DEMOD_CHIP_ID_CXD6802) || \
                                                (chipId == SONY_DEMOD_CHIP_ID_CXD6822) || \
                                                (chipId == SONY_DEMOD_CHIP_ID_CXD2878A))

/**
 @brief This macro is used to determine that CXD2878A family IC is used.
*/
#define SONY_DEMOD_CHIP_ID_2878A_FAMILY(chipId) (chipId == SONY_DEMOD_CHIP_ID_CXD2878A)
...
typedef enum {
    ...
    SONY_DEMOD_CHIP_ID_CXD2856  = 0x090,  /**< CXD2856 / CXD6800(SiP) / CXD6820(SiP2) */
...
typedef enum {
    ...
    */
    ...
    /**
     @brief Demodulator ADC internal DC bias voltage setting.

     @note  This setting should be changed for SiP2 (CXD6820 family).

            Value:
            - 0: ADC internal DC bias voltage disabled.
            - 1: ADC internal DC bias voltage enabled. (Default)
    */
    SONY_DEMOD_CONFIG_TADC_DC_BIAS,
    ...
    */
    ...
    /**
     @brief Configure Korean mode for handling ALP header length.

     @note  This setting is for CXD2878A family only.

            Values:
            - 0: Standard mode (Default)
            - 1: Korean mode
    */
    SONY_DEMOD_CONFIG_ATSC3_KOREAN_MODE,

    /**
     @brief ATSC 3.0 PLP ID packet insertion setting for Single PLP

            Values:
            - 0: Insert ALP packet (PLP ID included) every time
            - 3: No insersion (Default)
    */
    SONY_DEMOD_CONFIG_ATSC3_PLPID_PACKET_SPLP,
    ...
    */
    ...
    /**
     @brief ATSC 3.0 auto PLP ID correction setting for single PLP.

            Values:
            - 0 : Disable
            - 1 : Enable (Default)
    */
    SONY_DEMOD_CONFIG_ATSC3_AUTO_PLP_ID_SPLP,
    ...
    */
    ...
    /**
     @brief Configure ALPSYNC length under ALP serial.

            Only valid when SONY_DEMOD_CONFIG_ALP_PARALLEL_SEL = 0 (serial ALP).

            Value:
            - 0: ALPSYNC for the first byte = 8bit. (Default)
            - 1: ALPSYNC for the first bit.
    */
    SONY_DEMOD_CONFIG_ALP_SYNC_LENGTH,
...
typedef struct sony_demod_t {
    ...
    */
    ...
    /**
     @brief ATSC 3.0 PLP ID auto correction setting for single PLP.
    ...
    */
    ...
    /**
     @brief Currently used single cable switch inverts spectrum or not.

            This is configured using ::sony_demod_SetConfig with the
            SONY_DEMOD_CONFIG_SAT_SINGLECABLE_SPECTRUM_INV option.
    */
