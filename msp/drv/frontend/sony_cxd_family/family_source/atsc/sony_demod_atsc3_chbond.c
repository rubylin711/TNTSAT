                                                    ...
                                                    sony_demod_atsc3_chbond_plp_bond_t plpBond[4])
{
    ...
    /*  slave    Bank    Addr    Bit    default   Value          Name
     * ----------------------------------------------------------------------------------
     *  <SLV-T>   93h     80h     [7:0]    8'h00    8'hxx      OREGD_PLP_ID_0_VALID,OREGD_PLP_ID_0_CHBVALID,OREGD_PLP_ID_0[5:0]
     *  <SLV-T>   93h     81h     [7:0]    8'h00    8'hxx      OREGD_PLP_ID_1_VALID,OREGD_PLP_ID_1_CHBVALID,OREGD_PLP_ID_1[5:0]
     *  <SLV-T>   93h     82h     [7:0]    8'h00    8'hxx      OREGD_PLP_ID_2_VALID,OREGD_PLP_ID_2_CHBVALID,OREGD_PLP_ID_2[5:0]
     *  <SLV-T>   93h     83h     [7:0]    8'h00    8'hxx      OREGD_PLP_ID_3_VALID,OREGD_PLP_ID_3_CHBVALID,OREGD_PLP_ID_3[5:0]
    ...
    /* OREG_PLP_ID_AUTO should be 0 in channel bonding */
    if (pDemod->pI2c->WriteOneRegister (pDemod->pI2c, pDemod->i2cAddressSLVT, 0x85, 0x00) != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (SONY_RESULT_ERROR_I2C);
    }
