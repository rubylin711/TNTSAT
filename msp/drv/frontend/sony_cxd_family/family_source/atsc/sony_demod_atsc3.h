/*------------------------------------------------------------------------------
  ...
  Modification ID : ae1245fdaf66401838902e7214d8494b0f5e5a76
------------------------------------------------------------------------------*/
/**
    ...
    */
    ...
    /**
     @brief PLP bonding option for each PLPs.
            ...
            For main IC, the user should arrange PLP IDs on following constraints.

            * plpBond[0] must be SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_ENABLE or SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_FROM_MAIN
            * SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_FROM_SUB PLP cannot be located prior to
              SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_ENABLE or SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_FROM_MAIN PLPs
              on plpID[] and plpBond[].

              For example, following is invalid.

              plpBond[0] = SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_ENABLE
              plpBond[1] = SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_ENABLE
              plpBond[2] = SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_FROM_SUB
              plpBond[3] = SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_FROM_MAIN

              The user should change PLP ID selection order like as follows.

              plpBond[0] = SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_ENABLE
              plpBond[1] = SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_ENABLE
              plpBond[2] = SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_FROM_MAIN
              plpBond[3] = SONY_DEMOD_ATSC3_CHBOND_PLP_BOND_FROM_SUB
    */
