                                               ...
                                               sony_dvbc2_l1_t * l1Data)
{
...

    {
        ...
        if (result != SONY_RESULT_OK) {
             ...
             * <SLV-T>   52h     2Ch     [7:0]        IREG_L1_PART2_CHANGE_COUNTER[7:0]
             ...
             * <SLV-T>   52h     99h     [7]          IREG_EARLY_WARNING_SYSTEM
             * <SLV-T>   52h     99h     [6:3]        IREG_C2_VERSION[3:0]
             * <SLV-T>   52h     99h     [2:0]        IREG_RESERVED_4[10:8]
            ...
            l1Data->ews = (rdata[121] & 0x80) ? 0x01 : 0x00;
            l1Data->c2Version = (sony_dvbc2_version_t)((rdata[121] >> 3) & 0x0F);
