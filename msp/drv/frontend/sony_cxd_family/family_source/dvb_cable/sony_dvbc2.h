...
/**
 @brief DVB-C2 version definition.
*/
typedef enum {
    SONY_DVBC2_V121,                                /**< DVBC2 V1.2.1. */
    SONY_DVBC2_V131                                 /**< DVBC2 V1.3.1. */
} sony_dvbc2_version_t;
...
typedef struct sony_dvbc2_l1_t {
    ...
    uint8_t ews;                                    /**< Early warning system */
    sony_dvbc2_version_t c2Version;                 /**< C2 version */
