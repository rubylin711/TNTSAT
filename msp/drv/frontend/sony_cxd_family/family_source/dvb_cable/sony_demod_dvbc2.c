...
static sony_result_t SLtoAC2(sony_demod_t * pDemod)
{
    ...
    /* TLV output setting (CXD2878 family)
     *  slave    Bank    Addr    Bit    default   Value          Name
     * ---------------------------------------------------------------------------------
     *  <SLV-T>   01h     E8h    [0]     8'h00      8'h01      OTLV_WFMT_TIMER_OFF
     */
    if (SONY_DEMOD_CHIP_ID_2878_FAMILY (pDemod->chipId) && (pDemod->dvbc2Output == SONY_DEMOD_OUTPUT_DVBC2_TLV)) {
        /* Set SLV-T Bank : 0x01 */
