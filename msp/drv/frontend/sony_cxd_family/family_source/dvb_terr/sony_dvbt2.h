...
/**
 @brief DVBT2 S1 signaling definition.
*/
typedef enum {
...
/**
 @brief DVBT2 guard intervals.
        Same encoding as used for L1-pre signaling Guard Interval.
*/
typedef enum {
...
/**
 @brief The L1-pre pilot pattern signaling.
*/
typedef enum {
...
------------------------------------------------------------------------------*/
/**
 @brief L1-pre signaling information structure definition.
*/
typedef struct sony_dvbt2_l1pre_t {
    ...
    sony_dvbt2_s1_t s1;                         /**< S1 signaling. P1 S1. */
    uint8_t s2;                                 /**< S2 signaling. P1 S2. */
    ...
    uint16_t numSymbols;                        /**< Number of OFDM symbols per T2-frame. */
...
/**
 @brief DVBT2 PLP information in L1-post signaling.
*/
typedef struct sony_dvbt2_plp_t {
    ...
    */
    ...
    /**
     @brief In-band A signaling indicator.
            - 1 = enabled.
            - 0 = disabled
    */
    uint8_t inBandAFlag;
    ...
    /**
     @brief In band B signaling indicator.
            - 1 = enabled.
            - 0 = disabled
    */
    uint8_t inBandBFlag;
    ...
    */
    ...
    /**
     @brief This 1-bit field indicates whether BBFRAME padding is used
            other than for in-band signaling for the current PLP
    */
