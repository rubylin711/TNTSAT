...
/**
 @brief Monitor the L1-pre signaling information.

        L1-pre signaling information is available when TS is locked, and earlier in the
        acquisition sequence, after the P1 symbols have been decoded.

 @param pDemod The demodulator instance.
 @param pL1Pre Pointer to receive the L1-pre signaling information.
...
/**
 @brief Monitor the T2 version in use.
        ...
        The version is available from the L1-pre signaling information.
...
/**
 @brief Monitor the active PLP information in L1-post signaling.
...
/**
 @brief Monitor the in-band type B signaling TS (Transport Stream) rate.
