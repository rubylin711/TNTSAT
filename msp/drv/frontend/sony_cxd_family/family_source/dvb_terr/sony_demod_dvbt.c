...
static sony_result_t SLtoAT_BandSetting(sony_demod_t * pDemod)
{
    ...
    case SONY_DTV_BW_8_MHZ:
...

        {
             ...
             * slave    Bank    Addr    Bit      default    Value      Name
             * ----------------------------------------------------------------------------------
             * <SLV-T>   17h     38h    [3:0]     8'h01      8'h01      OREG_CAS_CCIFLT2_EN_CW[1:0], OREG_CAS_CCIFLT2_EN_CW2[1:0]
    ...
    case SONY_DTV_BW_7_MHZ:
...

        {
             ...
             * slave    Bank    Addr    Bit      default    Value      Name
             * ----------------------------------------------------------------------------------
             * <SLV-T>   17h     38h    [3:0]     8'h01      8'h00      OREG_CAS_CCIFLT2_EN_CW[1:0], OREG_CAS_CCIFLT2_EN_CW2[1:0]
