...
static sony_result_t allegro_a8304_GetDiagStatus (sony_lnbc_t * pLnbc,
                                                  uint32_t * pStatus,
                                    ...
                                    sony_i2c_t * pI2c)
{
    ...
    pLnbc->GetDiagStatus = allegro_a8304_GetDiagStatus;
                                                  ...
                                                  uint32_t * pStatusSupported)
{
    ...
    SONY_TRACE_ENTER ("allegro_a8304_GetDiagStatus");
