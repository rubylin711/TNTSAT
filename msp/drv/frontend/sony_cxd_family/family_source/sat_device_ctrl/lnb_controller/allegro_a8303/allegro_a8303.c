...
static sony_result_t allegro_a8303_GetDiagStatus (sony_lnbc_t * pLnbc,
                                                  uint32_t * pStatus,
                                    ...
                                    sony_i2c_t * pI2c)
{
    ...
    pLnbc->GetDiagStatus = allegro_a8303_GetDiagStatus;
    ...
    /* A8303 do not have any I2C register to change TX/RX. */
                                                    ...
                                                    sony_lnbc_transmit_mode_t mode)
{
    ...
    /* A8303 doesn't need to control something. */
    SONY_TRACE_RETURN (SONY_RESULT_OK);
}
                                                  ...
                                                  uint32_t * pStatusSupported)
{
    ...
    SONY_TRACE_ENTER ("allegro_a8303_GetDiagStatus");
