...
------------------------------------------------------------------------------*/
/**
 @file    allegro_a8303.h

          This file provides the functions to control A8303(Allegro).
*/
/*----------------------------------------------------------------------------*/
#ifndef ALLEGRO_A8303_H
#define ALLEGRO_A8303_H
...
*/
#define ALLEGRO_A8303_CONFIG_VOLTAGE_LOW_13_333V        0
...
/**
 ...
 please set this parameter by sony_lnbc_t::SetConfig(SONY_LNBC_CONFIG_ID_LOW_VOLTAGE, value).
*/
#define ALLEGRO_A8303_CONFIG_VOLTAGE_LOW_14_333V        1
...
*/
#define ALLEGRO_A8303_CONFIG_VOLTAGE_HIGH_18_667V      10
...
/**
 ...
 please set this parameter by sony_lnbc_t::SetConfig(SONY_LNBC_CONFIG_ID_HIGH_VOLTAGE, value).
*/
#define ALLEGRO_A8303_CONFIG_VOLTAGE_HIGH_19_667V      11

/*------------------------------------------------------------------------------
  Functions
------------------------------------------------------------------------------*/
/**
 @brief Create a instance for A8303(Allegro).
