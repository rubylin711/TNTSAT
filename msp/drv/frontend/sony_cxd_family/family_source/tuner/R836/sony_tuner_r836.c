...
------------------------------------------------------------------------------*/
static sony_result_t sony_tuner_r840_Initialize(sony_tuner_t * pTuner);

static sony_result_t sony_tuner_r840_Tune(sony_tuner_t * pTuner,
                                             uint32_t frequency,
                                             sony_dtv_system_t system,
                                             sony_dtv_bandwidth_t bandwidth);

static sony_result_t sony_tuner_r840_Sleep(sony_tuner_t * pTuner);

static sony_result_t sony_tuner_r840_Shutdown(sony_tuner_t * pTuner);

/*static sony_result_t sony_tuner_r840_Resume(sony_tuner_t * pTuner);*//*Clean warning*/

static sony_result_t sony_tuner_r840_ReadRFLevel(sony_tuner_t * pTuner, int32_t * pRFLevel);
                                      ...
                                      sony_r840_t * pR840Tuner)
{
    ...
    pTuner->TerrCableTune = sony_tuner_r840_Tune;
...
#if 0/*Clean Warning*/
static sony_result_t sony_tuner_r840_Resume(sony_tuner_t * pTuner)
{
    sony_result_t result = SONY_RESULT_OK;
