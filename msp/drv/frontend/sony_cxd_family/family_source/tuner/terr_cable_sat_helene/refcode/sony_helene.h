...
*/
#define SONY_HELENE_VERSION       "1.1.2.0"
...
typedef enum {
    ...
    SONY_HELENE_DTV_ATSC3_6,  /**< ATSC 3.0 6MHzBW  (IF: Fc=3.6MHz in default) */
    SONY_HELENE_DTV_ATSC3_7,  /**< ATSC 3.0 7MHzBW  (IF: Fc=4.2MHz in default) */
    SONY_HELENE_DTV_ATSC3_8,  /**< ATSC 3.0 8MHzBW  (IF: Fc=4.8MHz in default) */
