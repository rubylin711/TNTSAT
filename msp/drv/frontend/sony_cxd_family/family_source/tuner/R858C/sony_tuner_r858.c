...
------------------------------------------------------------------------------*/
static sony_result_t sony_tuner_r858_Initialize(sony_tuner_t *pTuner);

static sony_result_t sony_tuner_r858_Tune(sony_tuner_t *pTuner,
                                          uint32_t frequency,
                                          sony_dtv_system_t system,
                                          sony_dtv_bandwidth_t bandwidth);

static sony_result_t sony_tuner_r858_Sleep(sony_tuner_t *pTuner);

static sony_result_t sony_tuner_r858_Shutdown(sony_tuner_t *pTuner);

/*static sony_result_t sony_tuner_r858_Resume(sony_tuner_t *pTuner);*/ /*Clean warning*/

static sony_result_t sony_tuner_r858_ReadRFLevel(sony_tuner_t *pTuner, int32_t *pRFLevel);

sony_result_t sony_tuner_r858_get_tuner_num(sony_tuner_t *pTuner, R858_ExtTunerNum_Type *pExtTunerNum, R858_IntTunerNum_Type *pIntTunerNum)
{
...
/*------------------------------------------------------------------------------
 Functions
------------------------------------------------------------------------------*/
sony_result_t sony_tuner_r858_Create(sony_tuner_t *pTuner,
                                     uint8_t i2cAddress,
                                     sony_i2c_t *pI2c,
                                     ...
                                     sony_r858_t *pR858Tuner)
{
    ...
    pTuner->TerrCableTune = sony_tuner_r858_Tune;
	pTuner->SatTune = NULL;
...
#if 0 /*Clean warning*/
static sony_result_t sony_tuner_r858_Resume(sony_tuner_t *pTuner)
{
    sony_result_t result = SONY_RESULT_OK;
