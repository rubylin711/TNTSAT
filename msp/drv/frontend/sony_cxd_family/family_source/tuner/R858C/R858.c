...
01/06/2017     Vincent          v1.4        add DVBT/T2 and J.83B
01/10/2017     Vincent          v1.5        add ATSC
01/25/2017     Vincent          v1.6        add xtal choose
06/25/2017     Vincent          v1.7        add NA choose
06/27/2017     Vincent          v1.7B       modify R858_SBY2 size
10/20/2017	   Vincent			v1.7C		add more NA choose	
01/30/2017     Vincent          v1.8        add ATSC mode
04/02/2019     Vincent          v1.9        add xtal 16M
07/01/2019	   Vincent          v1.9a       remove x pow, add DVBT/ISDBT 5500
05/25/2021	   Vincent          v1.9b       improve standby power consumption and loopthrough function
*/
...
/*Clean warning redefined with R850.h R836.h
* so move the following define to R858.c
*/
#define VERSION "R858_GUI_v4_1.9b"
#define VER_NUM 0
#define CHIP_ID 0x41
...
static int Rafael_Convert(int InvertNum)
{
	int ReturnNum = 0;
	int AddNum = 0x80;
	int BitNum = 0x01;
...
static bool I2C_Write_Len(R858_ExtTunerNum_Type R858_Num, I2C_LEN_TYPE *I2C_Info)
{
	//R850_ADDRESS = R850_ADDRESS_MULTI[R850_Tuner_Num]; //Device address
	...
	result = _mt_i2c_write_sony(I2C_Info->I2cAddr, buf, I2C_Info->Len + 1);

	return (result == SONY_RESULT_OK) ? true : false;
}

static bool I2C_Read_Len(R858_ExtTunerNum_Type R858_Num, I2C_LEN_TYPE *I2C_Info)
{
	//R850_ADDRESS = R850_ADDRESS_MULTI[R850_Tuner_Num]; //Device address

	//for (DataCunt = 0;DataCunt < TransI2C.wCount;DataCunt ++)
	//{
	//	 I2C_Info->Data[DataCunt] = (unsigned char)R850_Convert(TransI2C.Data[DataCunt]);
	//}
...
#if 1 // 20210318
	buf[0] = I2C_Info->RegAddr;
	result = _mt_i2c_read_sony(I2C_Info->I2cAddr, buf, 1, I2C_Info->Data, I2C_Info->Len);
#else
	result = _mt_i2c_read_sony(I2C_Info->I2cAddr, NULL, 0, I2C_Info->Data, I2C_Info->Len);
#endif

	for (i = 0; i < I2C_Info->Len; i++)
	{
		I2C_Info->Data[i] = Rafael_Convert(I2C_Info->Data[i]);
		//printk("\t%02x, ", I2C_Info->Data[i]);
	}

	return (result == SONY_RESULT_OK) ? true : false;
}

static bool I2C_Write(R858_ExtTunerNum_Type R858_Num, I2C_TYPE *I2C_Info)
{
	//R850_ADDRESS = R850_ADDRESS_MULTI[R850_Tuner_Num]; //Device address
	sony_result_t result = SONY_RESULT_OK;
	uint8_t buf[2];
	...
	result = _mt_i2c_write_sony(I2C_Info->I2cAddr, buf, 2);
...
UINT8 R858_Standby_Mode = R858_SBY_ALL;
...
UINT8 R858_User_Mode = R858_SINGLE; //R858_DUAL;
...
UINT8 R858_XTAL_CAP = 10; //25; //(range 0~31)
...
void usleep(UINT32 waitTime)
{
	//UINT32 perfCnt, start, now;

	//	QueryPerformanceFrequency(&perfCnt);
	//	QueryPerformanceCounter(&start);
	//	do {
	//		QueryPerformanceCounter((UINT32*) &now);
...
UINT8 R858_iniArray[2][R858_REG_NUM] = 
{
	//Tuner1/2
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,			 //Reg0~7, read only
	 ...
	 0x45, 0x04, 0xCD, 0x2A, 0x0B, 0xE8, 0xD8, 0x00, 0xD2, 0x80,
	 //  0x26  0x27  0x28  0x29  0x2A  0x2B  0x2C  0x2D  0x2E  0x2F
	 0x22, 0x02, 0x00, 0x57, 0xAC, 0xF6, 0x77, 0x1A}, //0x33=0x57,NAT PWR=OFF;0x33=0xD7,NAT PWR=ON
...
UINT8 R858_ADDRESS[R858_MAX_NUM][2] = {{0x14, 0x34}, {0x14, 0x34}};
...
//LPF Cal Array 72MHz
UINT8 R858_LPF_CAL_Array_24[2][R858_REG_NUM] = {	 //tuner1/2
...
UINT8 R858_LPF_CAL_Array_16[2][R858_REG_NUM] = {	 //tuner1/2
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //read only
	 0x12, 0x60, 0xE5, 0x3D, 0x50, 0x13, 0x3A, 0x88,
	 0x21, 0xA0, 0x53, 0x80, 0x00, 0x1D, 0x9A, 0x99,
	 0x83, 0x04, 0x07, 0x05, 0x00, 0xE1, 0x38, 0xF8,
	 0xDC, 0x8A, 0x55, 0x1A, 0x39, 0x39, 0x4D, 0x04,
	 0xA5, 0xD0, 0x0B, 0xE8, 0xC0, 0x01, 0x92, 0x84,
	 0xE8, 0x20, 0x1B, 0xD7, 0xA5, 0xF6, 0xD7, 0x1A},
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //read only
	 0x12, 0x60, 0xA5, 0x3D, 0x50, 0x13, 0x3A, 0x8C,
	 0x32, 0xA0, 0x3B, 0x80, 0x00, 0x3D, 0x34, 0x33,
	 0x83, 0x06, 0x47, 0x15, 0x20, 0xE1, 0x38, 0xF8,
	 0xDC, 0x8A, 0x55, 0x1A, 0x39, 0x39, 0x4D, 0x04,
	 0xA5, 0x10, 0x0B, 0xE8, 0xC0, 0x01, 0x92, 0x84,
...
static UINT8 R858_Atsc_Mode[R858_MAX_NUM][2] = {{0, 0}, {0, 0}};
static UINT8 R858_Atsc_Mode_Pre[R858_MAX_NUM][2] = {{0, 0}, {0, 0}};
static UINT8 R858_Atsc_Mode1_Count[R858_MAX_NUM][2] = {{0, 0}, {0, 0}};
static UINT8 R858_Atsc_Mode2_Count[R858_MAX_NUM][2] = {{0, 0}, {0, 0}};
...
R858_ErrCode R858_AtscMonitor(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, UINT32 Freq_KHz);
...
*/
	...
	case R858_DVB_T2_6M_IF_5M:
		...
		R858_Sys_Info.FILT_EXT_POINT = 3;	  //buf 8
		break;
	case R858_DVB_T_6M_IF_5500:
	case R858_DVB_T2_6M_IF_5500:
	...
	case R858_ISDB_T_IF_5M:
		...
		R858_Sys_Info.FILT_EXT_POINT = 3;	  //buf 8
		break;
	case R858_ISDB_T_IF_5500:
		R858_Sys_Info.IF_KHz = 5500;
		R858_Sys_Info.BW = 1;			  //BW=7M   R17[5:4] [8M(0), 7M(1), 6M(2)]
		R858_Sys_Info.FILT_CAL_IF = 8440; //CAL IF
		R858_Sys_Info.HPF_COR = 2;		  //R18[6:3] [0~15 ; input: "0~15"]
										  //if (R858_Chip == R858_MP)
		R858_Sys_Info.FILT_EXT_ENA = 1;	  //R19[6] filter ext enable [off(0), on(1)]
		//else
...
*/
	...
	case R858_DVB_C_6M_IF_5M:
		...
		R858_SysFreq_Info.RF_VTL_H = 0x29;	 //R31[7:0] RF VTL/H = 0.54(2) / 1.24(9)
...
*/
	...
	{
	case 0:
		R858_SysFreq_Info.DEGLITCH_CLK = 1;	  //R39[2]	["500Hz"(0), "1KHz"(1)]
		...
		R858_SysFreq_Info.NAT_HYS = 1;		  //R52[0]	[" no hys"(0), "- 6.5dB hys"(1)]
		break;

	case 1:
		R858_SysFreq_Info.DEGLITCH_CLK = 1;	  //R39[2]	["500Hz"(0), "1KHz"(1)]
		R858_SysFreq_Info.PUL_FLAG_RANGE = 1; //R40[2:1]	["4~12"(0), "5~13"(1), "6~14"(2), "7~15"(3)]
		R858_SysFreq_Info.FAST_DEGLITCH = 2;  //R40[6:5]	["70ms"(0), "45ms"(1), "20ms"(2), "10ms"(3)]
		R858_SysFreq_Info.PULG_CNT_THRE = 1;  //R45[1]	["threshold =14"(0), "threshold =15"(1)]
		R858_SysFreq_Info.NAT_HYS = 0;		  //R52[0]	[" no hys"(0), "- 6.5dB hys"(1)]
		break;

	case 2:
		R858_SysFreq_Info.DEGLITCH_CLK = 0;	  //R39[2]	["500Hz"(0), "1KHz"(1)]
		R858_SysFreq_Info.PUL_FLAG_RANGE = 2; //R40[2:1]	["4~12"(0), "5~13"(1), "6~14"(2), "7~15"(3)]
		R858_SysFreq_Info.FAST_DEGLITCH = 2;  //R40[6:5]	["70ms"(0), "45ms"(1), "20ms"(2), "10ms"(3)]
		R858_SysFreq_Info.PULG_CNT_THRE = 0;  //R45[1]	["threshold =14"(0), "threshold =15"(1)]
		R858_SysFreq_Info.NAT_HYS = 1;		  //R52[0]	[" no hys"(0), "- 6.5dB hys"(1)]
...
R858_ErrCode R858_Init_ALL(R858_ExtTunerNum_Type R858_Num, R858_Set_Info R858_INFO)
{
	...
	printk("<<<Init Tuner1 Tuner1 Log>>>\n");
	R858_Dump_Data(R858_NUM1, R858_TUNER1);
	printk("\n");
	printk("<<<Init Tuner1 Tuner2 Log>>>\n");
...
#if 0
	printk("Standard2=%d\n", R858_INFO.R858_Standard_2);
	printk("<<<Init Tuner2 Tuner1 Log>>>\n");
	R858_Dump_Data(R858_NUM1, R858_TUNER1);
	printk("\n");
	printk("<<<Init Tuner2 Tuner2 Log>>>\n");
	R858_Dump_Data(R858_NUM1, R858_TUNER2);
	printk("\n");

	printk("<<<----------------End init tuner  Log----------------->>>\n");
#endif
...
R858_ErrCode R858_Cal_Prepare(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, UINT8 u1CalFlag)
{
	...
	case R858_LPF_CAL:
		...
		for (InitArrayCunt = 48; InitArrayCunt < R858_REG_NUM; InitArrayCunt++)
		{
			if (R858_Xtal == 24000)
			{
				R858_I2C_Len.Data[InitArrayCunt - 48] = R858_LPF_CAL_Array_24[R858_TUNER1][InitArrayCunt];
				R858_Array[R858_Num][R858_TUNER1][InitArrayCunt] = R858_LPF_CAL_Array_24[R858_TUNER1][InitArrayCunt];
			}
			else
			{
				R858_I2C_Len.Data[InitArrayCunt - 48] = R858_LPF_CAL_Array_16[R858_TUNER1][InitArrayCunt];
				R858_Array[R858_Num][R858_TUNER1][InitArrayCunt] = R858_LPF_CAL_Array_16[R858_TUNER1][InitArrayCunt];
			}
		}
		...
		if (R858_Xtal == 24000)
			R858_LPF_CAL_Array_24[IntTunerNum][29] = (R858_LPF_CAL_Array_24[IntTunerNum][29] & 0x86) | ((XTAL_CAP_RESOL_1 & 0x1E) << 2) | (XTAL_CAP_RESOL_1 & 0x01); //R29[6:3] R29[
		else
			R858_LPF_CAL_Array_16[IntTunerNum][29] = (R858_LPF_CAL_Array_16[IntTunerNum][29] & 0x86) | ((XTAL_CAP_RESOL_1 & 0x1E) << 2) | (XTAL_CAP_RESOL_1 & 0x01); //R29[6:3] R29[
		...
		for (InitArrayCunt = 8; InitArrayCunt < (R858_REG_NUM); InitArrayCunt++)
		{
			if (R858_Xtal == 24000)
			{
				R858_I2C_Len.Data[InitArrayCunt - 8] = R858_LPF_CAL_Array_24[IntTunerNum][InitArrayCunt];
				R858_Array[R858_Num][IntTunerNum][InitArrayCunt] = R858_LPF_CAL_Array_24[IntTunerNum][InitArrayCunt];
			}
			else
			{
				R858_I2C_Len.Data[InitArrayCunt - 8] = R858_LPF_CAL_Array_16[IntTunerNum][InitArrayCunt];
				R858_Array[R858_Num][IntTunerNum][InitArrayCunt] = R858_LPF_CAL_Array_16[IntTunerNum][InitArrayCunt];
			}
		}
...
*/
	...
	if (R858_Xtal == 24000)
	{
		...
		else //tuner2
		{
			...
			else if (((u2XalDivJudge >= 864000) && (u2XalDivJudge < 878000)) || (u2XalDivJudge == 72000))
			{
				CP_CUR = 0x05; //0.2mA,		R27[2:0]=5
			}
...
R858_ErrCode R858_SetFrequency(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, R858_Set_Info R858_INFO)
{
	...
	else if (R858_LNA_VTHVTL_Change_flag[R858_Num] == 0) //���ݩ�e
	{
	...
	else if (R858_OTH_VTHVTL_Change_flag[R858_Num][IntTunerNum] == 0 && R858_OTH_VTHVTL_Change_flag[R858_Num][1 - IntTunerNum] == 0) //�쥻
	{
    ...
    if (I2C_Write(R858_Num, &R858_I2C) != RT_Success)
       return RT_Fail;*/
	//NA
	R858_I2C.RegAddr = 39; //R39[2]
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0xFB) | (SysFreq_Info1.DEGLITCH_CLK << 2);
	...
	case R858_DVB_C_6M_IF_5500:
		...
		if ((R858_INFO.RF_KHz >= 322000) && (R858_INFO.RF_KHz <= 454000))
		{
			//Diplexer_sel bypass R11[0:1]=1 ,improve sensitivity 0.5~1dB
			R858_I2C.RegAddr = 11;
			R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0xFC) | 0x01;
		}
		break;
	...
	R858_I2C.I2cAddr = R858_ADDRESS[R858_Num][R858_TUNER1];
	//NA
	R858_I2C.RegAddr = 52; //R52[0]
	R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] = (R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] & 0xFE) | (SysFreq_Info1.NAT_HYS);
...
*/
	...
	R858_Atsc_Mode[R858_Num][IntTunerNum] = 0;
...
R858_ErrCode R858_Standby(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, R858_LT_Type R858_LT)
{
	...
	if (R858_SBY_flag[R858_Num][IntTunerNum] == 0)
	{
		...
		{
			R858_I2C.RegAddr = 8;
			R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0xBF) | 0x40;
			R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr];
			if (I2C_Write(R858_Num, &R858_I2C) != RT_Success)
				return RT_Fail;
			R858_I2C.RegAddr = 8;
			...
			if (I2C_Write(R858_Num, &R858_I2C) != RT_Success)
				return RT_Fail;
			R858_I2C.RegAddr = 9; //AGC PWOER=ON
			...
			R858_I2C.RegAddr = 25;
			R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0xF3) | 0x0C;
			R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr];
			if (I2C_Write(R858_Num, &R858_I2C) != RT_Success)
				return RT_Fail;
			R858_I2C.RegAddr = 8;
			...
			//if (R858_INFO.R858_LT == LT_ON) //active LT=ON after LNA standby current=39mA,LT sensitivity=normal
			if (R858_LT == LT_ON) //active LT=ON after LNA standby current=39mA,LT sensitivity=normal
			{
				R858_I2C.RegAddr = 51;
				R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] = (R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] & 0x60) | 0x1F;
			}
			else
			{
				//LNA off, off LT, actLT off, LNA det off NAT off, LT before LNA standby current=17mA,LT sensitivity-=3dB
				R858_I2C.RegAddr = 51;
				R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] = (R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] & 0x60) | 0x08;
			}
			R858_I2C.Data = R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr];
			if (I2C_Write(R858_Num, &R858_I2C) != RT_Success)
				return RT_Fail;
...
{
	UINT16 acc_lna_gain[32] = {
		0, 15, 26, 34, 50, 61, 75, 87, 101, 117,		  //0~9
	...
	*/
	...
	pR858_rf_gain->RF_gain_comb = acc_lna_gain[pR858_rf_gain->RF_gain1] + acc_rf_gain[pR858_rf_gain->RF_gain2] + acc_mixer_gain[pR858_rf_gain->RF_gain3] + pR858_rf_gain->RF_gain4 * 14;
...
R858_ErrCode R858_NA_Ctrl(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, UINT8 FEC_Lock) //Tuner1 & Tuner2 FEC Lock  Lock=1, unlock=0
{
	R858_I2C.I2cAddr = R858_ADDRESS[R858_Num][R858_TUNER1];
	R858_I2C.RegAddr = 51;

	if (FEC_Lock == 1) //1: one of demod FEC lock
	{
		R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] = (R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] & 0x7F) | 0x00; //Off
		R858_Slow_Function(R858_Num, IntTunerNum);
		//R858_Slow_Function(R858_Num, R858_TUNER2);
	}
...
R858_ErrCode R858_Slow_Function(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum)
{
	//R858_Delay_MS(R858_Num, 200); //delay ms
	R858_I2C.I2cAddr = R858_ADDRESS[R858_Num][IntTunerNum];
	R858_I2C.RegAddr = 37; //filter VTH/VTL=0.54/1.34
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = ((R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0x00) | 0x2A);
	R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr];
	if (I2C_Write(R858_Num, &R858_I2C) != RT_Success)
		return RT_Fail;
	R858_I2C.RegAddr = 38; //RF AGC CLK TO 64Hz
...
#if 0
	for (i = 0; i < R858_REG_NUM; i++)
	{
		printk("R%d = 0x%X\n", i, R858_I2C_Len.Data[i]);
	}
#endif
	printk("\n");
...
R858_ErrCode R858_AtscMonitor(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, UINT32 Freq_KHz)
{
	...
	if (R858_Atsc_Mode[R858_Num][R858_IntTunerNum] == 0) //fast
	{
		R858_Atsc_Mode[R858_Num][R858_IntTunerNum] = 1; //slow_narrow
	}
	...
	if ((Freq_KHz > 500000) && (Freq_KHz < 600000))
	{
		...
		filter_gain = (R858_I2C_Len.Data[6] & 0x0F);	 //filter
		mixer_gain = (R858_I2C_Len.Data[5] & 0xF0) >> 4; //mixer

		//monitor in which mode
		if (filter_gain <= 4) //mode2 (slow_wide)
		{
			if (R858_Atsc_Mode2_Count[R858_Num][R858_IntTunerNum] < 3)
			{
				R858_Atsc_Mode2_Count[R858_Num][R858_IntTunerNum]++;
			}

			if (R858_Atsc_Mode2_Count[R858_Num][R858_IntTunerNum] >= 2)
			{
				R858_Atsc_Mode[R858_Num][R858_IntTunerNum] = 2;
				R858_Atsc_Mode1_Count[R858_Num][R858_IntTunerNum] = 0; //clear mode1 count
			}
		}
		else if (filter_gain > 8) //mode1 (slow_narrow)
		{
			if (R858_Atsc_Mode1_Count[R858_Num][R858_IntTunerNum] < 3)
			{
				R858_Atsc_Mode1_Count[R858_Num][R858_IntTunerNum]++;
			}

			if (R858_Atsc_Mode1_Count[R858_Num][R858_IntTunerNum] >= 2)
			{
				R858_Atsc_Mode[R858_Num][R858_IntTunerNum] = 1;
				R858_Atsc_Mode2_Count[R858_Num][R858_IntTunerNum] = 0; //clear mode2 count
			}
		}
	...
	if (R858_Atsc_Mode[R858_Num][R858_IntTunerNum] != R858_Atsc_Mode_Pre[R858_Num][R858_IntTunerNum])
	{
		if (R858_Atsc_Mode[R858_Num][R858_IntTunerNum] == 0) //fast
		{
			// LNA VTL/H = 1.04/1.54
			R858_Array[R858_Num][IntTunerNum][30] = (R858_Array[R858_Num][IntTunerNum][30] & 0x00) | 0x7C;

			// RF VTL/H = 0.94/1.44
			R858_Array[R858_Num][IntTunerNum][31] = (R858_Array[R858_Num][IntTunerNum][31] & 0x00) | 0x6B;

			// MIXER VTL/H = 0.84/1.34
			R858_Array[R858_Num][IntTunerNum][35] = (R858_Array[R858_Num][IntTunerNum][35] & 0x00) | 0x5A;

			//AGC clk = 1K
			R858_Array[R858_Num][IntTunerNum][38] = (R858_Array[R858_Num][IntTunerNum][38] & 0xCF);

			// Mixer Gain Limt = 12
			R858_Array[R858_Num][IntTunerNum][46] = (R858_Array[R858_Num][IntTunerNum][46] & 0x3F) | 0xC0;

			//RF Discharge Mode = both(fast+slow)
			R858_Array[R858_Num][IntTunerNum][32] = (R858_Array[R858_Num][IntTunerNum][32] & 0x6F) | 0x90; //11
			R858_Array[R858_Num][R858_TUNER1][55] = (R858_Array[R858_Num][R858_TUNER1][55] & 0xF7) | 0x08; //1

			//LNA Discharge Mode = both(fast+slow)
			R858_Array[R858_Num][R858_TUNER1][53] = (R858_Array[R858_Num][R858_TUNER1][53] & 0xDF) | 0x20; //1
			R858_Array[R858_Num][R858_TUNER1][55] = (R858_Array[R858_Num][R858_TUNER1][55] & 0xED) | 0x12; //11

			//LNA_RF_dis current = normal
			R858_Array[R858_Num][R858_TUNER1][55] = (R858_Array[R858_Num][R858_TUNER1][55] & 0xDF) | 0x20;
		}
		else if (R858_Atsc_Mode[R858_Num][R858_IntTunerNum] == 1) //slow_narrow
		{
			if (R858_Atsc_Mode_Pre[R858_Num][R858_IntTunerNum] == 2) //slow_wide -> slow_narrow
			{
				if (mixer_gain >= 10)
				{
					//Mixer off (R15[0]=0)
					R858_I2C.RegAddr = 15;
					R858_Array[R858_Num][IntTunerNum][15] = (R858_Array[R858_Num][IntTunerNum][15] & 0xFE) | 0x00;
					R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][15];
					if (I2C_Write(R858_Num, &R858_I2C) != RT_Success)
						return RT_Fail;
					...
					//Mixer gain=11
					R858_I2C.RegAddr = 35;
					R858_Array[R858_Num][IntTunerNum][35] = (R858_Array[R858_Num][IntTunerNum][35] & 0x0F) | (11 << 4);
					R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][35];
					if (I2C_Write(R858_Num, &R858_I2C) != RT_Success)
						return RT_Fail;
				}
			...
			//AGC clk = 64Hz
			R858_Array[R858_Num][IntTunerNum][38] = (R858_Array[R858_Num][IntTunerNum][38] & 0xCF) | 0x30;
		...
		{
			if (R858_Atsc_Mode_Pre[R858_Num][R858_IntTunerNum] == 1) //slow_narrow -> slow_wide
			{
				if (mixer_gain >= 12)
				{
					//Mixer off (R15[0]=0)
			...
			// LNA VTL/H = 0.74/1.54
			R858_Array[R858_Num][IntTunerNum][30] = (R858_Array[R858_Num][IntTunerNum][30] & 0x00) | 0x4C;

			// RF VTL/H = 0.74/1.44
			R858_Array[R858_Num][IntTunerNum][31] = (R858_Array[R858_Num][IntTunerNum][31] & 0x00) | 0x4B;

			// MIXER VTL/H = 0.74/1.44
			R858_Array[R858_Num][IntTunerNum][35] = (R858_Array[R858_Num][IntTunerNum][35] & 0x00) | 0x4B;

			//AGC clk = 64Hz
			R858_Array[R858_Num][IntTunerNum][38] = (R858_Array[R858_Num][IntTunerNum][38] & 0xCF) | 0x30;

			// Mixer Gain Limt = 10
			R858_Array[R858_Num][IntTunerNum][46] = (R858_Array[R858_Num][IntTunerNum][46] & 0x3F) | 0x80;

			//RF Discharge Mode = slow
			R858_Array[R858_Num][IntTunerNum][32] = (R858_Array[R858_Num][IntTunerNum][32] & 0x6F) | 0x80; //10
			R858_Array[R858_Num][R858_TUNER1][55] = (R858_Array[R858_Num][R858_TUNER1][55] & 0xF7) | 0x08; //1

			//LNA Discharge Mode = slow
			R858_Array[R858_Num][R858_TUNER1][53] = (R858_Array[R858_Num][R858_TUNER1][53] & 0xDF);		   //0
			R858_Array[R858_Num][R858_TUNER1][55] = (R858_Array[R858_Num][R858_TUNER1][55] & 0xED) | 0x12; //11

			//LNA_RF_dis current = 1/3
			R858_Array[R858_Num][R858_TUNER1][55] = (R858_Array[R858_Num][R858_TUNER1][55] & 0xDF);
		...
		//Mixer off (R15[0]=0)
		R858_I2C.RegAddr = 15;
		R858_Array[R858_Num][IntTunerNum][15] = (R858_Array[R858_Num][IntTunerNum][15] & 0xFE) | 0x01;
		R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][15];
		if (I2C_Write(R858_Num, &R858_I2C) != RT_Success)
			return RT_Fail;
	...
	R858_Atsc_Mode_Pre[R858_Num][R858_IntTunerNum] = R858_Atsc_Mode[R858_Num][R858_IntTunerNum];
