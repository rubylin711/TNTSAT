...
*/
/*----------------------------------------------------------------------------*/
#ifndef SONY_TUNER_R858_H_
#define SONY_TUNER_R858_H_
...
/*------------------------------------------------------------------------------
 Driver Version
------------------------------------------------------------------------------*/
extern const char *sony_tuner_r858_version; /**< R836 driver version */

/*------------------------------------------------------------------------------
 Defines
------------------------------------------------------------------------------*/
#define SONY_TUNER_R858_OFFSET_CUTOFF_HZ 50000 /**< Maximum carrier offset frequency before requiring a retune */

typedef enum
{
	SONY_R858_STATE_UNKNOWN, /**< R836 state is Unknown */
	SONY_R858_STATE_SLEEP,   /**< R836 state is Sleep */
	SONY_R858_STATE_ACTIVE   /**< R836 state is Active */
} sony_r858_state_t;
...
typedef struct
{
	...
	sony_r858_state_t state;     /**< The driver operating state. */
	uint32_t frequencykHz;       /**< Currently RF frequency(kHz) tuned. */
	R858_Standard_Type tvSystem1; /**< Current broadcasting system tuned. */
	R858_Standard_Type tvSystem2; /**< Current broadcasting system tuned. */

	int dev_id;
	void *user; /**< User defined data. */
} sony_r858_t;

extern sony_r858_t *g_pR858Tuner;
//#define CUR_FE_ID (g_pR858Tuner->dev_id) //clean warning
