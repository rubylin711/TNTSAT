...
/*****************************************************************************/
/*
 * Filename:            mt_fe_dmd_cs8000_cab.c
 *
 * Description:         Montage QAM demodulator driver of Jazz.
 *
 * Current Version:     0.01.04
 *
 *  History:
 *
 *  Description     Version     Date        Author
 *---------------------------------------------------------------------------
 *  File Create     0.00.01     2016.09.01  YZ.Huang
 *  Modify          0.01.00     2016.10.20  YZ.Huang
 *  Modify          0.01.01     2016.10.28  YZ.Huang
 *  Modify          0.01.02     2016.11.07  YZ.Huang
 *  Modify          0.01.03     2016.11.10  YZ.Huang
 *  Modify          0.01.04     2016.12.14  YZ.Huang
 *****************************************************************************/
...
extern MT_FE_CA8K_CAB_TN_SETTINGS ca8k_tuner_ops;

MT_FE_RET mt_fe_dmd_ca8k_cab_config_default(MT_FE_CA8K_CAB_Device_Handle handle)
{
    //MT_FE_CA8K_CAB_SUPPORTED_TUNER tuner_type;
    ...
    handle->chip_id = 0;
    handle->demod_type = MT_FE_DEMOD_CS8000_CAB;
    handle->dtv_mode = MtFeType_DVBC;

    handle->channel_param.freq_KHz = 762000;
    ...
    handle->tuner_settings.tuner_type = TN_MONTAGE_TC6800;
    handle->tuner_settings.tuner_dev_addr = 0xC6;
    handle->tuner_settings.tuner_mode = 0;
    handle->tuner_settings.tuner_handle = 0; //NULL;
    handle->tuner_settings.tuner_reserved = 0;

    handle->tuner_settings.tuner_init = mt_fe_tn_init_tc6800_ca8k;
    handle->tuner_settings.tuner_set = mt_fe_tn_set_freq_tc6800_ca8k;
    handle->tuner_settings.tuner_get_offset = mt_fe_tn_get_offset_tc6800_ca8k;
    handle->tuner_settings.tuner_get_strength = mt_fe_tn_get_strength_tc6800_ca8k;

    handle->tuner_settings.tuner_sleep = mt_fe_tn_sleep_tc6800_ca8k;
    handle->tuner_settings.tuner_wakeup = mt_fe_tn_wakeup_tc6800_ca8k;
    handle->tuner_settings.tuner_get_version = mt_fe_tn_get_version_tc6800_ca8k;

    handle->tuner_settings.tuner_self_check = NULL; //mt_fe_cs8k_cab_tn_self_check_tc3800;
    ...
    //tuner_type = mt_fe_ca8k_cab_check_tuner_type(handle);

    handle->tuner_settings.tuner_type = TN_MONTAGE_TC6800; //tuner_type;

    return MtFeErr_Ok;
}

MT_FE_RET mt_fe_dmd_ca8k_cab_select_tuner(MT_FE_CA8K_CAB_Device_Handle handle, MT_FE_CA8K_CAB_SUPPORTED_TUNER tuner_type)
{
#if 0
	...
	{
		handle->tuner_settings.tuner_init			 = mt_fe_cs8k_cab_tn_init_tc2800;
		handle->tuner_settings.tuner_set			 = mt_fe_cs8k_cab_tn_set_freq_tc2800;
		handle->tuner_settings.tuner_get_offset		 = mt_fe_cs8k_cab_tn_get_offset_tc2800;
		handle->tuner_settings.tuner_get_strength	 = mt_fe_cs8k_cab_tn_get_strength_tc2800;

		handle->tuner_settings.tuner_sleep			 = mt_fe_cs8k_cab_tn_sleep_tc2800;
		handle->tuner_settings.tuner_wakeup			 = mt_fe_cs8k_cab_tn_wakeup_tc2800;
		handle->tuner_settings.tuner_get_version	 = mt_fe_cs8k_cab_tn_get_version_tc2800;

		handle->tuner_settings.tuner_self_check		 = mt_fe_cs8k_cab_tn_self_check_tc2800;
	}
	else if(tuner_type == TN_MONTAGE_TC3800)
	{
		handle->tuner_settings.tuner_init			 = mt_fe_cs8k_cab_tn_init_tc3800;
		handle->tuner_settings.tuner_set			 = mt_fe_cs8k_cab_tn_set_freq_tc3800;
		handle->tuner_settings.tuner_get_offset		 = mt_fe_cs8k_cab_tn_get_offset_tc3800;
		handle->tuner_settings.tuner_get_strength	 = mt_fe_cs8k_cab_tn_get_strength_tc3800;

		handle->tuner_settings.tuner_sleep			 = mt_fe_cs8k_cab_tn_sleep_tc3800;
		handle->tuner_settings.tuner_wakeup			 = mt_fe_cs8k_cab_tn_wakeup_tc3800;
		handle->tuner_settings.tuner_get_version	 = mt_fe_cs8k_cab_tn_get_version_tc3800;

		handle->tuner_settings.tuner_self_check		 = mt_fe_cs8k_cab_tn_self_check_tc3800;
	}
	else if(tuner_type != MT_FE_TN_NOTSUPPORT)
	{
		handle->tuner_settings.tuner_init			 = ca8k_tuner_ops.tuner_init;
		handle->tuner_settings.tuner_set			 = ca8k_tuner_ops.tuner_set;
		handle->tuner_settings.tuner_get_offset		 = ca8k_tuner_ops.tuner_get_offset;
		handle->tuner_settings.tuner_get_strength	 = ca8k_tuner_ops.tuner_get_strength;

		handle->tuner_settings.tuner_sleep			 = ca8k_tuner_ops.tuner_sleep;
		handle->tuner_settings.tuner_wakeup			 = ca8k_tuner_ops.tuner_wakeup;
		handle->tuner_settings.tuner_get_version	 = ca8k_tuner_ops.tuner_get_version;

		handle->tuner_settings.tuner_self_check		 = ca8k_tuner_ops.tuner_self_check;
	}
	else
	{
		...
		handle->tuner_settings.tuner_get_version	 = mt_fe_cs8k_cab_tn_get_version_default;

		handle->tuner_settings.tuner_self_check		 = NULL;
	}
...
MT_FE_RET mt_fe_dmd_ca8k_cab_config_tuner_settings(MT_FE_CA8K_CAB_Device_Handle handle, MT_FE_CA8K_CAB_TN_SETTINGS *tuner_config)
{
...
MT_FE_RET mt_fe_dmd_ca8k_cab_calibration(MT_FE_CA8K_CAB_Device_Handle handle, U8 iMaxTimes)
{
    U8 tmp1, tmp2, tmp3, i;
	...
	MT_INFO_FRONTEND("\tCS8000 cable calibration OK!\n");
    } else {
	MT_INFO_FRONTEND("\tCS8000 cable calibration failed!\n");
    }
...
MT_FE_RET mt_fe_dmd_ca8k_cab_init(MT_FE_CA8K_CAB_Device_Handle handle)
{
	MT_FE_RET ret = MtFeErr_Ok;
	...
	handle->Get32Bits(0xA4, &reg1);//0xFFAF00A4
	handle->Get32Bits(0xA0, &reg2);//0xFFAF00A0
	handle->Get32Bits(0xB8, &reg3);//0xFFAF00B8
	handle->Get32Bits(0xB4, &reg4);//0xFFAF00B4


#if 1		// No. 3
	handle->Set32Bits(0xA4, 0xF0002D4F);//0xFFAF00A4
	handle->Set32Bits(0xA0, 0x00404040);//0xFFAF00A0
	handle->Set32Bits(0xB8, 0x1C0D88FA);//0xFFAF00B8
	handle->Set32Bits(0xB4, 0x00003800);//0xFFAF00B4

	handle->Get32Bits(0xA4, &value1);//0xFFAF00A4
	handle->Get32Bits(0xA0, &value2);//0xFFAF00A4
	handle->Get32Bits(0xB8, &value3);//0xFFAF00A4
	handle->Get32Bits(0xB4, &value4);//0xFFAF00A4

	MT_INFO_FRONTEND("value1 = 0x%08x value2= 0x%08x, value3 = 0x%08x, value4 = 0x%08x.\n", value1, value2, value3, value4);

#else		// No. 4
	handle->Set32Bits(0xFFAF00A4, 0xF0002DCF);
	handle->Set32Bits(0xFFAF00A0, 0x00404040);
	handle->Set32Bits(0xFFAF00B8, 0x1C0D88FA);
	handle->Set32Bits(0xFFAF00B4, 0x00003800);
#endif
    ...
    mt_fe_dmd_ca8k_cab_calibration(handle, 5);
...
#if 1
	handle->Set32Bits(0xA4, reg1);//0xFFAF00A4
	handle->Set32Bits(0xA0, reg2);//0xFFAF00A0
	handle->Set32Bits(0xB8, reg3);//0xFFAF00B8
	handle->Set32Bits(0xB4, reg4);//0xFFAF00B4
#endif
...
MT_FE_RET mt_fe_dmd_ca8k_cab_connect(MT_FE_CA8K_CAB_Device_Handle handle, U32 freq_KHz, U16 symbol_rate_KSs, U16 qam, U8 inverted)
{
    MT_FE_RET ret = MtFeErr_Ok;
    U8 tmp1, tmp2;
    ...
    _mt_fe_dmd_ca8k_cab_set_demod(handle);

    _mt_fe_dmd_ca8k_cab_set_symbol_rate(handle, symbol_rate_KSs, handle->on_board_settings.xtal_KHz);

    _mt_fe_dmd_ca8k_cab_set_QAM(handle, qam);
    _mt_fe_dmd_ca8k_cab_set_tx_mode(handle, inverted, 0); /* J83A */
    _mt_fe_dmd_ca8k_cab_set_ts_output(handle, handle->ts_output_settings.output_mode);

    _mt_fe_dmd_ca8k_cab_set_demod_appendix(handle, qam);
	...
	{
	    if (handle->on_board_settings.iGainStep == 1) {
		handle->tn_set_reg(handle, 0x1E, 0x9D);
    ...
    } else if (handle->tuner_settings.tuner_type == TN_MONTAGE_TC6800) {
	if (handle->on_board_settings.iVppSel == 0) // 2V
	{
	    handle->tn_set_reg(handle, 0x22, 0xA5);
	} else // 1V
	{
	    handle->tn_set_reg(handle, 0x22, 0x95);
	}
    }

    mt_fe_dmd_ca8k_cab_soft_reset(handle);
...
************************************************/
MT_FE_RET _mt_fe_dmd_ca8k_cab_set_demod(MT_FE_CA8K_CAB_Device_Handle handle)
{
    if (handle == NULL) {
	return MtFeErr_Uninit;
    }
    ...
    //handle->dmd_set_reg(handle, 0x55, 0x7A);	// set symbol rate
...
/***********************************************
   ...
   xtal:	unit, KHz
************************************************/
MT_FE_RET _mt_fe_dmd_ca8k_cab_set_symbol_rate(MT_FE_CA8K_CAB_Device_Handle handle, U32 sym, U32 xtal)
{
    MT_FE_RET ret = MtFeErr_Ok;
...
************************************************/
MT_FE_RET _mt_fe_dmd_ca8k_cab_set_QAM(MT_FE_CA8K_CAB_Device_Handle handle, U16 qam)
{
    MT_FE_RET ret = MtFeErr_Ok;
...
/***********************************************
   ...
   J83: 0, J83A; 1, J83C
 ***********************************************/
MT_FE_RET _mt_fe_dmd_ca8k_cab_set_tx_mode(MT_FE_CA8K_CAB_Device_Handle handle, U8 inverted, U8 j83)
{
    MT_FE_RET ret = MtFeErr_Ok;
...
************************************************/
MT_FE_RET _mt_fe_dmd_ca8k_cab_set_ts_output(MT_FE_CA8K_CAB_Device_Handle handle, MT_FE_TS_OUT_MODE ts_mode)
{
    MT_FE_RET ret = MtFeErr_Ok;
...
MT_FE_RET _mt_fe_dmd_ca8k_cab_set_demod_appendix(MT_FE_CA8K_CAB_Device_Handle handle, U16 qam)
{
    MT_FE_RET ret = MtFeErr_Ok;
    ...
    //handle->dmd_get_reg(handle, 0x95, &tmp);
    //tmp |= 0x40;
    tmp = 0x40;
    ...
    handle->dmd_set_reg(handle, 0xce, 0x6d);
    handle->dmd_set_reg(handle, 0xb8, 0x3c);
...
************************************************/
MT_FE_RET mt_fe_dmd_ca8k_cab_soft_reset(MT_FE_CA8K_CAB_Device_Handle handle)
{
    MT_FE_RET ret = MtFeErr_Ok;
...
MT_FE_RET mt_fe_dmd_ca8k_cab_get_statistics(MT_FE_CA8K_CAB_Device_Handle handle,
                                            U32 *agc_lock,
                                            U32 *timing_lock,
                                            U32 *dagc_lock,
                                            U32 *carrier_lock,
...
************************************************/
MT_FE_RET mt_fe_dmd_ca8k_cab_get_lock_state(MT_FE_CA8K_CAB_Device_Handle handle, MT_FE_LOCK_STATE *lock_status)
{
    MT_FE_RET ret = MtFeErr_Ok;
...
//handle->dmd_get_reg(handle, 0x80, &reg80H);		// 0x86
...
************************************************/
MT_FE_RET mt_fe_dmd_ca8k_cab_get_ber(MT_FE_CA8K_CAB_Device_Handle handle, U32 *error_bits, U32 *total_bits)
{
    MT_FE_RET ret = MtFeErr_Ok;
    ...
    mt_fe_dmd_ca8k_cab_get_lock_state(handle, &lock_status);
...
************************************************/
MT_FE_RET mt_fe_dmd_ca8k_cab_get_snr(MT_FE_CA8K_CAB_Device_Handle handle, U8 *signal_snr)
{
    MT_FE_RET ret = MtFeErr_Ok;
...
/***********************************************
   Get signal strength
************************************************/
MT_FE_RET mt_fe_dmd_ca8k_cab_get_strength(MT_FE_CA8K_CAB_Device_Handle handle, U8 *signal_strength)
{
    MT_FE_RET ret = MtFeErr_Ok;
    ...
    if (handle->tuner_settings.tuner_get_strength != NULL) {
	U32 gain = 0, strength = 0;
...
MT_FE_RET mt_fe_dmd_ca8k_cab_get_offset(MT_FE_CA8K_CAB_Device_Handle handle, S32 *freq_offset_KHz, S32 *symbol_rate_offset_KSs)
{
    MT_FE_RET ret = MtFeErr_Ok;
    ...
    *freq_offset_KHz = freq_offset;
	...
	offset_val = (S32)reg51H;
    }

    //*symbol_rate_offset_KSs = (S32)(offset_val * (S32)(handle->channel_param.sym_KSs) * 0.5 / 1000);

    *symbol_rate_offset_KSs = (S32)(offset_val * (S32)(handle->channel_param.sym_KSs) / 2000);

    return ret;
}

MT_FE_RET mt_fe_dmd_ca8k_cab_get_symbol_rate(MT_FE_CA8K_CAB_Device_Handle handle, U16 *symbol_rate_KSs)
{
    U32 dwValue = 0;
...
MT_FE_RET mt_fe_dmd_ca8k_cab_get_tuner_version(MT_FE_CA8K_CAB_Device_Handle handle, U32 *version_no, U32 *version_time)
{
    MT_FE_RET ret = MtFeErr_Ok;
...
MT_FE_RET mt_fe_dmd_ca8k_cab_get_driver_version(U32 *version_no, U32 *version_time)
{
    *version_no = 104;
    *version_time = 16121415;
