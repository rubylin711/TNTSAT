...
#define M88CA8K_I2C_ADDR 0x38 /* M88DC2000 address            */
#define STBLT_IMP 0           /* 0: default ; 1:stability improvement*/

/*****************************************************************************/

typedef struct _MT_FE_CA8K_CAB_TS_OUTPUT_SETTING
{
...
} MT_FE_CA8K_CAB_TS_OUTPUT_SETTINGS;
...
typedef struct _MT_FE_CA8K_CAB_ON_BOARD_SETTINGS
{
...
} MT_FE_CA8K_CAB_ON_BOARD_SETTINGS;

typedef enum _MT_FE_CA8K_CAB_SUPPORTED_TUNER {
...
} MT_FE_CA8K_CAB_SUPPORTED_TUNER;

typedef struct _MT_FE_CA8K_CAB_TN_SETTINGS
{
    MT_BOOL tuner_init_OK;
    MT_FE_CA8K_CAB_SUPPORTED_TUNER tuner_type; /* tuner type*/
...
} MT_FE_CA8K_CAB_TN_SETTINGS, *MT_FE_CA8K_CAB_Tuner_Handle;

typedef struct _MT_FE_CA8K_CAB_SETTINGS
{
    U8 dev_index;      /*index*/
    U8 demod_dev_addr; /*demodulator device i2c addres*/
    U32 chip_id;       /*chip id, version*/
    U8 demod_i2c_id;   /*demodulator device i2c addres*/
    U8 tuner_i2c_id;   /*tuner device i2c addres*/

    MT_FE_SUPPORTED_DEMOD demod_type; /*demod type*/
    MT_FE_TYPE dtv_mode;              /*dtv mode*/
    MT_FE_DTV_PARAMETER_DVBC channel_param;
    MT_FE_CA8K_CAB_TN_SETTINGS tuner_settings; /*tuner settings*/
    MT_FE_CA8K_CAB_ON_BOARD_SETTINGS on_board_settings;
    MT_FE_CA8K_CAB_TS_OUTPUT_SETTINGS ts_output_settings;
...
} MT_FE_CA8K_CAB_SETTINGS, *MT_FE_CA8K_CAB_Device_Handle;
...
MT_FE_RET mt_fe_dmd_ca8k_cab_get_statistics(MT_FE_CA8K_CAB_Device_Handle handle, U32 *agc_lock, U32 *timing_lock,
                                            U32 *dagc_lock, U32 *carrier_lock, U32 *sync_lock, U32 *descrambler_lock, U32 *chip_lock);

/*Supported tuner APIs*/
MT_FE_RET mt_fe_ca8k_cab_tn_get_version_default(void *dev_handle, U32 *version_no, U32 *version_time);
