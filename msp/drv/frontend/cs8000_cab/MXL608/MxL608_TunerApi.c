                                          ...
                                          UINT8 standbyLt)
{
  ...
  switch(powerMode)
  {
    ...
    case MXL608_PWR_MODE_ACTIVE:
	  ...
	  printk("----MxLWare608_API_CfgDevPowerMode()---- Set tuner register 0x%02x - 0x01\n", TUNER_ENABLE_REG);
    ...
    case MXL608_PWR_MODE_STANDBY:
	  ...
	  printk("----MxLWare608_API_CfgDevPowerMode()---- Set tuner register 0x%02x - 0x00\n", TUNER_ENABLE_REG);
                                           ...
                                           MXL608_CHAN_TUNE_CFG_T chanTuneCfg)
{
  ...
  if (chanTuneCfg.startTune == MXL_ENABLE)
  {
    if (chanTuneCfg.signalMode <= MXL608_DIG_J83B)
    {
	  ...
	  printk("----MxLWare608_API_CfgTunerChanTune()---- Set tuner register 0x%02x - 0x01\n", TUNER_ENABLE_REG);
