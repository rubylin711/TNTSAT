                 ...
                 )
{
    ...
    if(err == TM_OK)
    {
        ...
        if(RegAddr < TDA18250A_REG_MAP_NB_BYTES && pObj != Null)
        {
        ...
        if( (eBusAccess&Bus_NoRead) == False && P_SIO_READ_VALID && pObj != Null)
        {
        ...
        if(err == TM_OK)
        {
            ...
            *pRegData |= uData << pBitField->PositionInBits;
            ...
            if( (eBusAccess&Bus_NoWrite) == False && P_SIO_WRITE_VALID && pObj != Null)
            {
                       ...
                       )
{
    ...
    if(err == TM_OK && P_SIO_WRITE_VALID && pObj != Null)
    {
        /* Write data to TDA18250A */
                      ...
                      )
{
    ...
    if(err == TM_OK && P_SIO_READ_VALID && pObj != Null)
    {
        /* Read data from TDA18250A */
