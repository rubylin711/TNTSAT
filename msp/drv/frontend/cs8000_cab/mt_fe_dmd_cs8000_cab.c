...
/* 0xbf130000 */
#define R_PUBLIC_BASE	mt_get_public_base()

/* 0xbf5d0000 */
#define R_ANALOG_SW_BASE	SYMPHONY_ANALOG_SW_BASE

//extern MT_FE_CS8000_CAB_TN_SETTINGS dc2800_tuner_ops;

MT_FE_RET mt_fe_dmd_cs8k_cab_config_default(MT_FE_CS8000_CAB_Device_Handle handle)
{
    MT_FE_CS8000_CAB_SUPPORTED_TUNER tuner_type = TN_MONTAGE_TC3800;
    ...
    handle->tuner_settings.tuner_handle = 0;
    handle->tuner_settings.tuner_reserved = 0;

#ifdef CFG_MT_FRONTEND_DMD_CS8K_CABLE_TN_TC3800_SUPPORT
    ...
    handle->mt_sleep = _mt_cs8k_cab_sleep;
    handle->Set32Bits = _mt_fe_write32;
    handle->Get32Bits = _mt_fe_read32;

    //tuner_type = mt_fe_cs8k_cab_check_tuner_type(handle);
...
extern MT_FE_CS8000_CAB_TN_SETTINGS cs8000_cab_tuner_ops; //dc2800_tuner_ops;
MT_FE_RET mt_fe_dmd_cs8k_cab_select_tuner(MT_FE_CS8000_CAB_Device_Handle handle, MT_FE_CS8000_CAB_SUPPORTED_TUNER tuner_type)
{
    ...
    if (tuner_type == TN_MONTAGE_TC3800) {
#ifdef CFG_MT_FRONTEND_DMD_CS8K_CABLE_TN_TC3800_SUPPORT
	handle->tuner_settings.tuner_init = mt_fe_cs8k_cab_tn_init_tc3800;
	handle->tuner_settings.tuner_set = mt_fe_cs8k_cab_tn_set_freq_tc3800;
	handle->tuner_settings.tuner_get_offset = mt_fe_cs8k_cab_tn_get_offset_tc3800;
	...
	handle->tuner_settings.tuner_self_check = mt_fe_cs8k_cab_tn_self_check_tc3800;
#endif
    } else if (tuner_type == TN_MONTAGE_TC6800) {
#ifdef CFG_MT_FRONTEND_DMD_CS8K_CABLE_TN_TC6800_SUPPORT
	handle->tuner_settings.tuner_init = mt_fe_cs8k_cab_tn_init_tc6800;
	handle->tuner_settings.tuner_set = mt_fe_cs8k_cab_tn_set_freq_tc6800;
	handle->tuner_settings.tuner_get_offset = mt_fe_cs8k_cab_tn_get_offset_tc6800;
	handle->tuner_settings.tuner_get_strength = mt_fe_cs8k_cab_tn_get_strength_tc6800;

	handle->tuner_settings.tuner_sleep = mt_fe_cs8k_cab_tn_sleep_tc6800;
	handle->tuner_settings.tuner_wakeup = mt_fe_cs8k_cab_tn_wakeup_tc6800;
	handle->tuner_settings.tuner_get_version = mt_fe_cs8k_cab_tn_get_version_tc6800;

	handle->tuner_settings.tuner_self_check = mt_fe_cs8k_cab_tn_self_check_tc6800;
	handle->tuner_settings.tuner_set_crystal = mt_fe_cs8k_cab_tn_set_crystal_tc6800;
#endif
    }
#if 0
	else if(tuner_type == TN_MXL_608)
	{
	    handle->tuner_settings.tuner_init            = mt_fe_cs8k_cab_tn_init_MXL608;
	    handle->tuner_settings.tuner_set             = mt_fe_cs8k_cab_tn_set_freq_MXL608;
	    handle->tuner_settings.tuner_get_offset      = NULL;
	    handle->tuner_settings.tuner_get_strength    = mt_fe_cs8k_cab_tn_get_strength_MXL608;
	    ...
	    handle->tuner_settings.tuner_self_check      = mt_fe_cs8k_cab_tn_self_check_MxL608;
	}
	else if(tuner_type == TN_MXL_203)
	{
	    handle->tuner_settings.tuner_init            = mt_fe_cs8k_cab_tn_init_MxL203;
	    handle->tuner_settings.tuner_set             = mt_fe_cs8k_cab_tn_set_freq_MxL203;
	    handle->tuner_settings.tuner_get_offset      = NULL;
	    handle->tuner_settings.tuner_get_strength    = mt_fe_cs8k_cab_tn_get_strength_MxL203;

	    handle->tuner_settings.tuner_sleep           = NULL;
	    handle->tuner_settings.tuner_wakeup          = NULL;
	    handle->tuner_settings.tuner_get_version     = NULL;

	    handle->tuner_settings.tuner_self_check      = mt_fe_cs8k_cab_tn_self_check_MxL203;
	}
	else if(tuner_type == TN_NXP_TDA18250)
	{
	    handle->tuner_settings.tuner_init            = mt_fe_cs8k_cab_tn_init_TDA18250;
	    handle->tuner_settings.tuner_set             = mt_fe_cs8k_cab_tn_set_freq_TDA18250;
	    handle->tuner_settings.tuner_get_offset      = NULL;
	    handle->tuner_settings.tuner_get_strength    = mt_fe_cs8k_cab_tn_get_strength_TDA18250;

	    handle->tuner_settings.tuner_sleep           = NULL;
	    handle->tuner_settings.tuner_wakeup          = NULL;
	    handle->tuner_settings.tuner_get_version     = mt_fe_cs8k_cab_tn_get_version_TDA18250;

	    handle->tuner_settings.tuner_self_check      = mt_fe_cs8k_cab_tn_self_check_TDA18250;

	}
	else if(tuner_type == TN_NXP_TDA18250A)
	{
	    handle->tuner_settings.tuner_init            = mt_fe_cs8k_cab_tn_init_TDA18250A;
	    handle->tuner_settings.tuner_set             = mt_fe_cs8k_cab_tn_set_freq_TDA18250A;
	    handle->tuner_settings.tuner_get_offset      = NULL;
	    handle->tuner_settings.tuner_get_strength    = mt_fe_cs8k_cab_tn_get_strength_TDA18250A;
	...
	{
	   handle->tuner_settings.tuner_init            = mt_fe_cs8k_cab_tn_init_R836;
	   handle->tuner_settings.tuner_set             = mt_fe_cs8k_cab_tn_set_freq_R836;
	   handle->tuner_settings.tuner_get_offset      = NULL;
	   handle->tuner_settings.tuner_get_strength    = mt_fe_cs8k_cab_tn_get_strength_R836;

	   handle->tuner_settings.tuner_sleep           = NULL;
	   handle->tuner_settings.tuner_wakeup          = NULL;
	   handle->tuner_settings.tuner_get_version     = NULL;

	   handle->tuner_settings.tuner_self_check      = mt_fe_cs8k_cab_tn_self_check_R836;
	}
#endif
    else {
...
MT_FE_RET mt_fe_dmd_cs8k_cab_calibration(MT_FE_CS8000_CAB_Device_Handle handle, U8 iMaxTimes)
{
    ...
    if (handle->demod_type == MT_FE_DEMOD_M88DC2800)
    {
        return MtFeErr_Ok;
    }
    ...
    if ((tmp3 == 0x2C) || (tmp3 == 0x2D) || (tmp3 == 0x2E)) {
...
MT_FE_RET mt_fe_dmd_cs8k_cab_init(MT_FE_CS8000_CAB_Device_Handle handle)
{
    ...
    handle->Get32Bits(R_PUBLIC_BASE + 0xC00C, &reg2);
    // bit[11:8] = _1
    reg2 &= 0xFFFFF0FF;
    reg2 |= 0x00000100;
    handle->Set32Bits(R_PUBLIC_BASE + 0xC00C, reg2);

    handle->Get32Bits(R_ANALOG_SW_BASE + 0x00D0, &reg1);
    // bit[10:8] = _100
    reg1 &= 0xFFFFF8FF;
    reg1 |= 0x00000400;
    handle->Set32Bits(R_ANALOG_SW_BASE + 0x00D0, reg1);

    handle->Get32Bits(R_ANALOG_SW_BASE + 0x0098, &reg1);
    handle->Get32Bits(R_ANALOG_SW_BASE + 0x009C, &reg2);
    handle->Get32Bits(R_ANALOG_SW_BASE + 0x004C, &reg3);

    handle->Set32Bits(R_ANALOG_SW_BASE + 0x0098, 0xF000281F);
    handle->Set32Bits(R_ANALOG_SW_BASE + 0x009C, 0x00404040);
    handle->Set32Bits(R_ANALOG_SW_BASE + 0x004C, 0x0EA1BB01);
    ...
    mt_fe_dmd_cs8k_cab_calibration(handle, 5);
    ...
    handle->Set32Bits(R_ANALOG_SW_BASE + 0x0098, reg1);
    handle->Set32Bits(R_ANALOG_SW_BASE + 0x009C, reg2);
    handle->Set32Bits(R_ANALOG_SW_BASE + 0x004C, reg3);
    }
...
MT_FE_RET mt_fe_dmd_cs8k_cab_connect(MT_FE_CS8000_CAB_Device_Handle handle, U32 freq_KHz, U16 symbol_rate_KSs, U16 qam, U8 inverted)
{
    ...
    _mt_fe_dmd_cs8k_cab_set_demod(handle);

    _mt_fe_dmd_cs8k_cab_set_symbol_rate(handle, symbol_rate_KSs, handle->on_board_settings.xtal_KHz);

    _mt_fe_dmd_cs8k_cab_set_QAM(handle, qam);
    _mt_fe_dmd_cs8k_cab_set_tx_mode(handle, inverted, 0); /* J83A */
    _mt_fe_dmd_cs8k_cab_set_ts_output(handle, handle->ts_output_settings.output_mode);

    _mt_fe_dmd_cs8k_cab_set_demod_appendix(handle, qam);

    if (((handle->tuner_settings.tuner_type == TN_NXP_TDA18250) || (handle->tuner_settings.tuner_type == TN_NXP_TDA18250A) ||
         (handle->tuner_settings.tuner_type == TN_MXL_608)) && (handle->on_board_settings.chip_mode != 2))
    {
    ...
    mt_fe_dmd_cs8k_cab_soft_reset(handle);
...
MT_FE_RET _mt_fe_dmd_cs8k_cab_set_demod(MT_FE_CS8000_CAB_Device_Handle handle)
{
	...
	else if (((RegE3H & 0xC0) == 0x80) && ((RegE4H & 0xC0) == 0x40))
	{
		...
		if((handle->tuner_settings.tuner_type == TN_MONTAGE_TC2800) || (handle->tuner_settings.tuner_type == TN_MONTAGE_TC3800))
		{
			handle->dmd_set_reg(handle, 0x3A, 0x60);
		}
		else
		{
...
MT_FE_RET _mt_fe_dmd_cs8k_cab_set_demod_appendix(MT_FE_CS8000_CAB_Device_Handle handle, U16 qam)
{
	...
	if(handle->on_board_settings.chip_mode == 2)
	{
		if (handle->tuner_settings.tuner_type == TN_MXL_608)
		{
			...
			{
				handle->dmd_set_reg(handle, 0x2a, 0x2e);
			}
		}
	}
	else
...
MT_FE_RET mt_fe_dmd_cs8k_cab_get_statistics(MT_FE_CS8000_CAB_Device_Handle handle,
                                            U32 *agc_lock,
                                            U32 *timing_lock,
                                            U32 *dagc_lock,
                                            U32 *carrier_lock,
...
MT_FE_RET mt_fe_dmd_cs8k_cab_get_ber(MT_FE_CS8000_CAB_Device_Handle handle, U32 *error_bits, U32 *total_bits)
{
    ...
    mt_fe_dmd_cs8k_cab_get_lock_state(handle, &lock_status);
