...
//extern MT_FE_RET _mt_fe_tn_get_reg(MT_FE_CS8000_CAB_Device_Handle handle, U8 reg_addr, U8 *reg_data);
//extern MT_FE_RET _mt_fe_tn_set_reg(MT_FE_CS8000_CAB_Device_Handle handle, U8 reg_addr, U8 reg_data);
