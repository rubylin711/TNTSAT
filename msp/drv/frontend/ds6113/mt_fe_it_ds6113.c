...
/*****************************************************************************/
/*****************************************************************************/
/* Filename:      mt_fe_it_ds6113.c
 *
 * Description:   Montage M88DS6113 Digital Satellite Tuner IC driver.
 *
 * Author:        Jerock Qin
 * Version:       0.00.06
 * Date:          2017-11-27
...
void mt_fe_it_wakeup_ds6113(MT_FE_DS6113_Device_Handle handle)
{
...
void mt_fe_it_sleep_ds6113(MT_FE_DS6113_Device_Handle handle)
{
...
void mt_fe_it_init_ds6113(MT_FE_DS6113_Device_Handle handle)
{
	handle->it_set_reg(handle, 0x10, 0x01);
	handle->it_set_reg(handle, 0x11, 0x01);
...
void mt_fe_it_reset_ds6113(MT_FE_DS6113_Device_Handle handle)
{
...
void mt_fe_it_dmpll_select_xm_ds6113(MT_FE_DS6113_Device_Handle handle, U32 *xm_KHz, U32 symbol_rate, U32 tuner_freq_MHz)
{
	static U32 xm_list_KHz[1][8] = {
...
void mt_fe_it_dmpll_select_mclk_ds6113(MT_FE_DS6113_Device_Handle handle, U32 tuner_freq_MHz, MT_BOOL bBs)
{
...
void mt_fe_it_dmpll_set_ts_mclk_ds6113(MT_FE_DS6113_Device_Handle handle, MT_FE_TS_OUT_MODE ts_mode, U32 MCLK_KHz)
{
...
void mt_fe_it_dmpll_get_ts_mclk_ds6113(MT_FE_DS6113_Device_Handle handle, U32 *p_MCLK_KHz)
{
