...
/********************************************************************************************/
#ifndef __NIM_MN_DS6113_H__
#define __NIM_MN_DS6113_H__
...
typedef struct
{
    ...
    u32 print_level;
    u32 sig_type;
} mt_fe_ds6113_priv_t, *mt_fe_ds6113_priv_handle;


extern mt_fe_ds6113_priv_handle g_ds6113_priv;

void port_ds6113_notify_to_up_layer(MT_FE_MSG msg, void *p_param);


/*!
  The nim ds6113 config
  */
typedef struct nim_ds6113_config
{
...
typedef struct _nim_ds6113_sat_attr
{
	signed   char snr;
	double   ber;
...
void nim_ds6113_set_config(nim_ds6113_config_t *p_cfg);

/*see NIM_DMD_WORK_MODE
  0 for return success
  other for fail
*/
int nim_ds6113_work_mode(int workmode);
