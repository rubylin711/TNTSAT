...
* --------------------------------------------------------------------------
*
* File:				mt_fe_dmd_ds6113_reg_tbl.h
*
* Current version:	2.01.15
*
* Description:		register table of DS6113
*
...
const U8 ds6113_reg_tbl_def[][2] =
{
	{0x04, 0x10},

	{0x8a, 0x01},	//modify by Henry 20171211
	{0x16, 0xa7},
	{0x14, 0x83},	//modify by Daniel 20230531
	{0x0c, 0x02},
	...
	{0x78, 0x0c},
	{0x85, 0x08},
	{0x54, 0x4f},	//modify by Daniel 20220823

	//for s2 mode ts out en
	{0x08, 0x47},
	{0xf0, 0x01},	//modify on 20240221 from 0x03	
	{0xfa, 0x01},
	{0xf2, 0x00},
	{0xf4, 0x02},//config 2 ts-putout, for s6-a1 s-nosync

	{0xf6, 0x00},	//add on 20240403 process in gse mode default
	{0xfa, 0x00},
	{0xe6, 0x00},
	{0xe7, 0xf3},
...
const U8 ds6113_reg_tbl_bs_def[][2] =
{
	{0x04, 0x10},
