...
typedef enum _MT_FE_ANALOG_CLK_CONFIG_DS6113
{	// Analog clock mode				// CLK_DEMOD	// DMPLL_CLK_LDPC	// DMPLL_CLK_XM	// ADC_CK_OUT	// VCO	// COMMENTS
	ANALOG_CLOCK_CONFIG_DEFAULT	 = 0,	// 27MHz		// 192MHz			// 144MHz		//  96MHz		// 1152	//  Low Symbol Rate, 1 Serial TS
	ANALOG_CLOCK_CONFIG_SCAN	 = 1,	// 27MHz		// 224MHz			// ~200MHz		// 112MHz		// 1350	// High Symbol Rate, 1 Serial TS
	ANALOG_CLOCK_CONFIG_OPTION1	 = 2,	// 27MHz		// 192MHz			// 144MHz		//  96MHz		// 1152	//  Low Symbol Rate, 1 Serial TS
	ANALOG_CLOCK_CONFIG_OPTION2	 = 3,	// 27MHz		// 224MHz			// 143MHz		// 112MHz		// 1350	// High Symbol Rate, 1 Serial TS
	ANALOG_CLOCK_CONFIG_OPTION3	 = 4,	// 27MHz		// 224MHz			// 70~80MHz		// 112MHz		// 1350	// High Symbol Rate, 3 Serial TS
	ANALOG_CLOCK_CONFIG_OPTION4	 = 5	// 27MHz		// 224MHz			// ~200MHz		// 112MHz		// 1350	// High Symbol Rate, 1 Serial TS
} MT_FE_ANALOG_CLK_CONFIG_DS6113;

typedef struct _MT_FE_AMC_SETTINGS_DS6113
{
	U16		iIndex;

	U32		AMC_Code_24_23_22;

	U32		Ind_56_Byte_00_03;
	U32		Ind_56_Byte_04_07;
	U32		Ind_56_Byte_08_11;
} MT_FE_AMC_SETTINGS_DS6113;

typedef struct _MT_FE_BOARD_SETTINGS_DS6113
{
	MT_BOOL		bIQInverted;
	MT_BOOL		bAGCPolar;
...
} MT_FE_BOARD_SETTINGS_DS6113;


typedef struct _MT_FE_TS_SETTINGS_DS6113
{
...
} MT_FE_TS_SETTINGS_DS6113;

typedef struct _MT_FE_LNB_SETTINGS_DS6113
{
	MT_BOOL					bLnbOn;
	MT_BOOL					b22K;
	...
	U8						iUBVer;
	MT_BOOL					bSpectrumInverted;
} MT_FE_LNB_SETTINGS_DS6113;

typedef struct _MT_FE_TP_PARAMS_DS6113
{
	...
	U16						uiAMCIndex;
	S16						iAMCOffset;
} MT_FE_TP_PARAMS_DS6113;

typedef struct _MT_FE_GLOBAL_SETTINGS_DS6113
{
...
} MT_FE_GLOBAL_SETTINGS_DS6113;

typedef struct _MT_FE_TN_DEVICE_SETTINGS_DS6113
{
...
} MT_FE_TN_DEVICE_SETTINGS_DS6113, *MT_FE_Tuner_Handle_DS6113;

typedef struct _MT_FE_DS6113_SETTINGS
{
	...
	MT_FE_TN_DEVICE_SETTINGS_DS6113 tuner_cfg;			/* Tuner settings */
	MT_FE_BOARD_SETTINGS_DS6113		board_cfg;			/* Board settings */
	MT_FE_TS_SETTINGS_DS6113		ts_cfg;				/* TS settings */
	MT_FE_LNB_SETTINGS_DS6113		lnb_cfg;			/* LNB settings */
	MT_FE_GLOBAL_SETTINGS_DS6113	global_cfg;			/* Global settings */

	MT_FE_TP_PARAMS_DS6113			tp_cfg;				/* Channel parameters */
	...
	MT_FE_RET	(*id_set_reg)(void *handle, U8 reg_addr, U8 reg_index, U8 reg_data);
	MT_FE_RET	(*id_get_reg)(void *handle, U8 reg_addr, U8 reg_index, U8 *p_buf);
...
} MT_FE_DS6113_DEVICE_SETTINGS, *MT_FE_DS6113_Device_Handle;




typedef struct _MT_FE_DS6113_Serial_TS_CLK
{
	U32 internal_freq;
	U32 refResults;
	U8 ana_reg1_23_16;
	...
	U8 ana_reg2_7_4;
	U8 ana_reg2_3_0;
}MT_FE_DS6113_Serial_TS_CLK;
#define MT_FE_DS6113_Serial_TS_CLK_COUNT    18//16

typedef enum _MT_FE_DS6113_LABLE_FILTER_TYPE
{
	LABLE_3_BYTE_MODE,
	LABLE_6_BYTE_MODE,
}MT_FE_DS6113_LABLE_FILTER_TYPE;
...
typedef enum _MT_FE_DS6113_TS_GS_MODE_T {
	DS6113_BBHEADER_UNKNOW = 0x00,
    /*!
        BBHeader is Transport Mode
      */
    DS6113_BBHEADER_TRANSPORT_MODE = 0x02,
    /*!
        BBHeader is Generic Packetized Mode
      */
    DS6113_BBHEADER_GENERIC_CONTINUOUS_MODE = 0x03,
    /*!
        BBHeader is GSE-HEM Mode
      */
    DS6113_BBHEADER_GSE_HEM_MODE = 0x04,
    /*!
        BBHeader is Generic Packetized Mode
      */
    DS6113_BBHEADER_GENERIC_PACKETIZED_MODE = 0x05,
} MT_FE_DS6113_TS_GS_MODE_T;

/*!
  @brief gs_package_mode, used for IO control "NIM_IOCTRL_SET_PORLAR" command
  */
typedef enum _MT_FE_DS6113_GS_PACKAGE_MODE_T {

     /*!
        gs date process in gse mode
      */
	DS6113_PROCESS_IN_GSE_MODE = 0x00,
    /*!
        gs date process in bbframe mode
      */
    DS6113_PROCESS_IN_BBFRAME_MODE = 0x01,
    /*!
        BBHeader is Generic Packetized Mode
      */
    DS6113_PROCESS_IN_UKNOW_MODE = 0xFF,
} MT_FE_DS6113_GS_PACKAGE_MODE_T;
...
MT_FE_RET mt_fe_tn_init_RDA5815S_ds6113(MT_FE_DS6113_Device_Handle handle);
MT_FE_RET mt_fe_tn_set_freq_RDA5815S_ds6113(MT_FE_DS6113_Device_Handle handle, U32 freq_KHz, U32 sym_rate_KSs, S16 lpf_offset_KHz);
S32 mt_fe_tn_get_tuner_freq_offset_RDA5815S_ds6113(MT_FE_DS6113_Device_Handle handle);
MT_FE_RET mt_fe_tn_get_strength_RDA5815S_ds6113(MT_FE_DS6113_Device_Handle handle, U32 *p_gain, S32 *p_strength);
...
MT_FE_RET mt_fe_tn_init_RDA5815M_ds6113(MT_FE_DS6113_Device_Handle handle);
MT_FE_RET mt_fe_tn_set_freq_RDA5815M_ds6113(MT_FE_DS6113_Device_Handle handle, U32 freq_KHz, U32 sym_rate_KSs, S16 lpf_offset_KHz);
S32 mt_fe_tn_get_tuner_freq_offset_RDA5815M_ds6113(MT_FE_DS6113_Device_Handle handle);
MT_FE_RET mt_fe_tn_get_strength_RDA5815M_ds6113(MT_FE_DS6113_Device_Handle handle, U32 *p_gain, S32 *p_strength);
...
/* demod&tuner address */
#define MT_FE_DMD_DEV_ADDR_DS6113            0xD2   // 0xD2     /* Demodulator address    */
...
**    This define is used to unlock DS6113 if the carrier offset
** is larger than the defined carrier offset.
**      User can set this define to "1" and set the carrier offset
** (6MHz offset as default).
**      If the carrier offset if larger than the defined value, DS6113
...
MT_FE_RET mt_fe_dmd_ds6113_blindscan_get_psd(MT_FE_DS6113_Device_Handle handle, U32 begin_freq_MHz, U32 end_freq_MHz, MT_FE_BS_TP_INFO *p_bs_info);
