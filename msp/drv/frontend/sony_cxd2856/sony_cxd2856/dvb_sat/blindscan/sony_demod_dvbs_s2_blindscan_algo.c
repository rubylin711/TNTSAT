        ...
        while (isContinue){
            if (pListBase->pNext){
                ...
                if (pListCurrent->data.candidate.symbolRateKSps > baseSymbolRateKSps){
                    sony_current = pListCurrent->data.candidate.symbolRateKSps - baseSymbolRateKSps;
                } else {
                    sony_current = baseSymbolRateKSps - pListCurrent->data.candidate.symbolRateKSps;
                }
        ...
        while (isContinue){
            if (pListBase->pNext){
                ...
                if (pListCurrent->data.candidate.centerFreqKHz > baseFrequencyKHz){
                    sony_current = pListCurrent->data.candidate.centerFreqKHz - baseFrequencyKHz;
                } else {
                    sony_current = baseFrequencyKHz - pListCurrent->data.candidate.centerFreqKHz;
                }
