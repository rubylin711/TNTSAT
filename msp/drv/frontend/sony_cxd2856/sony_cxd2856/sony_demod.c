                                 ...
                                 sony_i2c_t * pDemodI2c)
{
    ...
    pDemod->iffreqConfig.configDVBT_8 = SONY_DEMOD_MAKE_IFFREQ_CONFIG(5);
    ...
    pDemod->iffreqConfig.configDVBT2_8 = SONY_DEMOD_MAKE_IFFREQ_CONFIG(5);
                                    ...
                                    int32_t value)
{
    ...
    case SONY_DEMOD_CONFIG_PARALLEL_SEL:
        ...
        //printk("%s[%d] ---- Set value = %d, select %s\n", __FUNCTION__, __LINE__, value, value ? "Parallel" : "Serial");
