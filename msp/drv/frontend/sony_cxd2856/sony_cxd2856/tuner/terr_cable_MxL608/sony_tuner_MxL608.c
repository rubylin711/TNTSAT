...
------------------------------------------------------------------------------*/
static sony_result_t sony_tuner_MxL608_Initialize (sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_MxL608_Tune (sony_tuner_terr_cable_t * pTuner,
                                             uint32_t frequency,
                                             sony_dtv_system_t system,
                                             sony_dtv_bandwidth_t bandwidth);

static sony_result_t sony_tuner_MxL608_Sleep (sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_MxL608_Shutdown (sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_MxL608_ReadRFLevel (sony_tuner_terr_cable_t * pTuner, int32_t * pRFLevel);

/*------------------------------------------------------------------------------
 Functions
------------------------------------------------------------------------------*/
sony_result_t sony_tuner_MxL608_Create (sony_tuner_terr_cable_t * pTuner,
                                        ...
                                        sony_MxL608_t * pAscot3Tuner)
{
    ...
    pTuner->Tune = sony_tuner_MxL608_Tune;
...
sony_result_t sony_tuner_MxL608_ReadRssi (sony_tuner_terr_cable_t * pTuner, int32_t * pRssi)
{
    sony_result_t result = SONY_RESULT_OK;
	int32_t level = 0;
