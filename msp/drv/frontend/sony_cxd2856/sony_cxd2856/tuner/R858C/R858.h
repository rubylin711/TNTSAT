...
#include "../sony_tuner_rafael_common.h"
...
#define INT32 signed int	  // 2147483648 ~ 2147483647
#define INT16 signed short
#define INT8 signed char

#ifndef RAFAEL_COMMON_HEADER
#define TRUE 1
#define FALSE 0
#endif
...
#else
#define R858_XTAL_LOWEST XTAL_LOWEST
#define R858_XTAL_LOW XTAL_LOW
#define R858_XTAL_HIGH XTAL_HIGH
#define R858_XTAL_HIGHEST XTAL_HIGHEST
#define R858_XTAL_CHECK_SIZE XTAL_CHECK_SIZE
#endif

/**
 @brief Xtal frequencies supported by .
*/
typedef enum
{
	R858_XTAL_16000KHz, /**< 16 MHz */
	R858_XTAL_20500KHz, /**< 20.5 MHz */
	R858_XTAL_24000KHz	/**< 24 MHz */
} sony_r858_xtal_t;
...
#else
#define R858_Xtal_Div_TYPE Rafael_Xtal_Div_TYPE
#endif
...
#else
#define R858_ErrCode Rafael_ErrCode
#endif
...
typedef enum _R858_Standard_Type //Don't remove standand list!!
{
	...
	//DTV IF=5M
	R858_DVB_T_6M_IF_5M,
	R858_DVB_T_6M_IF_5500,
	R858_DVB_T_7M_IF_5M,
	R858_DVB_T_7M_IF_5500,
	R858_DVB_T_8M_IF_5M,
	R858_DVB_T_8M_IF_5500,
	R858_DVB_T2_6M_IF_5M,
	R858_DVB_T2_6M_IF_5500,
	R858_DVB_T2_7M_IF_5M,
...
#else
#define R858_RF_Gain_TYPE Rafael_RF_Gain_TYPE
#define R858_ClkOutMode_Type Rafael_ClkOutMode_Type
#define R858_LT_Type Rafael_LoopThrough_Type
#endif
...
#define R858_Delay_MS(R858_ExtTunerNum_Type, x_ms) sony_sleep_delay_ms(x_ms)
