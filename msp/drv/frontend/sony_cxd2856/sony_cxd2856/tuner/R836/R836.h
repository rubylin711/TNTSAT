...
//--------------------------------------------------------------------------------------//
#define R840_Xtal                24000// 16000  //change the value when change clock input frequency
...
enum R840_XTAL_PWR_VALUE
{
	R840_XTAL_NOR_LOWEST = 0,
	R840_XTAL_NOR_LOW,
	R840_XTAL_NOR_HIGH,
	R840_XTAL_NOR_HIGHEST,
	//R840_XTAL_GM3V_HIGHEST,
	R840_XTAL_GM3V_STRONG,
	R840_XTAL_CHECK_SIZE
};

typedef enum _R840_Rafael_Chip_Type //Don't modify chip list
{
	R840 = 0,
	R836,
	R840_R,
	R836_R,
} R840_Rafael_Chip_Type;
...
#else
#define R840_ErrCode Rafael_ErrCode
#endif
...
//----------------------------------------------------------//
#define R840_Delay_MS sony_sleep_delay_ms
