...
------------------------------------------------------------------------------*/
static sony_result_t sony_tuner_r850_Initialize(sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_r850_Tune(sony_tuner_terr_cable_t * pTuner,
                                             uint32_t frequency,
                                             sony_dtv_system_t system,
                                             sony_dtv_bandwidth_t bandwidth);

static sony_result_t sony_tuner_r850_Sleep(sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_r850_Shutdown(sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_r850_Resume(sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_r850_ReadRFLevel(sony_tuner_terr_cable_t * pTuner, int32_t * pRFLevel);
                                      ...
                                      sony_r850_t * pR850Tuner)
{
    ...
    pTuner->Tune = sony_tuner_r850_Tune;
