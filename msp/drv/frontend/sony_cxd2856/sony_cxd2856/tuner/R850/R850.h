...
//----------------------------------------------------------//
//===========Clock out Setting=========//
#define R850_CLOCK_OUT_ENABLE_AFTER_INIT  TRUE

//===========Share Xtal=========//
#define R850_SINGLE_SHARE_XTAL_MASTER   TRUE      //share Xtal, R850 is Master device, xtal_gm = normal (R32[4:3]=2'b11), xtal pw = highest
...
#define R850_USE_MULTI_TUNER    FALSE  //if only one tuner, please set FALSE.
...
#else
#define R850_ErrCode Rafael_ErrCode
#endif
...
#else
#define R850_LoopThrough_Type Rafael_LoopThrough_Type
#define R850_ClkOutMode_Type Rafael_ClkOutMode_Type
#define R850_RF_Gain_TYPE Rafael_RF_Gain_TYPE
#define R850_Xtal_Div_TYPE Rafael_Xtal_Div_TYPE
#endif
...
#define R850_Delay_MS(R850_Tuner_Num, x_ms)   	sony_sleep_delay_ms(x_ms)
