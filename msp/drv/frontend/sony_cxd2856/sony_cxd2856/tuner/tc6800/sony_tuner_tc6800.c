...
------------------------------------------------------------------------------*/
static sony_result_t sony_tuner_tc6800_Initialize(sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_tc6800_Tune(sony_tuner_terr_cable_t * pTuner,
                                             uint32_t frequency,
                                             sony_dtv_system_t system,
                                             sony_dtv_bandwidth_t bandwidth);

static sony_result_t sony_tuner_tc6800_Sleep(sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_tc6800_Shutdown(sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_tc6800_Resume(sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_tc6800_ReadRFLevel(sony_tuner_terr_cable_t * pTuner, int32_t * pRFLevel);
                                      ...
                                      sony_tc6800_t * pTC6800Tuner)
{
    ...
    pTuner->Tune = sony_tuner_tc6800_Tune;
