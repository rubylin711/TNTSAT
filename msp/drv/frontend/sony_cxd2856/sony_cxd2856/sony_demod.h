...
/**
 @brief Tuner software state.
*/
typedef enum {
    SONY_TUNER_STATE_UNKNOWN,           /**< Unknown. */
    SONY_TUNER_STATE_SHUTDOWN,          /**< Chip is in Shutdown state. */
    SONY_TUNER_STATE_SLEEP,             /**< Chip is in Sleep state. */
    SONY_TUNER_STATE_ACTIVE,            /**< Chip is in Active state. */
    SONY_TUNER_STATE_INVALID            /**< Invalid, result of an error during a state change. */
} sony_tuner_state_t;
