...
#define  MT_TC6800_CUSTOM_CONFIG	0
		// 0: General customers
		// 1: Jiuzhou or Changhong
		// 2: Startimes
		// 3: Indonesia
		// 4: Antina
		// 5: SKW
...
typedef struct _MT_FE_TN_Device_Settings_TC6800
{
	...
	U8			tuner_inter_fef_status;	// Tuner FEF status
...
static S32 _mt_fe_tn_set_reg_bit_expand_tc6800(MT_FE_Tuner_Handle_TC6800 handle, U8 reg_addr_expand, U8 reg_addr, U8 data, U8 high_bit, U8 low_bit);
...
S32  mt_fe_tn_global_reset_tc6800(MT_FE_Tuner_Handle_TC6800 handle, U8 reset_flag);
