...
CHAN_DEPENDENT_SPUR_REGISTER_T MxL601_SPUR_REGISTER_cs8800 = 
...
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_NTSC_FREQ_LUT_XTAL_16MHZ_LIF_cs8800[] = 
{
...
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_NTSC_FREQ_LUT_XTAL_24MHZ_cs8800[] = 
{
...
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_NTSC_FREQ_LUT_HRC_16MHZ_cs8800[] = 
{
...
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_NTSC_FREQ_LUT_HRC_24MHZ_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0x90},
...
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_NTSC_FREQ_LUT_IRC_16MHZ_cs8800[] = 
{
  { 1, 0x1C, 0x17, 0x00, 0xD8},
...
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_NTSC_FREQ_LUT_IRC_24MHZ_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0x90},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_BG_7MHZ_LUT_XTAL_16MHZ_LIF_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0xD8},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_BG_7MHZ_LUT_XTAL_24MHZ_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0x90},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_BG_8MHZ_LUT_XTAL_16MHZ_LIF_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0xD8},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_BG_8MHZ_LUT_XTAL_24MHZ_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0x90},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_D_LUT_XTAL_16MHZ_LIF_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0xD8},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_D_LUT_XTAL_24MHZ_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0x90},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_I_LUT_XTAL_16MHZ_LIF_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0xD8},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_I_LUT_XTAL_24MHZ_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0x90},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_SECAM_L_LUT_XTAL_16MHZ_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0xD8},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_SECAM_L_LUT_XTAL_24MHZ_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0x90},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_D_LUT_XTAL_16MHZ_HIF_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0xD8},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_I_LUT_XTAL_16MHZ_HIF_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0xD8},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_BG_7MHZ_LUT_XTAL_16MHZ_HIF_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0xD8},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_PAL_BG_8MHZ_LUT_XTAL_16MHZ_HIF_cs8800[] = 
{
  { 1, 0x1D, 0x17, 0x00, 0xD8},
...
// on which optimized channel tunning settungs wll be performed
CHAN_DEPENDENT_FREQ_TABLE_T MxL601_NTSC_FREQ_LUT_XTAL_16MHZ_HIF_cs8800[] = 
{
  { 1, 0x1C, 0x17, 0x00, 0xD8},
