 ...
 *----------------------------------------------------------------------------
 *
 *	FILE:				mt_fe_dmd_ds6103.c
 *
 *	VERSION:			2.01.20
 *
 *	DESCRIPTION:
 *			Define the interfaces of DS6103.
 *
 *   History:
 ...
 *   Modify          2.01.00     2017.08.22      YZ.Huang
 *   Modify          2.01.01     2017.08.28      YZ.Huang
 *   Modify          2.01.02     2017.09.13      YZ.Huang
 *   Modify          2.01.03     2017.11.07      YZ.Huang
 *   Modify          2.01.04     2017.11.09      YZ.Huang
 *   Modify          2.01.05     2017.11.16      YZ.Huang
 *   Modify          2.01.06     2017.11.27      YZ.Huang
 *   Modify          2.01.07     2017.12.18      YZ.Huang
 *   Modify          2.01.08     2018.03.30      YZ.Huang
 *   Modify          2.01.09     2018.10.16      YZ.Huang
 *   Modify          2.01.10     2018.11.30      YZ.Huang
 *   Modify          2.01.11     2019.01.02      YZ.Huang
 *   Modify          2.01.12     2019.05.29      YZ.Huang
 *   Modify          2.01.13     2019.07.03      YZ.Huang
 *   Modify          2.01.14     2019.07.05      YZ.Huang
 *   Modify          2.01.15     2019.09.06      YZ.Huang
 *   Modify          2.01.16     2020.12.16      YZ.Huang
 *   Modify          2.01.18     2021.05.18      YZ.Huang
 *   Modify          2.01.19     2022.03.02      YZ.Huang
 *   Modify          2.01.20     2022.10.24      YZ.Huang
 *****************************************************************************/
...
#include "mt_fe_dmd_ds6103_fw.h"
#include "mt_fe_dmd_ds6103_reg_tbl.h"
...
****internal function****
*************************/
MT_FE_RET _mt_fe_dmd_ds6103_set_demod(MT_FE_DS6103_Device_Handle handle, U32 sym_rate_KSs, MT_FE_TYPE type);
MT_FE_RET _mt_fe_dmd_ds6103_init_reg(MT_FE_DS6103_Device_Handle handle, const U8 (*p_reg_tabl)[2], S32 size);
MT_FE_RET _mt_fe_dmd_ds6103_download_fw(MT_FE_DS6103_Device_Handle handle, const U8* p_fw, U16 fw_size);
MT_FE_RET _mt_fe_dmd_ds6103_set_ts_out_mode(MT_FE_DS6103_Device_Handle handle, MT_FE_TS_OUT_MODE mode);
MT_FE_RET _mt_fe_dmd_ds6103_set_clock_ratio(MT_FE_DS6103_Device_Handle handle);
MT_FE_RET _mt_fe_dmd_ds6103_set_sym_rate(MT_FE_DS6103_Device_Handle handle, U32 sym_rate_KSs);
MT_FE_RET _mt_fe_dmd_ds6103_get_sym_rate(MT_FE_DS6103_Device_Handle handle, U32 *sym_rate_KSs);
MT_FE_RET _mt_fe_dmd_ds6103_set_carrier_offset(MT_FE_DS6103_Device_Handle handle, S32 carrier_offset_KHz);
MT_FE_RET _mt_fe_dmd_ds6103_get_carrier_offset(MT_FE_DS6103_Device_Handle handle, S32 *carrier_offset_KHz);
MT_FE_RET _mt_fe_dmd_ds6103_get_total_carrier_offset(MT_FE_DS6103_Device_Handle handle, S32 *carrier_offset_KHz);
MT_FE_RET _mt_fe_dmd_ds6103_get_fec(MT_FE_DS6103_Device_Handle handle, MT_FE_TP_INFO *p_info, MT_FE_TYPE tp_type);

MT_FE_RET _mt_fe_dmd_ds6103_select_mclk(MT_FE_DS6103_Device_Handle handle, U32 tuner_freq_MHz);
MT_FE_RET _mt_fe_dmd_ds6103_get_ts_mclk(MT_FE_DS6103_Device_Handle handle, U32 *p_MCLK_KHz);
MT_FE_RET _mt_fe_dmd_ds6103_set_ts_mclk(MT_FE_DS6103_Device_Handle handle, U32 MCLK_KHz);
MT_FE_RET _mt_fe_dmd_ds6103_set_ts_divide_ratio(MT_FE_DS6103_Device_Handle handle, MT_FE_TYPE type, U8 dr_high, U8 dr_low);
MT_FE_RET _mt_fe_dmd_ds6103_get_current_ts_mode(MT_FE_DS6103_Device_Handle handle, MT_FE_TS_OUT_MODE *p_ts_mode);


/* function for blind scan*/
MT_FE_RET _mt_fe_dmd_ds6103_bs_set_demod(MT_FE_DS6103_Device_Handle handle, U32 sym_rate_KSs, MT_FE_TYPE type);
MT_FE_RET _mt_fe_dmd_ds6103_bs_remove_unlocked_TP(MT_FE_DS6103_Device_Handle handle, MT_FE_BS_TP_INFO *p_bs_info, U32 compare_freq_KHz);
MT_FE_RET _mt_fe_dmd_ds6103_bs_connect(MT_FE_DS6103_Device_Handle handle, MT_FE_BS_TP_INFO *p_bs_info,
									 U16 start_index,
									 U16 scanned_tp);
...
MT_FE_RET mt_fe_dmd_ds6103_config_default(MT_FE_DS6103_Device_Handle handle)
{
	...
	handle->dev_index		 = 0;
	handle->demod_dev_addr	 = MT_FE_DMD_DEV_ADDR_DS6103;

	handle->it_dev_addr		 = MT_FE_IT_I2C_ADDR;

	handle->demod_id		 = MtFeDmdId_DS6103;
	handle->demod_type		 = MT_FE_DEMOD_M88DS6103;
	...
	handle->tuner_cfg.tuner_init		 = (MT_FE_RET (*)(void *))mt_fe_tn_init_ts6011_ds6103;
	handle->tuner_cfg.tuner_set			 = (MT_FE_RET (*)(void *, U32, U32, S16))mt_fe_tn_set_freq_ts6011_ds6103;
	handle->tuner_cfg.tuner_get_offset	 = (S32 (*)(void *))mt_fe_tn_get_tuner_freq_offset_ts6011_ds6103;
	handle->tuner_cfg.tuner_get_strength = (MT_FE_RET (*)(void *, U32 *, S32 *))mt_fe_tn_get_strength_ts6011_ds6103;
	handle->tuner_cfg.tuner_sleep		 = (MT_FE_RET (*)(void *))mt_fe_tn_sleep_ts6011_ds6103;
	handle->tuner_cfg.tuner_wakeup		 = (MT_FE_RET (*)(void *))mt_fe_tn_wake_up_ts6011_ds6103;
	...
	handle->ts_cfg.iSerialDriverMode	 = 0;	/* 0 - DS6103 only; 1 - DS6103 + other demodulators */
	...
	handle->version_number				 = 0x00020120;
	handle->version_time				 = 0x22102416;

	handle->dmd_set_reg	 = (MT_FE_RET (*)(void *, U8, U8))_mt_fe_dmd_set_reg_ds6103;
	handle->dmd_get_reg	 = (MT_FE_RET (*)(void *, U8, U8*))_mt_fe_dmd_get_reg_ds6103;
	handle->write_fw	 = (MT_FE_RET (*)(void *, U8, U8*, U16))_mt_fe_write_fw_ds6103;
	handle->mt_sleep	 = (void (*)(U32))_mt_sleep_ds6103;
	handle->tn_read		 = (MT_FE_RET (*)(void *, U8, U8 *, U16))_mt_fe_tn_read_ds6103;
	handle->tn_write	 = (MT_FE_RET (*)(void *, U8 *, U16))_mt_fe_tn_write_ds6103;
	handle->tn_set_reg	 = (MT_FE_RET (*)(void *, U8, U8))_mt_fe_tn_set_reg_ds6103;
	handle->tn_get_reg	 = (MT_FE_RET (*)(void *, U8, U8*))_mt_fe_tn_get_reg_ds6103;
	handle->it_set_reg	 = (MT_FE_RET (*)(void *, U8, U8))_mt_fe_it_set_reg_ds6103;
	handle->it_get_reg	 = (MT_FE_RET (*)(void *, U8, U8*))_mt_fe_it_get_reg_ds6103;
...
MT_FE_RET mt_fe_dmd_ds6103_select_tuner(MT_FE_DS6103_Device_Handle handle, MT_FE_TN_SUPPORTED_TUNER tuner_type)
{
	...
	switch (tuner_type)
	{
#ifdef CONFIG_MT_FRONTEND_DMD_DS6103_TN_TS6011
...
#ifdef CONFIG_MT_FRONTEND_DMD_DS6103_TN_RDA5815S
		case MtFeTn_RDA_5815S:
			handle->board_cfg.bAGCPolar			 = 0;
			handle->board_cfg.bIQInverted		 = 0;

			handle->tuner_cfg.tuner_init		 = (MT_FE_RET (*)(void *))mt_fe_tn_init_RDA5815S_ds6103;
			handle->tuner_cfg.tuner_set			 = (MT_FE_RET (*)(void *, U32, U32, S16))mt_fe_tn_set_freq_RDA5815S_ds6103;
			handle->tuner_cfg.tuner_get_offset	 = (S32 (*)(void *))mt_fe_tn_get_tuner_freq_offset_RDA5815S_ds6103;
			handle->tuner_cfg.tuner_get_strength = (MT_FE_RET (*)(void *, U32 *, S32 *))mt_fe_tn_get_strength_RDA5815S_ds6103;
...
#ifdef CONFIG_MT_FRONTEND_DMD_DS6103_TN_RDA5815M
		case MtFeTn_RDA_5815M:
			handle->board_cfg.bAGCPolar			 = 1;
			handle->board_cfg.bIQInverted		 = 1;

			handle->tuner_cfg.tuner_init		 = (MT_FE_RET (*)(void *))mt_fe_tn_init_RDA5815M_ds6103;
			handle->tuner_cfg.tuner_set			 = (MT_FE_RET (*)(void *, U32, U32, S16))mt_fe_tn_set_freq_RDA5815M_ds6103;
			handle->tuner_cfg.tuner_get_offset	 = (S32 (*)(void *))mt_fe_tn_get_tuner_freq_offset_RDA5815M_ds6103;
			handle->tuner_cfg.tuner_get_strength = (MT_FE_RET (*)(void *, U32 *, S32 *))mt_fe_tn_get_strength_RDA5815M_ds6103;
...
#ifdef CONFIG_MT_FRONTEND_DMD_DS6103_TN_AV2018
		case  MtFeTn_AV2018:
			handle->board_cfg.bAGCPolar			 = 1;
			handle->board_cfg.bIQInverted		 = 0;

			handle->tuner_cfg.tuner_init		 = (MT_FE_RET (*)(void *))mt_fe_tn_init_AV2018_ds6103;
			handle->tuner_cfg.tuner_set			 = (MT_FE_RET (*)(void *, U32, U32, S16))mt_fe_tn_set_freq_AV2018_ds6103;
			handle->tuner_cfg.tuner_get_offset	 = (S32 (*)(void *))mt_fe_tn_get_tuner_freq_offset_AV2018_ds6103;
			handle->tuner_cfg.tuner_get_strength = (MT_FE_RET (*)(void *, U32 *, S32 *))mt_fe_tn_get_strength_AV2018_ds6103;
...
#ifdef CONFIG_MT_FRONTEND_DMD_DS6103_TN_AV2012
		case  MtFeTn_AV2012:
			handle->board_cfg.bAGCPolar			 = 1;
			handle->board_cfg.bIQInverted		 = 0;

			handle->tuner_cfg.tuner_init		 = (MT_FE_RET (*)(void *))mt_fe_tn_init_AV2012_ds6103;
			handle->tuner_cfg.tuner_set			 = (MT_FE_RET (*)(void *, U32, U32, S16))mt_fe_tn_set_freq_AV2012_ds6103;
			handle->tuner_cfg.tuner_get_offset	 = (S32 (*)(void *))mt_fe_tn_get_tuner_freq_offset_AV2012_ds6103;
			handle->tuner_cfg.tuner_get_strength = (MT_FE_RET (*)(void *, U32 *, S32 *))mt_fe_tn_get_strength_AV2012_ds6103;
		...
		default:
			...
			handle->tuner_cfg.tuner_dev_addr	 = 0x00;
	...
	//mt_fe_dmd_ds6103_check_tuner(handle);

	return MtFeErr_Ok;
}

/************************************************************************
** Function: mt_fe_dmd_ds6103_get_driver_version
**
**
...
/************************************************************************
** Function: mt_fe_dmd_ds6103_soft_reset
**
**
...
/******************************************************************
** Function: mt_fe_dmd_ds6103_hard_reset
**
**
...
MT_FE_RET mt_fe_dmd_ds6103_hard_reset(MT_FE_DS6103_Device_Handle handle)
{
	...
	*/
	...
	mt_fe_it_reset_ds6103(handle);

	mt_fe_dmd_ds6103_wake_up(handle);

	//mt_fe_dmd_ds6103_get_demod_id(handle, &(handle->demod_id));
	...
	mt_fe_dmd_ds6103_global_reset(handle);
...
MT_FE_RET mt_fe_dmd_ds6103_set_high_Z_state(MT_FE_DS6103_Device_Handle handle, MT_BOOL high_Z_output)
{
	U8 val = 0;
...
/******************************************************************************
** Function: mt_fe_dmd_ds6103_init
**
**
** Description:  This function is used to initial DS6103.
...
MT_FE_RET mt_fe_dmd_ds6103_init(MT_FE_DS6103_Device_Handle handle)
{
	...
	mt_fe_dmd_ds6103_hard_reset(handle);

	mt_fe_it_init_ds6103(handle);
	...
	_mt_fe_dmd_ds6103_download_fw(handle, ds6103_fm, sizeof(ds6103_fm) / sizeof(U8));

	handle->mt_sleep(1);

	handle->dmd_get_reg(handle, 0xb9, &val);
	if (val != ds6103_fm_ver)
	{
		mt_fe_print(("\tDownload firmware failed! Version no = 0x%02X!\n", val));
	}

	_mt_fe_dmd_ds6103_set_ts_out_mode(handle, handle->ts_cfg.mTsMode);
...
/************************************************************************
** Function: mt_fe_dmd_ds6103_change_ts_out_mode
**
**
...
MT_FE_RET mt_fe_dmd_ds6103_change_ts_out_mode(MT_FE_DS6103_Device_Handle handle, MT_FE_TS_OUT_MODE mode)
{
	...
	//mt_fe_dmd_ds6103_get_lock_state(&lockstate);
	...
	_mt_fe_dmd_ds6103_get_ts_mclk(handle, &cur_mclk);
	...
	if (cur_mclk != target_mclk)
	{
		...
		_mt_fe_dmd_ds6103_set_ts_mclk(handle, target_mclk);
	...
	if (mode == MtFeTsOutMode_Serial)
	{
		if (handle->ts_cfg.bAutoSerial != 0)
		{
			...
			{
				_mt_fe_dmd_ds6103_set_clock_ratio(handle);
			}
		}
	}
...
/************************************************************************
** Function: mt_fe_dmd_ds6103_sleep
**
**
** Description:	This function is used to sleep DS6103.
**
**
** Inputs:   None
**
...
MT_FE_RET mt_fe_dmd_ds6103_sleep(MT_FE_DS6103_Device_Handle handle)
{
	...
	mt_fe_dmd_ds6103_set_high_Z_state(handle, TRUE);
...
/************************************************************************
** Function: mt_fe_dmd_ds6103_wake_up
**
**
** Description:	This function is used to wake up DS6103.
**
**
** Inputs:   None
**
...
MT_FE_RET mt_fe_dmd_ds6103_wake_up(MT_FE_DS6103_Device_Handle handle)
{
	...
	mt_fe_dmd_ds6103_set_high_Z_state(handle, FALSE);
...
/**********************************************************************************************
** Function: mt_fe_dmd_ds6103_connect
**
**
...
MT_FE_RET mt_fe_dmd_ds6103_connect(MT_FE_DS6103_Device_Handle handle, U32 freq_MHz, U32 sym_rate_KSs, MT_FE_TYPE dvbs_type)
{
	...
	mt_fe_dmd_ds6103_clear_ts(handle);
	...
	_mt_fe_dmd_ds6103_get_current_ts_mode(handle, &ts_mode);
	...
	handle->dmd_set_reg(handle, 0x06, 0xe0);
	_mt_fe_dmd_ds6103_select_mclk(handle, handle->tp_cfg.iFreqKHz / 1000);
	_mt_fe_dmd_ds6103_set_ts_mclk(handle, target_mclk);
	handle->dmd_set_reg(handle, 0x06, 0x00);
	...
	{
		mt_fe_dmd_ds6103_unicable_set_tuner(handle, freq_tmp_KHz, sym_rate_KSs, &real_freq_KHz, handle->lnb_cfg.iUBIndex, handle->lnb_cfg.iBankIndex, handle->lnb_cfg.iUBFreqMHz);
	...
	/*set demod registers*/
	_mt_fe_dmd_ds6103_set_demod(handle, sym_rate_KSs, handle->tp_cfg.mCurrentType);
	...
	/*set carrier offset*/
	_mt_fe_dmd_ds6103_set_carrier_offset(handle, handle->tuner_cfg.tuner_get_offset(handle) + lpf_offset_KHz + deviceoffset_KHz);
	...
	{
		mt_fe_tn_adjust_AGC_ts6011_ds6103((MT_FE_Tuner_Handle_TS6011)handle->tuner_cfg.tuner_handle);
	}
#endif
...
#if 0
void mt_fe_dmd_ds6103_calc_PLS_gold_code(U8 *pNormalCode, U32 PLSGoldCode)
{
...
/******************************************************************
** Function: mt_fe_dmd_ds6103_get_lock_state
**
**
** Description:	This function is called by app level to get the
**			lock status of DS6103.
**
**
** Inputs:   None
**
...
**		Parameter	Type				Description
**		-----------------------------------------------------------
**		p_state		MT_FE_LOCK_STATE*	lock status of DS6103
**
**
*******************************************************************/
MT_FE_RET mt_fe_dmd_ds6103_get_lock_state(MT_FE_DS6103_Device_Handle handle, MT_FE_LOCK_STATE *p_state)
{
	...
	*p_state = MtFeLockState_Waiting;
	...
	if (tmp == 0xfe)
	{
		...
		mt_fe_dmd_ds6103_soft_reset(handle);
	...
	if (tmp & 0x08)
	{
		...
		{
			//mt_dbg_printf(1, "%s[%d] ---- Start super search!\n", __FUNCTION__, __LINE__);
			...
			if ((tmp & 0x8f) == 0x0f)
			{
				...
				for (iPLSIndex = 0; iPLSIndex < iPLSCnt; iPLSIndex++)
				{
					...
					//mt_fe_dmd_ds6103_calc_PLS_gold_code(PLSCode, mPLSGoldTable[iPLSIndex]);
					...
					if ((val & 0x8f) == 0x8f)
					{
						//mt_dbg_printf(1, "%s[%d] ---- Super search OK, PLS Gold = %d!\n", __FUNCTION__, __LINE__, mPLSGoldTable[iPLSIndex]);
				...
				if ((iPLSIndex == iPLSCnt) && ((val & 0x8f) != 0x8f))
				{
					...
					//mt_dbg_printf(1, "%s[%d] ---- Super search failed\n", __FUNCTION__, __LINE__);
				}
			}
		}
			...
			((tmp & 0x8f) == 0x8f))
		{
			...
			//if (handle->tp_cfg.ucCurTsId == 0)
			{
				...
				if (!handle->tp_cfg.bCheckCCM)
				{
					...
					bMIS = _mt_fe_dmd_ds6103_check_MIS(handle);
	...
	if (*p_state == MtFeLockState_Locked)
	{
		...
		if (handle->tp_cfg.bLimitCarrierOffset)
		{
			...
			{
				_mt_fe_dmd_ds6103_get_carrier_offset(handle, &carrier_offset_KHz);
			}
			else
			{
				_mt_fe_dmd_ds6103_get_total_carrier_offset(handle, &carrier_offset_KHz);
			}
		...
		if (ucTmp < 0x80)
		{
			mt_fe_dmd_ds6103_get_channel_info(handle, &ch_info);
...
/*********************************************************************
** Function: mt_fe_dmd_ds6103_get_per
**
**
...
MT_FE_RET mt_fe_dmd_ds6103_get_per(MT_FE_DS6103_Device_Handle handle, U32 *p_total_packags, U32 *p_err_packags)
{
	...
	*p_total_packags = pre_total_packags;
	...
	{
		mt_fe_dmd_ds6103_get_channel_info(handle, &p_info);
...
/******************************************************************
** Function: mt_fe_dmd_ds6103_get_snr
**
**
...
/******************************************************************
** Function: mt_fe_dmd_ds6103_get_strength
**
**
...
/******************************************************************
** Function: mt_fe_dmd_ds6103_get_channel_info
**
**
...
/*********************************************************************************
** Function: mt_fe_dmd_ds6103_set_LNB
**
**
...
/*************************************************************************************
** Function: mt_fe_dmd_ds6103_DiSEqC_send_tone_burst
**
**
...
/*****************************************************************************
** Function: mt_fe_dmd_ds6103_DiSEqC_send_receive_msg
**
**
...
/**********************************************************************
** Function: mt_fe_ds6103_blindscan_abort
**
**
...
/*********************************************************************************
** Function: mt_fe_dmd_ds6103_register_blindscan_callback
**
**
...
MT_FE_RET _mt_fe_dmd_ds6103_select_xm(MT_FE_DS6103_Device_Handle handle, U32 *xm_KHz, U32 tuner_freq_MHz)
{
	U32 symbol_rate = 0;

	_mt_fe_dmd_ds6103_get_sym_rate(handle, &symbol_rate);

	mt_fe_it_dmpll_select_xm_ds6103(handle, xm_KHz, symbol_rate, tuner_freq_MHz);
...
MT_FE_RET _mt_fe_dmd_ds6103_select_mclk(MT_FE_DS6103_Device_Handle handle, U32 tuner_freq_MHz)
{
	mt_fe_it_dmpll_select_mclk_ds6103(handle, tuner_freq_MHz, FALSE);
...
MT_FE_RET _mt_fe_dmd_ds6103_get_ts_mclk(MT_FE_DS6103_Device_Handle handle, U32 *p_MCLK_KHz)
{
	mt_fe_it_dmpll_get_ts_mclk_ds6103(handle, p_MCLK_KHz);
...
/******************************************************************
** Function: _mt_fe_dmd_ds6103_set_ts_mclk
**
**
** Description:	set TS Clock Ratio for DS6103.
**
**
** Inputs:
...
MT_FE_RET _mt_fe_dmd_ds6103_set_ts_mclk(MT_FE_DS6103_Device_Handle handle, U32 MCLK_KHz)
{
	...
	mt_fe_it_dmpll_set_ts_mclk_ds6103(handle, ts_mode, MCLK_KHz);
...
/******************************************************************
** Function: _mt_fe_dmd_ds6103_set_ts_divide_ratio
**
**
...
/******************************************************************
** Function: _mt_fe_dmd_ds6103_set_clock_ratio
**
**
...
MT_FE_RET _mt_fe_dmd_ds6103_set_clock_ratio(MT_FE_DS6103_Device_Handle handle)
{
	...
	_mt_fe_dmd_ds6103_get_sym_rate(handle, &locked_sym_rate_KSs);
	...
	if (handle->tp_cfg.mCurrentType == MtFeType_DvbS2)			// for dvb-s2
	{
		...
		_mt_fe_dmd_ds6103_get_ts_mclk(handle, &MClk_KHz);
		...
		if (ts_mode == MtFeTsOutMode_Serial)
		{
			...
			_mt_fe_dmd_ds6103_select_xm(handle, &target_mclk, handle->tp_cfg.iFreqKHz / 1000);
			...
			_mt_fe_dmd_ds6103_get_ts_mclk(handle, &(handle->global_cfg.iSerialMclkHz));
	...
	_mt_fe_dmd_ds6103_set_ts_divide_ratio(handle, handle->tp_cfg.mCurrentType, tmp1, tmp2);
...
/******************************************************************
** Function: _mt_fe_dmd_ds6103_set_ts_out_mode
**
**
...
/*****************************************************************************
** Function: _mt_fe_dmd_ds6103_set_demod
**
**
...
MT_FE_RET _mt_fe_dmd_ds6103_set_demod(MT_FE_DS6103_Device_Handle handle, U32 sym_rate_KSs, MT_FE_TYPE type)
{
	...
	ret = _mt_fe_dmd_ds6103_init_reg(handle, ds6103_reg_tbl_def, sizeof(ds6103_reg_tbl_def) / 2);
	...
	_mt_fe_dmd_ds6103_set_sym_rate(handle, sym_rate_KSs);
...
/*****************************************************************************
** Function: _mt_fe_dmd_ds6103_set_sym_rate
**
**
...
/*****************************************************************************
** Function: _mt_fe_dmd_ds6103_get_sym_rate
**
**
...
/*************************************************************************
** Function:  _mt_fe_dmd_ds6103_set_carrier_offset
**
**
...
/***********************************************************************
** Function: _mt_fe_dmd_ds6103_get_carrier_offset
**
**
...
/***********************************************************************
** Function: _mt_fe_dmd_ds6103_get_total_carrier_offset
**
**
...
/*************************************************************************
** Function:  _mt_fe_dmd_ds6103_get_fec
**
**
...
/*****************************************************************************
** Function: _mt_fe_dmd_ds6103_get_current_ts_mode
**
**
...
/**********************************************************************
** Function: _mt_fe_dmd_ds6103_init_reg
**
**
** Description:	initialize the register of DS6103
**
**
** Inputs:
*
...
/*******************************************************************
** Function: _mt_fe_dmd_ds6103_download_fw
**
**
** Description:	download the mcu code to DS6103
**
**
** Inputs:
**
...
/*****************************************************************************
** Function: _mt_fe_dmd_ds6103_bs_set_demod
**
**
...
MT_FE_RET _mt_fe_dmd_ds6103_bs_set_demod(MT_FE_DS6103_Device_Handle handle, U32 sym_rate_KSs, MT_FE_TYPE type)
{
	...
	ret = _mt_fe_dmd_ds6103_init_reg(handle, ds6103_reg_tbl_bs_def, sizeof(ds6103_reg_tbl_bs_def)/2);
...
/********************************************************************************************
** Function: _mt_fe_dmd_ds6103_bs_remove_unlocked_TP
**
**
...
/************************************************************************************
** Function: _mt_fe_dmd_ds6103_bs_connect
**
**
									 ...
									 U16 scanned_tp)
{
	...
	for (index = start_index; index < scanned_tp; index++)
	{
		...
		if (handle->lnb_cfg.bUnicable)
		{
			ret = mt_fe_dmd_ds6103_unicable_set_tuner(handle, centerfreq_KHz, sym_rate_KSs, &real_freq_KHz, handle->lnb_cfg.iUBIndex, handle->lnb_cfg.iBankIndex, handle->lnb_cfg.iUBFreqMHz);
		...
		_mt_fe_dmd_ds6103_bs_set_demod(handle, sym_rate_KSs, current_mode);
		...
		while ((count > 0) && (!handle->global_cfg.bCancelBs))
		{
			...
			if (tmp & 0x08)
			{
				...
				if (handle->tp_cfg.bSuperSearch && ((ucTmp & 0x20) != 0x20))
				{
					...
					//mt_dbg_printf(1, "%s[%d] ---- Start super blindscan!\n", __FUNCTION__, __LINE__);
					...
					if ((tmp & 0x8f) == 0x0f)
					{
						...
						for (iPLSIndex = 0; iPLSIndex < iPLSCnt; iPLSIndex++)
						{
							...
							if ((val & 0x8f) == 0x8f)
							{
								//mt_dbg_printf(1, "%s[%d] ---- Super blindscan OK, PLS Gold = %d!\n", __FUNCTION__, __LINE__, mPLSGoldTable[iPLSIndex]);
						...
						if ((iPLSIndex == iPLSCnt) && ((val & 0x8f) != 0x8f))
						{
							...
							//mt_dbg_printf(1, "%s[%d] ---- Super blindscan failed\n", __FUNCTION__, __LINE__);
						}
					}
				}
			...
			if (lockstate == MtFeLockState_Locked)
			{
				...
				{
					// AFC on
					_mt_fe_dmd_ds6103_get_total_carrier_offset(handle, &carrier_offset);
		...
		if (lockstate == MtFeLockState_Locked)
		{
			...
			_mt_fe_dmd_ds6103_get_carrier_offset(handle, &carrieroffset_KHz);

			truefreq_KHz = real_freq_KHz + handle->tuner_cfg.tuner_get_offset(handle) - carrieroffset_KHz;

			_mt_fe_dmd_ds6103_get_sym_rate(handle, &sym_rate_KSs);
			...
			if (sym_rate_KSs > 990)	// 20221212
			{
				...
				_mt_fe_dmd_ds6103_get_fec(handle, &(p_bs_info->p_tp_info[index]), current_mode);
...
MT_FE_RET mt_fe_dmd_ds6103_unicable_set_tuner(MT_FE_DS6103_Device_Handle handle, U32 freq_KHz, U32 symbol_rate_KSs, U32* real_freq_KHz, U8 ub_select, U8 bank_select, U32 ub_freq_MHz)
{
	...
	mt_fe_dmd_ds6103_set_LNB(handle, MtFe_True, MtFe_False, MtFeLNB_18V, MtFe_False);
	handle->mt_sleep(15);

	mt_fe_dmd_ds6103_DiSEqC_send_receive_msg(handle, &msg);

	handle->mt_sleep(1);
	mt_fe_dmd_ds6103_set_LNB(handle, MtFe_True, MtFe_False, MtFeLNB_13V, MtFe_False);
...
/*************************************************************/
MT_FE_RET _mt_fe_dmd_ds6103_select_mclk_psd(MT_FE_DS6103_Device_Handle handle)
{
	mt_fe_it_dmpll_select_mclk_ds6103(handle, handle->tp_cfg.iFreqKHz / 1000, TRUE);
...
MT_FE_RET _mt_fe_dmd_ds6103_bs_set_reg_psd(MT_FE_DS6103_Device_Handle handle)
{
	U8 tmp, sm_buf;
...
static void mt_fe_dmd_bs_ch_measure(MT_FE_DS6103_Device_Handle handle, MT_FE_BS_TP_INFO *p_bs_info, U32 *psd, U32 idx_ps_sn)
{
...
MT_FE_RET _mt_fe_dmd_ds6103_bs_process_get_range_list(MT_FE_DS6103_Device_Handle handle,U32 begin_freq_MHz, U32 end_freq_MHz, U32 *range_list,U8 *list_num)
{
	...
	while (set_freq < end_freq_MHz)
	{
		...
		dwTmp1 = atoi(str4);
#else
		_mt_fe_dmd_ds6103_bs_set_reg_psd(handle);
		handle->tp_cfg.iFreqKHz = (freq_KHz + 500) / 1000 * 1000;
		handle->tp_cfg.iSymRateKSs = BLINDSCAN_SYMRATEKSs;

		if (handle->lnb_cfg.bUnicable)
		{
			mt_fe_dmd_ds6103_unicable_set_tuner(handle, freq_KHz, BLINDSCAN_SYMRATEKSs, &real_freq_KHz, handle->lnb_cfg.iUBIndex, handle->lnb_cfg.iBankIndex, handle->lnb_cfg.iUBFreqMHz);
		...
		mt_fe_dmd_ds6103_get_strength(handle, &dwTmp1);
#endif
...
MT_FE_RET _mt_fe_dmd_ds6103_bs_process_scanned_TP_soft(MT_FE_DS6103_Device_Handle handle, U32 *psd, U32 cur_scan_freq_KHz, U8 bs_times, S8 *strength)
{
	MT_FE_BOOL	b_analog_locked, b_fftdone;
	...
	//mt_fe_tn_get_gain(handle, &gain_val);
	mt_fe_dmd_ds6103_get_strength(handle, &iStrength);
...
MT_FE_RET _mt_fe_dmd_ds6103_bs_A_soft(MT_FE_DS6103_Device_Handle handle, U32 begin_freq_MHz, U32 end_freq_MHz, MT_FE_BS_TP_INFO *p_bs_info, U8 bs_times)
{
	...
	//////////////////////////////
	//clock4 = clock();
	//_mt_fe_dmd_ds6103_bs_process_get_range_list(handle, begin_freq_MHz, end_freq_MHz - 2, F_range_list, &fre_seg_idx);
	//clock5 = clock();
	...
	for (i = 0; i < fre_seg_idx; i++)
	{
		...
		while ((flag_scan_done == 0) && (!handle->global_cfg.bCancelBs))
		{
...
#if 1
			handle->dmd_set_reg(handle, 0x06, 0xe0);
			_mt_fe_dmd_ds6103_select_mclk_psd(handle);
			_mt_fe_dmd_ds6103_set_ts_mclk(handle, 96000);
			handle->dmd_set_reg(handle, 0x06, 0x00);
#endif
			handle->mt_sleep(10);
			...
			_mt_fe_dmd_ds6103_set_carrier_offset(handle, handle->tuner_cfg.tuner_get_offset(handle));

			ret = _mt_fe_dmd_ds6103_bs_process_scanned_TP_soft(handle, psd, freq_KHz, bs_times, &sig_stre);
#endif
			...
			while (idx_curr <= FFT_N - 2 * OVLP)
			{
				...
				if ((idx_curr > idx_ch_max) || ( cnt_notch > 0))//% after a  first rising edge,during a falling edge OR
				{
					...
					//	idx_notch_last_tmp = idx_notch_last;
						...
						{
							//sprintf(log_str, "\tmt_fe_dmd_ds6103_bs_A_test_2 ---- sig_idx = 0!\n");
							//mt_fe_dbg_log2file(log_str);
						}
						...
						{
							//sprintf(log_str, "\tmt_fe_dmd_ds6103_bs_A_test_1 ---- sig_idx = 0!\n");
							//mt_fe_dbg_log2file(log_str);
						}
	...
	#if FIND_DEBUG
	#else
	_mt_fe_dmd_ds6103_bs_connect(handle, p_bs_info, 0, handle->global_cfg.iScannedTpCnt);
	#endif
...
MT_FE_RET mt_fe_dmd_ds6103_blindscan(MT_FE_DS6103_Device_Handle handle, U32 begin_freq_MHz, U32 end_freq_MHz, MT_FE_BS_TP_INFO *p_bs_info)
{
	...
	_mt_fe_dmd_ds6103_bs_A_soft(handle, begin_freq_MHz, end_freq_MHz, p_bs_info, times);

	if (!handle->global_cfg.bCancelBs)
	{
		handle->mt_sleep(1000);

		_mt_fe_dmd_ds6103_bs_remove_unlocked_TP(handle, p_bs_info, (U32)FREQ_MAX_KHz);
	}
