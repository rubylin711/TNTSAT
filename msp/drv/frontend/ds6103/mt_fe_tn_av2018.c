...
static TUNER_ErrorCode Tuner_I2C_Write(pTunerPara pAVtuner, UINT8 reg_start, UINT8* buff, UINT8 length)
{
	...
	ds6103_handle->tn_write(ds6103_handle, buf, (U16)(length + 1));
...
static TUNER_ErrorCode Tuner_I2C_Write (pTunerPara pAVtuner, UINT8 reg_start, UINT8* buff, UINT8 length)
{
	...
	ds6103_handle->tn_write(ds6103_handle, queue, (U16)(length + 2));
...
static TUNER_ErrorCode Tuner_I2C_Read (pTunerPara pAVtuner, UINT8 reg_start, UINT8* buff, UINT8 length)
{
	...
	ds6103_handle->tn_read(ds6103_handle, reg_start, buff, length);
...
MT_FE_RET mt_fe_tn_get_gain_AV2018_ds6103(MT_FE_DS6103_Device_Handle handle, U32 *p_gain)
{
...
MT_FE_RET mt_fe_tn_get_strength_AV2018_ds6103(MT_FE_DS6103_Device_Handle handle, U32 *p_gain, S32 *p_strength)
{
	...
	mt_fe_tn_get_gain_AV2018_ds6103(handle, &gain_val);
