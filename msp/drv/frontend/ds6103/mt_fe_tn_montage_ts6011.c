...
S32 mt_fe_tn_ts6011_wakeup_ds6103(MT_FE_Tuner_Handle_TS6011 handle)
{
...
S32 mt_fe_tn_ts6011_sleep_ds6103(MT_FE_Tuner_Handle_TS6011 handle)
{
...
/************************************************************************/
S32 mt_fe_tn_ts6011_get_gain_ds6103(MT_FE_Tuner_Handle_TS6011 handle, U32 Vagc)
{
...
void mt_fe_tn_ts6011_init_ds6103(MT_FE_Tuner_Handle_TS6011 handle)
{
	...
	mt_fe_tn_ts6011_wakeup_ds6103(handle);
...
void mt_fe_tn_set_tuner_ts6011_ds6103(MT_FE_Tuner_Handle_TS6011 handle, U32 freq_MHz, U32 symbol_rate_KSs)
{
#if MT_FE_TS6011_DEBUG_PRNT
...
void mt_fe_tn_adjust_AGC_ts6011_ds6103(MT_FE_Tuner_Handle_TS6011 handle)
{
	_mt_sleep_ds6103(10);
...
S32 mt_fe_tn_ts6011_get_freq_offset_ds6103(MT_FE_Tuner_Handle_TS6011 handle)
{
...
S32 mt_fe_tn_ts6011_set_freq_ds6103(MT_FE_Tuner_Handle_TS6011 handle, U32 Freq_KHz, U32 sym_rate_KSs, S16 lpf_offset_KHz)
{
	U32 freq_MHz = (Freq_KHz + 500) / 1000;

	handle->tuner_lpf_offset_KHz = lpf_offset_KHz;
	mt_fe_tn_set_tuner_ts6011_ds6103(handle, freq_MHz, sym_rate_KSs);
...
/************************************************************************/
S32 mt_fe_tn_ts6011_get_signal_strength_ds6103(MT_FE_Tuner_Handle_TS6011 handle, S32 Vagc, MT_BOOL bLocked)
{
	U8  strength = 0;
	S32 gain = 0;
	...
	gain = mt_fe_tn_ts6011_get_gain_ds6103(handle, Vagc);  //Get the total tuner gain in 0.01dB
	...
	//mt_fe_dmd_ds6103_get_pure_lock(handle, &lockstate);		// Get the lock status of the demodulator;
...
MT_FE_RET mt_fe_tn_init_ts6011_ds6103(MT_FE_DS6103_Device_Handle handle)
{
	...
	handle->tuner_cfg.tuner_handle = (mt_handle)ts6011_handle;

	mt_fe_tn_ts6011_init_ds6103(ts6011_handle);
...
MT_FE_RET mt_fe_tn_sleep_ts6011_ds6103(MT_FE_DS6103_Device_Handle handle)
{
	...
	mt_fe_tn_ts6011_sleep_ds6103(ts6011_handle);
...
MT_FE_RET mt_fe_tn_wake_up_ts6011_ds6103(MT_FE_DS6103_Device_Handle handle)
{
	...
	mt_fe_tn_ts6011_wakeup_ds6103(ts6011_handle);
...
MT_FE_RET mt_fe_tn_get_strength_ts6011_ds6103(MT_FE_DS6103_Device_Handle handle, U32 *p_gain, S32 *p_strength)
{
	...
	gain = mt_fe_tn_ts6011_get_gain_ds6103(ts6011_handle, Vagc);
	...
	mt_fe_dmd_ds6103_get_pure_lock(handle, &lockstate);
...
MT_FE_RET mt_fe_tn_set_freq_ts6011_ds6103(MT_FE_DS6103_Device_Handle handle, U32 freq_KHz, U32 sym_rate_KSs, S16 lpf_offset_KHz)
{
	...
	mt_fe_tn_ts6011_set_freq_ds6103(ts6011_handle, freq_KHz, sym_rate_KSs, lpf_offset_KHz);
...
S32 mt_fe_tn_get_tuner_freq_offset_ts6011_ds6103(MT_FE_DS6103_Device_Handle handle)
{
	...
	return mt_fe_tn_ts6011_get_freq_offset_ds6103(ts6011_handle);
}

MT_FE_RET mt_fe_tn_get_gain_ts6011_ds6103(MT_FE_DS6103_Device_Handle handle, U32 *p_gain)
{
	S32 Vagc;
	U8  AgcPWM;
	...
	*p_gain = mt_fe_tn_ts6011_get_gain_ds6103(ts6011_handle, Vagc);
