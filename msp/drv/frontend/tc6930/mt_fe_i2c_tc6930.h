...
MT_FE_RET _mt_fe_dsp_set_reg_tc6930(void *dev_handle,U8 iIndex, U8 reg_index, U8 data);
MT_FE_RET _mt_fe_dsp_get_reg_tc6930(void *dev_handle,U8 iIndex, U8 reg_index, U8 *p_buf);
