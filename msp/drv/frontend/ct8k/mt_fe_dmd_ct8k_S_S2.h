...
typedef struct _MT_FE_BS_TP_INFO
{
    ...
    U32     next_freq_KHz;	//fix 99855 start
} MT_FE_BS_TP_INFO;
...
typedef struct _MT_FE_BOARD_SETTINGS_SS2_CT8K
{
	MT_BOOL		bIQInverted;
	MT_BOOL		bAGCPolar;
...
} MT_FE_BOARD_SETTINGS_SS2_CT8K;


typedef struct _MT_FE_TS_SETTINGS_SS2_CT8K
{
	//MT_BOOL					bHighZ;
	...
	//MT_BOOL					bHighValid;
	//MT_BOOL					bHighError;
} MT_FE_TS_SETTINGS_SS2_CT8K;

typedef struct _MT_FE_LNB_SETTINGS_SS2_CT8K
{
	MT_BOOL					bLnbOn;
	MT_BOOL					b22K;
	...
	U8						iUBVer;
	MT_BOOL					bSpectrumInverted;
}MT_FE_LNB_SETTINGS_SS2_CT8K;

typedef struct _MT_FE_TP_PARAMS_SS2_CT8K
{
	...
	MT_BOOL					bHavePLS;
	U8						ucPLSCode[3];
} MT_FE_TP_PARAMS_SS2_CT8K;

typedef struct _MT_FE_GLOBAL_SETTINGS_SS2_CT8K
{
	S32			iMclkKHz;
...
} MT_FE_GLOBAL_SETTINGS_SS2_CT8K;

typedef struct _MT_FE_BS_SETTINGS_SS2_CT8K
{
	U16		fft_length;
	U8		psd_overlap;
	U16		ave_times;
