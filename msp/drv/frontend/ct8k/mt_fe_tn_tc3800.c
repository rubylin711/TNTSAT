...
static U32 tc3800_ct8k_dbg_level = 0;
...
static S32 _mt_fe_tn_get_reg_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 reg_addr, U8 *reg_data)
{
	mt_fe_tn_read_ct8k(handle->tuner_dev_addr, &reg_addr, 1, reg_data, 1);
...
static S32 _mt_fe_tn_set_reg_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 reg_addr, U8 reg_data)
{
	...
	mt_fe_tn_write_ct8k(handle->tuner_dev_addr,p_buf,2);
...
static void _mt_wait_tc3800(U32 ticks_ms)
{
...
MT_FE_RET mt_fe_tn_set_freq_tc3800_tc_ct8k(MT_FE_CT8K_Device_Handle handle, U32 Freq_KHz, U32 sym_rate, S16 lpf_offset)
{
	...
	{
		mt_fe_tn_init_tc3800_tc_ct8k(handle);
	}
...
MT_FE_RET mt_fe_tn_wake_up_tc3800_tc_ct8k(MT_FE_CT8K_Device_Handle handle)
{
	...
	mt_fe_tn_set_freq_tc3800_tc_ct8k(handle, handle->m_device_ctt2.input_params.input_freq_kHz, 0, 0);
...
{
	tc3800_ct8k_dbg_level = tc3800_dbg_level;
}

void mt_fe_tn_get_tc3800_dbg_level_ct8k(U32 *tc3800_dbg_level)
{
	*tc3800_dbg_level = tc3800_ct8k_dbg_level;
}
...
void mt_fe_ct8k_tn_attach_tc3800(void)
{
