...
*********************************************************************************************/
#ifndef __MT_FE_DEF_CT8K_C_H__
#define __MT_FE_DEF_CT8K_C_H__
...
MT_FE_RET _mt_fe_dmd_set_QAM_ct8k_c(MT_FE_CT8K_Device_Handle handle);//, U16 qam);
MT_FE_RET _mt_fe_dmd_soft_reset_ct8k_c(MT_FE_CT8K_Device_Handle handle);
MT_FE_RET _mt_fe_dmd_connect_ct8k_c(MT_FE_CT8K_Device_Handle handle);//, U32 freq_KHz, U16 symbol_rate_KSs, U16 qam, U8 inverted);
MT_FE_RET _mt_fe_dmd_get_statistics_ct8k_c(MT_FE_CT8K_Device_Handle handle, U32 *agc_lock, U32 *timing_lock, U32 *dagc_lock,
