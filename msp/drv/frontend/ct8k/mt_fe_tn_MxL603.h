...
#ifndef __MT_FE_TN_MXL603_H__
#define __MT_FE_TN_MXL603_H__
...
#include "./MxL6/MaxLinearDataTypes.h"
...
******************************************************************************/
extern const UINT8 MxLWare603DrvVersion_ct8k[5];
...
MXL_STATUS MxLWare603_API_CfgDevOverwriteDefaults_ct8k(UINT8 devId, MXL_BOOL singleSupply_3_3V);
...
MXL_STATUS MxLWare603_API_ReqDevVersionInfo_ct8k(UINT8 devId, MXL603_VER_INFO_T* mxlDevVerInfoPtr);
MXL_STATUS MxLWare603_API_ReqDevGPOStatus_ct8k(UINT8 devId, MXL603_GPO_STATE_E* gpoStatusPtr);
MXL_STATUS MxLWare603_API_ReqDevPllState_ct8k(UINT8 devId, MXL603_PLL_STATE_E* PllStatePtr);

MXL_STATUS MxLWare603_API_CfgTunerMode_ct8k(UINT8 devId, MXL603_TUNER_MODE_CFG_T tunerModeCfg);
...
MXL_STATUS MxLWare603_API_CfgTunerChanTune_ct8k(UINT8 devId, MXL603_CHAN_TUNE_CFG_T chanTuneCfg);

MXL_STATUS MxLWare603_API_ReqTunerAGCLock_ct8k(UINT8 devId, MXL_BOOL* agcLockStatusPtr);
MXL_STATUS MxLWare603_API_ReqTunerLockStatus_ct8k(UINT8 devId, MXL_BOOL* rfLockPtr, MXL_BOOL* refLockPtr);
