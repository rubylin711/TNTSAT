...
typedef enum _MT_FE_RS6K_CODE_RATE_SELECT
{
    MtFeRs6kCodeRate_None    = 0
    ,MtFeRs6kCodeRate_AllEn  = 0xf8
    ,MtFeRs6kCodeRate_1_2_en = 0x08
    ,MtFeRs6kCodeRate_2_3_en = 0x10
    ,MtFeRs6kCodeRate_3_4_en = 0x20
    ,MtFeRs6kCodeRate_5_6_en = 0x40
    ,MtFeRs6kCodeRate_6_7_en = 0x80
    ,MtFeRs6kCodeRate_7_8_en = 0x80
} MT_FE_RS6K_CODE_RATE_SELECT;
...
typedef struct _MT_FE_BOARD_SETTINGS_SS2_DM6K
{
	MT_BOOL		bIQInverted;
	MT_BOOL		bAGCPolar;
...
} MT_FE_BOARD_SETTINGS_SS2_DM6K;


typedef struct _MT_FE_TS_SETTINGS_SS2_DM6K
{
	//MT_BOOL					bHighZ;
	...
	//MT_BOOL					bHighValid;
	//MT_BOOL					bHighError;
} MT_FE_TS_SETTINGS_SS2_DM6K;

typedef struct _MT_FE_LNB_SETTINGS_SS2_DM6K
{
	MT_BOOL					bLnbOn;
	MT_BOOL					b22K;
	...
	U8						iUBCount;
	U16						iUBList[8];
}MT_FE_LNB_SETTINGS_SS2_DM6K;
/*
typedef struct _MT_FE_TP_PARAMS_SS2_DM6K
{
	...
	S32						iOffsetRangeKHz;
} MT_FE_TP_PARAMS_SS2_DM6K;
*/
typedef struct _MT_FE_GLOBAL_SETTINGS_SS2_DM6K
{
	MT_BOOL		bCheckCCI;
	...
	MT_BOOL		bCancelBs;
	U8			iTotalBsTimes;
} MT_FE_GLOBAL_SETTINGS_SS2_DM6K;
...
**    This define is used to unlock RS6000 if the carrier offset
** is larger than the defined carrier offset.
**      User can set this define to "1" and set the carrier offset
** (4MHz offset as default).
**      If the carrier offset if larger than the defined value, RS6000
