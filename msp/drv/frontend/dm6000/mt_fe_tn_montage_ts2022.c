...
static MT_FE_RET ts2022_tn_get_reg(MT_FE_DM6K_Device_Handle handle, U8 reg_addr, U8 *p_data)
{
	return _mt_fe_tn_get_reg_ss2(handle, reg_addr, p_data);
}

static MT_FE_RET ts2022_tn_set_reg(MT_FE_DM6K_Device_Handle handle, U8 reg_addr, U8 reg_data)
{
...
static U8 CheckTunerVersion(MT_FE_DM6K_Device_Handle handle)
{
	U8 buf = 0;
...
/***************************************************************************/
static void InitialTuner(MT_FE_DM6K_Device_Handle handle)
{
	U8 buf = 0;
 ...
 **************************************************************************/
static S32 SetTuner(MT_FE_DM6K_Device_Handle handle, U32 fPLL, U32 fSym, U16 lpfOffset, U8 gainHold)
{
...
/***************************************************************************/
static void SleepTuner(MT_FE_DM6K_Device_Handle handle)
{
...
/************************************************************************/
static S32	GetTunerGain(MT_FE_DM6K_Device_Handle handle, U16 Vagc)
{
...
/************************************************************************/
static U8 GetSignalStrength(MT_FE_DM6K_Device_Handle handle)
{
	U8  strength = 0;
	S32  Vagc = 0;
	S32 gain = 0;
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x3f, &AgcPWM);
	...
	mt_fe_dmd_get_pure_lock_dm6k_ss2(handle, &lockstate);		// Get the lock status of the demodulator M88DS3002;
