...
MXL601_REG_CTRL_INFO_T MxL601_OverwriteDefaults[] = 
{
  {0x00, 0xFF, 0x01},
  {0x96, 0xFF, 0x00},
  {0x00, 0xFF, 0x00},
...
MXL601_REG_CTRL_INFO_T MxL601_AnalogNtsc[] = 
{
  {0x0C, 0xFF, 0x08},
  {0x13, 0xFF, 0x00},
  {0x53, 0xFF, 0x3E},
...
MXL601_REG_CTRL_INFO_T MxL601_Ntsc_RfLutSwpHIF[] = 
{
  {0x4A, 0xFF, 0x1B},
  {0x4B, 0xFF, 0x1A},
  {0x4C, 0xFF, 0x19},
...
MXL601_REG_CTRL_INFO_T MxL601_Ntsc_16MHzRfLutSwpLIF[] = 
{
  {0x4A, 0xFF, 0x1B},
  {0x4B, 0xFF, 0x1A},
  {0x4C, 0xFF, 0x19},
...
MXL601_REG_CTRL_INFO_T MxL601_Ntsc_24MHzRfLutSwpLIF[] = 
{
  {0x4A, 0xFF, 0x1C},
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
...
MXL601_REG_CTRL_INFO_T MxL601_Ntsc_HRCRfLutSwpLIF[] = 
{
  {0x4A, 0xFF, 0x1C},
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
...
MXL601_REG_CTRL_INFO_T MxL601_Pal_RfLutSwpLIF[] = 
{
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
  {0x4D, 0xFF, 0x19},
...
MXL601_REG_CTRL_INFO_T MxL601_PalD_RfLutSwpHIF[] = 
{
  {0x4B, 0xFF, 0x14},
  {0x4C, 0xFF, 0x13},
  {0x4D, 0xFF, 0x15},
...
MXL601_REG_CTRL_INFO_T MxL601_PalI_RfLutSwpHIF[] = 
{
  {0x4B, 0xFF, 0x16},
  {0x4C, 0xFF, 0x15},
  {0x4D, 0xFF, 0x14},
...
MXL601_REG_CTRL_INFO_T MxL601_PalBG_8MHzBW_RfLutSwpHIF[] = 
{
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
  {0x4D, 0xFF, 0x19},
...
MXL601_REG_CTRL_INFO_T MxL601_PalBG_7MHzBW_RfLutSwpHIF[] = 
{
  {0x4B, 0xFF, 0x1B},
  {0x4C, 0xFF, 0x1A},
  {0x4D, 0xFF, 0x15},
...
MXL601_REG_CTRL_INFO_T MxL601_AnalogPal[] = 
{
  {0x13, 0xFF, 0x00},
  {0x53, 0xFF, 0x3E},
  {0x57, 0xFF, 0x91},
...
MXL601_REG_CTRL_INFO_T MxL601_AnalogSecam[] = 
{
  {0x13, 0xFF, 0x00},
  {0x53, 0xFF, 0x3E},
  {0x57, 0xFF, 0x91},
...
MXL601_REG_CTRL_INFO_T MxL601_DigitalDvbc[] = 
{
  {0x0C, 0xFF, 0x00},
  {0x13, 0xFF, 0x04},
  {0x53, 0xFF, 0x3E},
...
MXL601_REG_CTRL_INFO_T MxL601_DigitalIsdbtAtsc[] = 
{
  {0x0C, 0xFF, 0x00},
  {0x13, 0xFF, 0x04},
  {0x53, 0xFF, 0xFE},
...
MXL601_REG_CTRL_INFO_T MxL601_DigitalDvbt[] = 
{
  {0x13, 0xFF, 0x04},
  {0x0C, 0xFF, 0x00},
  {0x53, 0xFF, 0xFE},
