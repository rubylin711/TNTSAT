...
static S32 _mt_fe_tn_get_reg_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 reg_addr, U8 *reg_data)
{
	mt_fe_tn_read_dm6k(handle->tuner_dev_addr, &reg_addr, 1, reg_data, 1);

	return 0;
}

static S32 _mt_fe_tn_set_reg_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 reg_addr, U8 reg_data)
{
	U8 p_buf[2] = {0, 0};
	...
	mt_fe_tn_write_dm6k(handle->tuner_dev_addr,p_buf,2);

	return 0;
}

static S32 _mt_fe_tn_set_reg_bit_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 reg_addr, U8 data, U8 high_bit, U8 low_bit)
{
	U8 tmp = 0, value = 0;
...
static void _mt_sleep_tc3800(U32 ticks_ms)
{
	_mt_sleep_dm6k(ticks_ms);
}

/*****************************************************************************/
/*Function: 	_mt_fe_tn_set_RF_front_tc3800								 */
/*****************************************************************************/
static void _mt_fe_tn_set_RF_front_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
/*****************************************************************************/
static void _mt_fe_tn_set_Mixer_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	U32 freq_KHz = handle->tuner_freq;
...
/*****************************************************************************/
static void _mt_fe_tn_set_PLL_freq_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
/*****************************************************************************/
static void _mt_fe_tn_set_BB_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	U8  bandwidth = 0;
...
/*****************************************************************************/
static void _mt_fe_tn_set_BB_Cal_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 bandwidth)
{
	U32	Fcal_tia = 0;
	U32	Fcal_bq = 0;
...
/*****************************************************************************/
static void _mt_fe_tn_set_DAC_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	U32		DACFreq_KHz = 0;
...
/*****************************************************************************/
static void _mt_fe_tn_preset_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
/*****************************************************************************/
static void _mt_fe_tn_div_ratio_cal_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U32 FVCO_TG, U32 FR_V, U32 FD, U8 N_HALF, U8 SDM, U32 *div_out)
{
	U32	Ndiv2_scale			= 0;
...
/*****************************************************************************/
static void _mt_fe_tn_freq_fine_tune_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 Delta_sign, U8 Num_step)
{
...
/*****************************************************************************/
static void _mt_fe_tn_freq_fine_tune_core_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 Delta_sign, U8 Num_step, U32 LDIV, U32 FR_V, U8 N_HALF, U8 SDM)
{
	U32	Ndiv2_scale			 = 0;
	U32	div_N_V_scale_right	 = 0;
	U32	den_shift_bit		 = 7;
...
/*****************************************************************************/
static void _mt_fe_tn_set_tune_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U32 WaitTime)
{
...
/*****************************************************************************/
static void _mt_fe_tn_set_sysmon_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	if(handle->tuner_int_fast_set == 1)
	{
		_mt_fe_tn_set_reg_tc3800(handle, 0xb5, 0x14);
...
/*****************************************************************************/
static void _mt_fe_tn_poweron_set_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
#if TC3800_ENABLE_PRINT
	mt_fe_print(("TC3800 power on.\n"));
#endif
...
/*****************************************************************************/
static void _mt_fe_tn_lpf_cal_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
/*****************************************************************************/
static void _mt_fe_tn_set_mch_cal_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
/*****************************************************************************/
static void _mt_fe_tn_set_mch_app_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
/*****************************************************************************/
static void _mt_fe_tn_set_appendix_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	return;
}
#endif
...
/*****************************************************************************/
static void mt_fe_tn_wakeup_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
/*****************************************************************************/
static void mt_fe_tn_sleep_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	U8	buf = 0;
...
/*****************************************************************************/
static void mt_fe_tn_init_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	if (handle->tuner_init_OK != 1)
	{
	#if TC3800_ENABLE_PRINT
		mt_fe_print("TC3800 initialize.\n");
	#endif
//		handle->tuner_dev_addr			 = TUNER_I2C_ADDR_TC3800;

//		handle->tuner_application		 = 3;
...
/*****************************************************************************/
static void mt_fe_tn_set_freq_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U32 freq_KHz)
{
	U8 buf = 0, buf1 = 0, buf2 = 0, buf3 = 0, buf4 = 0, buf5 = 0, buf6 = 0, buf7 = 0;
	U8 tWait1 = 0, tWait2 = 0;

#if TC3800_ENABLE_PRINT
	mt_fe_print("TC3800 set freq called.tuner_app is %d\n",handle->tuner_application);
#endif
	...
	if(((handle->tuner_application == 3)||(handle->tuner_application == 4)) && (handle->tuner_freq == 690000) && (handle->tuner_custom_cfg == 1))
	{
		_mt_sleep_tc3800(100);
		_mt_fe_tn_get_reg_tc3800(handle, 0x8a, &buf);
		buf = buf & 0x0f;
		_mt_fe_tn_get_reg_tc3800(handle, 0x2a, &buf1);
		buf1 = buf1 & 0x7f;
		if(((buf == 7) || (buf == 8) || (buf == 9) || (buf == 10)) && (buf1 == 64))
		{
			_mt_fe_tn_set_reg_bit_tc3800(handle, 0x8a, 0x1b, 4, 0);
		}
		#if 0
		_mt_fe_tn_get_reg_tc3800(handle, 0x8a, &buf);
		mt_fe_print(("[enter %s, %d  0x8a = 0x%x] \n", __FUNCTION__, __LINE__, buf));
		#endif
	}

#if TC3800_ENABLE_PRINT
	mt_fe_print("tc3800 set finished.\n");
#endif
...
/*****************************************************************************/
static void mt_fe_tn_set_BB_filter_band_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 bandwidth)
{
...
static S32 mt_fe_tn_get_signal_strength_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
/*****************************************************************************/
static void mt_fe_tn_set_GPIOout_high_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
/*****************************************************************************/
static void mt_fe_tn_set_GPIOout_low_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
...
static void mt_fe_tn_set_test_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	U8 buf = 0, buf1 = 0;

	if(((handle->tuner_application == 4)) && (handle->tuner_freq == 690000) && (handle->tuner_custom_cfg == 1))
	{
		//_mt_sleep_tc3800(100);
		_mt_fe_tn_get_reg_tc3800(handle, 0x8a, &buf);
		buf = buf & 0x0f;
		...
		#if 0
		_mt_fe_tn_get_reg_tc3800(handle, 0x8a, &buf);
		mt_fe_print(("[enter %s, %d  0x8a = 0x%x FREQ:%dKHZ] \n", __FUNCTION__, __LINE__,buf, handle->tuner_freq));
		_mt_fe_tn_get_reg_tc3800(handle, 0x8d, &buf);
		mt_fe_print(("[enter %s, %d  0x8d = 0x%x] \n", __FUNCTION__, __LINE__,(buf & 0x3f)));
		#endif
	}
...
/*****************************************************************************/
static void mt_fe_tn_get_diagnose_info_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U32* data1, U32* data2)
{
	...
	mt_fe_print(("TC3800 - tia: %d, bb: %d, vga: %d, dac: %d, fr: %d\n", reg_data0, reg_data1, reg_data2, reg_data3, reg_data4));
	...
	mt_fe_print(("TC3800 - tia_cap: %d, bp_cap: %d, lna_cc: %d, cc_final: %d\n", reg_data0, reg_data1, value0, value1));
	...
	mt_fe_print(("TC3800 - 0x01: 0x%x, 0xc5: 0x%x, 0xc6: 0x%x, 0xc8: 0x%x\n", reg_data0, reg_data1, reg_data2, reg_data3));
	...
	mt_fe_print(("TC3800 - 0x65: 0x%x, 0x66: 0x%x, 0x67: 0x%x, 0x68: 0x%x, 0x69: 0x%x\n", reg_data0, reg_data1, reg_data2, reg_data3, reg_data4));
	...
	mt_fe_print(("TC3800 - 0x6a: 0x%x, 0x6b: 0x%x, 0x6c: 0x%x\n", reg_data0, reg_data1, reg_data2));
...
{
	TC3800_tuner_cfg.tuner_dev_addr = handle->m_device_ctt2.tuner_cfg.tuner_dev_addr;

	if(handle->m_device_ctt2.demod_type == MtFeType_DVBC)
	{
		TC3800_tuner_cfg.tuner_init_OK = handle->m_device_ctt2.tuner_cfg.tuner_init_ok;
		...
		TC3800_tuner_cfg.tuner_dac = 7200;
	}
	else
	{
		if(handle->m_device_ctt2.demod_type == MtFeType_DVBT)
			TC3800_tuner_cfg.tuner_application = 4;
		else if(handle->m_device_ctt2.demod_type == MtFeType_DVBT2)
			TC3800_tuner_cfg.tuner_application = 3;
		...
		if (handle->m_device_ctt2.input_params.demod_bandwidth == MtFeBandwidth_8M)
			...
			TC3800_tuner_cfg.tuner_bandwidth = 6;
		else if (handle->m_device_ctt2.input_params.demod_bandwidth == MtFeBandwidth_10M)
			TC3800_tuner_cfg.tuner_bandwidth = 10;

		TC3800_tuner_cfg.tuner_dac = 5000;
	}

	mt_fe_tn_init_tc3800(&TC3800_tuner_cfg);

	handle->m_device_ctt2.tuner_cfg.tuner_init_ok = TC3800_tuner_cfg.tuner_init_OK;
	handle->m_device_ctt2.tuner_cfg.tuner_open = TC3800_tuner_cfg.tuner_init_OK;
...
MT_FE_RET mt_fe_tn_get_strength_tc3800_tc(MT_FE_DM6K_Device_Handle  handle,S8 *p_strength)
{
	...
	if (handle->m_device_ctt2.tuner_cfg.tuner_lna_type == 1)
	{
		if (handle->m_device_ctt2.input_params.input_freq_kHz < 474000)
			strength = (S8)((mt_fe_tn_get_signal_strength_tc3800(&TC3800_tuner_cfg)) -9);
		else if (handle->m_device_ctt2.input_params.input_freq_kHz <=666000)
			strength = (S8)((mt_fe_tn_get_signal_strength_tc3800(&TC3800_tuner_cfg)) -14);
		else if (handle->m_device_ctt2.input_params.input_freq_kHz <=794000)
			strength = (S8)((mt_fe_tn_get_signal_strength_tc3800(&TC3800_tuner_cfg)) -12);
		else
			strength = (S8)((mt_fe_tn_get_signal_strength_tc3800(&TC3800_tuner_cfg)) -9);
	}
	else
		strength = (S8)(mt_fe_tn_get_signal_strength_tc3800(&TC3800_tuner_cfg));
	mt_fe_i2c_repeat_disable_dm6k(handle);
...
MT_FE_RET mt_fe_tn_wake_up_tc3800_tc(MT_FE_DM6K_Device_Handle  handle)
{
	...
	mt_fe_tn_set_freq_tc3800_tc(handle, handle->m_device_ctt2.input_params.input_freq_kHz, 0, 0);

	return MtFeErr_Ok;
}

MT_FE_RET mt_fe_tn_application_tc3800_tc(MT_FE_DM6K_Device_Handle  handle, U8 tc3800_application)
{
...
MT_FE_RET mt_fe_tn_loop_tc3800_tc(MT_FE_DM6K_Device_Handle  handle, S16 tc3800_1oop)
{
...
MT_FE_RET mt_fe_tn_loop_add_tc3800_tc(MT_FE_DM6K_Device_Handle  handle, U8 tc3800_1oop_add)
{
...
MT_FE_RET mt_fe_tn_xtal_tc3800_tc(MT_FE_DM6K_Device_Handle  handle, U32 xtal_khz)
{
	TC3800_tuner_cfg.tuner_crystal = xtal_khz;

	return MtFeErr_Ok;
}

MT_FE_RET mt_fe_tn_im_tc3800_tc(MT_FE_DM6K_Device_Handle  handle, U8 tc3800_im)
{
...
MT_FE_RET mt_fe_tn_clkout_tc3800_tc(MT_FE_DM6K_Device_Handle  handle, U8 tc3800_clock)
{
