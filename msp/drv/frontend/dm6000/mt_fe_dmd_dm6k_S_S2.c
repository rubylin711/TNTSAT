...
/***************************************************************************/
/*
*	FILE:				mt_fe_dmd_dm6k_S_S2.c
*
*	VERSION:			06
*
*	DESCRIPTION:
*			Define the interfaces to initialize and get the channel info from DM6000
*
*	History:
*	Description		Version		Date			Author
*---------------------------------------------------------------------------
*	File Create		00			2013.03.12		YZ.Huang
*	Modify			01			2014.09.26		YZ.Huang
*	Modify			02			2015.07.20		BJ.Wang
*	Modify			03			2016.03.10		BJ.Wang
*	Modify			04			2016.03.29		BJ.Wang
*	Modify			05			2017.07.18		BJ.Wang
*	Modify			06			2018.02.28		YZ.Huang
***************************************************************************************/
...
#include "mt_fe_dmd_fw_dm6k_S_S2.h"
#include "mt_fe_dmd_reg_tbl_dm6k_S_S2.h"
...
****external function****
*************************/
extern void _mt_sleep_dm6k(U32 ms);
...
****internal function****
*************************/
MT_FE_RET _mt_fe_dmd_set_demod_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 sym_rate_KSs, MT_FE_TYPE type);
MT_FE_RET _mt_fe_dmd_init_reg_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, const U8 (*p_reg_tabl)[2], S32 size);
MT_FE_RET _mt_fe_dmd_download_fw_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, const U8* p_fw);
MT_FE_RET _mt_fe_dmd_set_ts_out_mode_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_TS_OUT_MODE mode);
MT_FE_RET _mt_fe_dmd_set_CCI_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_ON_OFF is_cci_on);
MT_FE_RET _mt_fe_dmd_check_CCI_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_LOCK_STATE *p_state);
MT_FE_RET _mt_fe_dmd_set_clock_ratio_dm6k_ss2(MT_FE_DM6K_Device_Handle handle);
MT_FE_RET _mt_fe_dmd_set_sym_rate_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 sym_rate_KSs);
...
MT_FE_RET _mt_fe_dmd_get_total_carrier_offset_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, S32 *carrier_offset_KHz);
...
MT_FE_RET _mt_fe_dmd_set_mclk_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 MCLK_KHz);
MT_FE_RET _mt_fe_dmd_set_ts_divide_ratio_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_TYPE type, U8 dr_high, U8 dr_low);
MT_FE_RET _mt_fe_dmd_get_current_ts_mode_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U8 *p_ts_mode);

#if 0
/* function pointer */
S32 (*mt_fe_tn_get_offset)(MT_FE_DM6K_Device_Handle handle);
MT_FE_RET (*mt_fe_tn_set_tuner)(MT_FE_DM6K_Device_Handle handle, U32 freq_KHz, U32 sym_rate_KSs, S16 lpf_offset_KHz);
MT_FE_RET (*mt_fe_tn_cal_offset)(MT_FE_DM6K_Device_Handle handle, U32 freqKHz, U32 *realfreqKHz);
MT_FE_RET (*mt_fe_tn_sleep)(MT_FE_DM6K_Device_Handle handle);
MT_FE_RET (*mt_fe_tn_wake_up)(MT_FE_DM6K_Device_Handle handle);
MT_FE_RET (*mt_fe_tn_get_gain)(MT_FE_DM6K_Device_Handle handle, U32 *p_gain);

#endif

/* function for blind scan*/
MT_FE_RET _mt_fe_dmd_bs_set_reg_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U8 bs_times);
MT_FE_RET _mt_fe_dmd_bs_set_demod_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 sym_rate_KSs, MT_FE_TYPE type);
MT_FE_RET _mt_fe_dmd_bs_remove_unlocked_TP_dm6k_ss2(MT_FE_BS_TP_INFO *p_bs_info, U32 compare_freq_KHz);
MT_FE_RET _mt_fe_dmd_bs_process_scanned_TP_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_BS_TP_INFO *p_bs_info,
													   U32 cur_scan_freq_KHz,
													   U8  bs_times);
MT_FE_RET _mt_fe_dmd_bs_save_scanned_TP_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_BS_TP_INFO *p_bs_info,
													U32 freq_KHz,
													U32 symbol_rate_KSs,
													U8  bs_times);
MT_FE_RET _mt_fe_dmd_bs_TP_scan_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 start_freq_KHz,
									 U32 end_freq_KHz,
									 MT_FE_BS_TP_INFO *p_bs_info,
									 U16 *scanned_tp,
									 U8 bs_times);
MT_FE_RET _mt_fe_dmd_bs_A_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 start_freq_KHz,
							   U32 end_freq_KHz,
							   MT_FE_BS_TP_INFO *p_bs_info,
							   U8 bs_times);
MT_FE_RET _mt_fe_dmd_bs_B_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 start_freq_KHz,
							   U32 end_freq_KHz,
							   MT_FE_BS_TP_INFO *p_bs_info,
							   U8 bs_times);
...
MT_FE_RET mt_fe_unicable_set_tuner_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 freq_KHz, U32 symbol_rate_KSs, U32* real_freq_KHz, U8 ub_select, U8 bank_select, U32 ub_freq_MHz);
MT_FE_RET mt_fe_dmd_get_channel_info_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_CHAN_INFO_DVBS2 *p_info);


void mt_fe_dummy_function_dm6k_ss2(MT_FE_MSG msg, void* p_param)
{
	UNUSED_PARAMETER(msg);
	UNUSED_PARAMETER(p_param);
}

static void (*mt_fe_bs_notify)(MT_FE_MSG msg, void *p_tp_info) = mt_fe_dummy_function_dm6k_ss2;
...
{
	return _mt_fe_dm6k_get_reg(handle->m_device_ss2.demod_dev_addr, reg_addr, p_data);
}

MT_FE_RET _mt_fe_dmd_set_reg_ss2(MT_FE_DM6K_Device_Handle handle, U8 reg_addr, U8 reg_data)
{
	return _mt_fe_dm6k_set_reg(handle->m_device_ss2.demod_dev_addr, reg_addr, reg_data);
}
...
MT_FE_RET _mt_fe_tn_get_reg_ss2(MT_FE_DM6K_Device_Handle handle, U8 reg_addr, U8 *p_data)
{
	...
	return _mt_fe_dm6k_get_reg(handle->m_device_ss2.tuner_cfg.tuner_dev_addr, reg_addr, p_data);
}
...
MT_FE_RET _mt_fe_tn_set_reg_ss2(MT_FE_DM6K_Device_Handle handle, U8 reg_addr, U8 reg_data)
{
	...
	return _mt_fe_dm6k_set_reg(handle->m_device_ss2.tuner_cfg.tuner_dev_addr, reg_addr, reg_data);
}
...
MT_FE_RET _mt_fe_tn_write_ss2(MT_FE_DM6K_Device_Handle handle, U8 *p_buf, U16 n_byte)
{
	...
	return _mt_fe_dmd_write_dm6k(handle->m_device_ss2.tuner_cfg.tuner_dev_addr, p_buf, n_byte);
}
...
U8	g_dev_addr_dm6k_ss2			 = 0x42;				// For DS3103B

extern U8 g_dmd_i2c_addr;
...
MT_FE_RET mt_fe_dmd_ss2_config_default(MT_FE_DM6K_Device_Handle handle)
{
	...
	handle_ss2->ts_out_mode = MtFeTsOutMode_Serial;
	...
	handle_ss2->global_cfg.bCheckCCI		 = FALSE;
	handle_ss2->global_cfg.bEqCoefChecked	 = FALSE;
	handle_ss2->global_cfg.iAutoTuneCnt		 = 0;
...
/************************************************************************
** Function: mt_fe_dmd_get_driver_version_dm6k_ss2
**
**
...
/************************************************************************
** Function: mt_fe_dmd_soft_reset_dm6k_ss2
**
**
...
MT_FE_RET mt_fe_dmd_soft_reset_dm6k_ss2(MT_FE_DM6K_Device_Handle handle)
{
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0xb2, 0x01);
	_mt_fe_dmd_set_reg_ss2(handle, 0x00, 0x01);
	_mt_sleep_dm6k(1);
	_mt_fe_dmd_set_reg_ss2(handle, 0x00, 0x00);
	_mt_fe_dmd_set_reg_ss2(handle, 0xb2, 0x00);

	return MtFeErr_Ok;
}

MT_FE_RET mt_fe_dmd_global_reset_dm6k_ss2(MT_FE_DM6K_Device_Handle handle)
{
	U8 data = 0;

	_mt_fe_dm6k_get_reg(handle->sys_dev_addr, 0x03, &data);
	data = (U8)(data |0x08);
	_mt_fe_dm6k_set_reg(handle->sys_dev_addr, 0x03, data);
	data = (U8)(data & 0xf7);
	_mt_fe_dm6k_set_reg(handle->sys_dev_addr, 0x03, data);
...
MT_FE_RET mt_fe_dmd_get_demod_id_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_DMD_ID *dmd_id)
{
	U8 val_00 = 0, val_01 = 0, val_02 = 0, val_b2 = 0;

	*dmd_id = MtFeDmdId_Undef;

	_mt_fe_dmd_get_reg_ss2(handle, 0x00, &val_00);
	_mt_fe_dmd_get_reg_ss2(handle, 0x01, &val_01);
	_mt_fe_dmd_get_reg_ss2(handle, 0x02, &val_02);
	_mt_fe_dmd_get_reg_ss2(handle, 0xb2, &val_b2);
...
/* Tscancode: duplicate branches for 'if' and 'else'. */
	...
	//{
		//*dmd_id = MtFeDmdId_DS3103B;
		//mt_fe_print(("\tChip ID = [DS3103B]!\n"));
	//}
	else
	{
		*dmd_id = MtFeDmdId_DS3103B;
	...
	if(*dmd_id == MtFeDmdId_DS3103B)
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0x29, &val_00);

		g_dev_addr_dm6k_ss2 = (U8)(((val_00 & 0x80) == 0) ? 0x42 : 0x40);
	}
...
/******************************************************************
** Function: mt_fe_dmd_hard_reset_dm6k_ss2
**
**
...
**
*******************************************************************/
MT_FE_RET mt_fe_dmd_hard_reset_dm6k_ss2(MT_FE_DM6K_Device_Handle handle)
{
	...
	*/
...
#if MT_FE_DMD_I2C_ADDR_AUTO_DETECT
	for(g_dmd_i2c_addr = 0xD0; g_dmd_i2c_addr <= 0xD6; g_dmd_i2c_addr += 2)
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0x00, &val);

		if(((val & 0xFE) == 0xE0) || ((val & 0xFE) == 0xE8))
		{
			mt_fe_print(("\tCheck OK! Demod address = 0x%02X\n", g_dmd_i2c_addr));
			break;
		}
	}
	...
	if(((val & 0xFE) != 0xE0) && ((val & 0xFE) != 0xE8))
	{
		g_dmd_i2c_addr = MT_FE_DMD_I2C_ADDR_DS3K;
		mt_fe_print(("\tCheck failed! Select default demod address = 0x%02X\n", g_dmd_i2c_addr));
		return ret;
	}
#endif

	mt_fe_dmd_get_demod_id_dm6k_ss2(handle, &g_dmd_id);

	#if (MT_FE_CHECK_CARRIER_OFFSET != 0)

	_mt_fe_dmd_get_reg_ss2(handle, 0xb2, &val_regb2);
	if(val_regb2 == 0x01)
	{
		_mt_fe_dmd_set_reg_ss2(handle, 0x00, 0x00);
		_mt_fe_dmd_set_reg_ss2(handle, 0xb2, 0x00);
	...
	mt_fe_dmd_global_reset_dm6k_ss2(handle);

	_mt_sleep_dm6k(1);

	_mt_fe_dmd_get_reg_ss2(handle, 0x08, &val);
	val |= 0x01;
	_mt_fe_dmd_set_reg_ss2(handle, 0x08, val);
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x11, &val);
	val |= 0x01;
	_mt_fe_dmd_set_reg_ss2(handle, 0x11, val);

	return ret;
}


MT_FE_RET mt_fe_dmd_set_high_Z_state_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_BOOL high_Z_output)
{
	U8 val = 0;

	_mt_fe_dmd_get_reg_ss2(handle, 0x29, &val);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x29, val);

	return MtFeErr_Ok;
}

MT_FE_RET _mt_fe_dmd_set_demod_mode_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_TYPE type)
{
	MT_FE_RET ret = MtFeErr_Ok;
	U8 data = 0;
	...
	switch(type)
	{
		case MtFeType_DVBS2:
			...
			_mt_fe_dm6k_get_reg(handle->sys_dev_addr, 0x04, &data);
			data = (U8)((data & 0xfb)|0x08);
			_mt_fe_dm6k_set_reg(handle->sys_dev_addr, 0x04, data);

			_mt_fe_dm6k_get_reg(handle->sys_dev_addr, 0x07, &data);
			data = (U8)(data |0x02);
			_mt_fe_dm6k_set_reg(handle->sys_dev_addr, 0x07, data);
...
/******************************************************************************
** Function: mt_fe_dmd_init_dm6k_ss2
**
**
** Description:  This function is used to initial DS3103B/DS3103/DS3002B/DS300X.
...
MT_FE_RET mt_fe_dmd_init_dm6k_ss2(MT_FE_DM6K_Device_Handle handle)
{
	...
	iq_inverted_status = handle->m_device_ss2.board_cfg.bIQInverted;

	_mt_fe_dmd_set_demod_mode_dm6k_ss2(handle, g_current_type);

	mt_fe_dmd_hard_reset_dm6k_ss2(handle);
	...
	spectrum_inverted = (U8)(iq_inverted_status ^ handle->m_device_ss2.lnb_cfg.bUnicable);		// XOR


	_mt_fe_dmd_download_fw_dm6k_ss2(handle, m88dm6kss2_fm);


	_mt_fe_dmd_set_ts_out_mode_dm6k_ss2(handle, handle->m_device_ss2.ts_out_mode);
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x10, &val);
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x25, &val);
	val |= 0x08;
	_mt_fe_dmd_set_reg_ss2(handle, 0x25, val);
#endif
	if(spectrum_inverted == 1)			// 0x4d, bit 1
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0x4d, &val);
		val |= 0x02;
		_mt_fe_dmd_set_reg_ss2(handle, 0x4d, val);
	}
	else
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0x4d, &val);
	...
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0x30, &val);
		val |= 0x10;
		_mt_fe_dmd_set_reg_ss2(handle, 0x30, val);
	}
	else
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0x30, &val);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0xf1, 0x01);
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x9d, &val);
	val |= 0x08;
	_mt_fe_dmd_set_reg_ss2(handle, 0x9d, val);
...
/************************************************************************
** Function: mt_fe_dmd_change_ts_out_mode_dm6k_ss2
**
**
...
**
*************************************************************************/
MT_FE_RET mt_fe_dmd_change_ts_out_mode_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_TS_OUT_MODE mode)
{
	...
	U32 locked_sym_rate = 0;

	U32 target_mclk = MT_FE_MCLK_KHZ, cur_mclk = MT_FE_MCLK_KHZ;



	_mt_fe_dmd_get_reg_ss2(handle, 0xfd, &tmp);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0xfd, tmp);


	//mt_fe_dmd_get_lock_state_dm6k_ss2(&lockstate);
	if(g_current_type == MtFeType_DVBS2)
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0x0d, &tmp);
		if ((tmp & 0x8f) == 0x8f)
		{
	...
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0xd1, &tmp);
	...
	_mt_fe_dmd_get_mclk_dm6k_ss2(handle, &cur_mclk);
	...
	if((mode == MtFeTsOutMode_Parallel) || (mode == MtFeTsOutMode_Common))
	{
		if(g_current_type == MtFeType_DVBS2)
		{
			...
			{
				_mt_fe_dmd_get_sym_rate_dm6k_ss2(handle, &locked_sym_rate);

				if(locked_sym_rate > 28000)
				{
					target_mclk = 192000;//144000;
				}
	...
	{
		_mt_fe_dmd_set_reg_ss2(handle, 0x06, 0xe0);
		_mt_fe_dmd_set_mclk_dm6k_ss2(handle, target_mclk);
		_mt_fe_dmd_set_reg_ss2(handle, 0x06, 0x00);
	}
	...
	{	// Locked && (Parallel mode || CI mode)
		...
		if(lockstate == MtFeLockState_Locked)
		{
			_mt_fe_dmd_set_clock_ratio_dm6k_ss2(handle);
		}
		#else
		if(g_current_type == MtFeType_DVBS2)
		{
		...
		_mt_fe_dmd_set_ts_divide_ratio_dm6k_ss2(handle, g_current_type, tmp3, tmp4);
		#endif
	}
	else	// Serial
	{
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x29, &tmp);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x29, tmp);


	//mt_fe_dmd_soft_reset_dm6k_ss2(handle);
...
/************************************************************************
** Function: mt_fe_dmd_sleep_dm6k_ss2
**
**
...
**
*************************************************************************/
MT_FE_RET mt_fe_dmd_sleep_dm6k_ss2(MT_FE_DM6K_Device_Handle handle)
{
	U8 val = 0;
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x04, &val);
	val |= 0x01;
	_mt_fe_dmd_set_reg_ss2(handle, 0x04, val);

	_mt_fe_dmd_get_reg_ss2(handle, 0x23, &val);
	val |= 0x10;
	_mt_fe_dmd_set_reg_ss2(handle, 0x23, val);
...
/************************************************************************
** Function: mt_fe_dmd_wake_up_dm6k_ss2
**
**
...
**
*************************************************************************/
MT_FE_RET mt_fe_dmd_wake_up_dm6k_ss2(MT_FE_DM6K_Device_Handle handle)
{
	U8 val = 0;
...
/**********************************************************************************************
** Function: mt_fe_dmd_connect_dm6k_ss2
**
**
...
MT_FE_RET mt_fe_dmd_connect_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 freq_MHz, U32 sym_rate_KSs, MT_FE_TYPE dvbs_type)
{
	...
	if (dvbs_type == MtFeType_DTV_Unknown)
		g_current_type = MtFeType_DVBS;
	else
	...
	{
		mt_fe_i2c_repeat_enable_dm6k(handle);
		mt_fe_unicable_set_tuner_dm6k_ss2(handle, freq_tmp_KHz, sym_rate_KSs, &real_freq_KHz,
	...
	/*set demod registers*/
	_mt_fe_dmd_set_demod_dm6k_ss2(handle, sym_rate_KSs, g_current_type);
	...
	_mt_fe_dmd_set_carrier_offset_dm6k_ss2(handle, tuner_offset_KHZ+ lpf_offset_KHz + deviceoffset_KHz);
	//_mt_fe_dmd_set_carrier_offset_dm6k_ss2(handle, lpf_offset_KHz + deviceoffset_KHz);
...
/******************************************************************
** Function: mt_fe_dmd_get_lock_state_dm6k_ss2
**
**
** Description:	This function is called by app level to get the
**			lock status of DS3103B/DS3103/DS3002B/DS300X.
**
**
** Inputs:   None
**
...
**		Parameter	Type				Description
**		-----------------------------------------------------------
**		p_state		MT_FE_LOCK_STATE*	lock status of DS3103B/DS3103/DS3002B/DS300X
**
**
*******************************************************************/
MT_FE_RET mt_fe_dmd_get_lock_state_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_LOCK_STATE *p_state)
{
	...
	*p_state = MtFeLockState_Waiting;
	...
	if(g_cci_detect == 1)
	{
		_mt_fe_dmd_check_CCI_dm6k_ss2(handle, p_state);
	...
	if (g_current_type == MtFeType_DVBS2)
	{
		...
		_mt_fe_dmd_get_reg_ss2(handle, 0x76, &tmp);
		if(((tmp & 0x40) == 0) && (g_eq_coef_check == 0))		// 21 taps and first time
		{
			_mt_fe_dmd_get_reg_ss2(handle, 0xb3, &tmp);
			if((tmp & 0x3f) >= 0x21)
			{
				_mt_fe_dmd_get_reg_ss2(handle, 0x7e, &tmp);
				if((tmp & 0x20) == 0)	// pilot off
				{
					...
					for(i = 0; i < 21; i ++)
					{
						_mt_fe_dmd_set_reg_ss2(handle, 0x7A, (U8)(i << 2));
						_mt_fe_dmd_get_reg_ss2(handle, 0x7A, &tmp);
						bit01_00 = (U8)(tmp & 0x03);
						_mt_fe_dmd_get_reg_ss2(handle, 0x7B, &tmp);
						bit09_02 = (U16)(tmp << 2);
						bit09_00 = (U16)(bit09_02 | bit01_00);
						real = (S32)bit09_00;
						if(real >= 512)
						{
							real -= 1024;
						...
						_mt_fe_dmd_set_reg_ss2(handle, 0x7A, (U8)((i + 21) << 2));
						_mt_fe_dmd_get_reg_ss2(handle, 0x7A, &tmp);
						bit01_00 = (U8)(tmp & 0x03);
						_mt_fe_dmd_get_reg_ss2(handle, 0x7B, &tmp);
						bit09_02 = (U16)(tmp << 2);
					...
					{
						_mt_fe_dmd_set_reg_ss2(handle, 0xbd, 0x03);
	...
	if (*p_state == MtFeLockState_Locked)
	{
		...
		_mt_fe_dmd_get_total_carrier_offset_dm6k_ss2(handle, &carrier_offset_KHz);
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0xb3, &tmp);
	if(g_connect_type != MtFeType_DTV_Unknown)
	{
		if ((tmp & 0xc0) != 0)
		{
			*p_state = MtFeLockState_Unlocked;
	...
	else
	{
		...
		if((tmp & 0x40) == 0x40)
		{
			if(g_auto_tune_cnt < 1)
			{
				...
				_mt_fe_dmd_set_carrier_offset_dm6k_ss2(handle, g_carrier_offset);
				...
				_mt_fe_dmd_set_demod_dm6k_ss2(handle, g_connect_sym_rate, g_current_type);
...
/*********************************************************************
** Function: mt_fe_dmd_get_per_dm6k_ss2
**
**
...
MT_FE_RET mt_fe_dmd_get_per_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 *p_total_packags, U32 *p_err_packags)
{
	...
	*p_total_packags = pre_total_packags;
	...
	if (g_current_type == MtFeType_DVBS2)
	{
		mt_fe_dmd_get_channel_info_dm6k_ss2(handle, &p_info);
		...
		_mt_fe_dmd_get_reg_ss2(handle, 0xdb, &tmp1);
		_mt_fe_dmd_get_reg_ss2(handle, 0xda, &tmp2);
		_mt_fe_dmd_get_reg_ss2(handle, 0xd9, &tmp3);
		ldpc_frame_cnt = (tmp1 << 16) | (tmp2 << 8) | tmp3;


		_mt_fe_dmd_get_reg_ss2(handle, 0xf8, &tmp1);
		_mt_fe_dmd_get_reg_ss2(handle, 0xf7, &tmp2);
		...
		{
			_mt_fe_dmd_get_reg_ss2(handle, 0xd0, &tmp1);
			tmp1 = (U8)(tmp1 | 0x08);
			_mt_fe_dmd_set_reg_ss2(handle, 0xd0, tmp1);
			_mt_fe_dmd_set_reg_ss2(handle, 0xf9, 0x01);
			_mt_fe_dmd_set_reg_ss2(handle, 0xf9, 0x00);
	...
	{
		_mt_fe_dmd_set_reg_ss2(handle, 0xf9, 0x04);
		_mt_fe_dmd_get_reg_ss2(handle, 0xf8, &val_0xF8);

		if((val_0xF8&0x10) == 0)
		{
			_mt_fe_dmd_get_reg_ss2(handle, 0xf6, &val_0xF6);
			_mt_fe_dmd_get_reg_ss2(handle, 0xf7, &val_0xF7);

			pre_err_packags = (val_0xF7 << 8) | val_0xF6;

			val_0xF8 |= 0x10;
			_mt_fe_dmd_set_reg_ss2(handle, 0xf8, val_0xF8);
		}
...
/******************************************************************
** Function: mt_fe_dmd_get_snr_dm6k_ss2
**
**
...
MT_FE_RET mt_fe_dmd_get_snr_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, S8 *p_snr)
{
	...
	*p_snr = 0;
	if (g_current_type == MtFeType_DVBS2)
	{
		...
		while(cnt > 0)
		{
			_mt_fe_dmd_get_reg_ss2(handle, 0x8c, &npow1);
			_mt_fe_dmd_get_reg_ss2(handle, 0x8d, &npow2);
			npow += (((npow1 & 0x3F) + (U16)(npow2 << 6)) >> 2);

			_mt_fe_dmd_get_reg_ss2(handle, 0x8e, &spow1);
			spow += ((spow1 * spow1) >> 1);
	...
	else
	{
		...
		while(cnt > 0)
		{
			_mt_fe_dmd_get_reg_ss2(handle, 0xff, &val);
			snr_total += val;
...
/******************************************************************
** Function: mt_fe_dmd_get_strength_dm6k_ss2
**
**
...
MT_FE_RET mt_fe_dmd_get_sat_quality_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U8 *p_percent)
{
	...
	mt_fe_dmd_get_pure_lock_dm6k_ss2(handle, &lock_state);
	...
	else
	{
		...
		_mt_fe_dmd_set_reg_ss2(handle, 0x63, 0x4f);

		for(cnt = 0; cnt < 3; cnt ++)
		{
			_mt_fe_dmd_get_reg_ss2(handle, 0x8f, &val);
...
/******************************************************************
** Function: mt_fe_dmd_get_channel_info_dm6k_ss2
**
**
...
MT_FE_RET mt_fe_dmd_get_channel_info_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_CHAN_INFO_DVBS2 *p_info)
{
	...
	if(g_current_type == MtFeType_DVBS2)
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0x7e, &val_0x7E);
		...
		_mt_fe_dmd_get_reg_ss2(handle, 0x89, &tmp);
		p_info->is_spectrum_inv = ((tmp & 0x80) != 0) ? MtFeSpectrum_Inversion : MtFeSpectrum_Normal;


		_mt_fe_dmd_get_reg_ss2(handle, 0xf2, &tmp);
		tmp	&= 0x03;
		switch(tmp)
		{
	...
	else
	{
		...
		_mt_fe_dmd_get_reg_ss2(handle, 0xe6, &tmp);
		tmp = (U8)(tmp >> 5);
		switch(tmp)
		{
		...
		_mt_fe_dmd_get_reg_ss2(handle, 0xe0, &tmp);
...
/*********************************************************************************
** Function: mt_fe_dmd_set_LNB_dm6k_ss2
**
**
...
MT_FE_RET  mt_fe_dmd_set_LNB_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_BOOL is_LNB_enable, MT_FE_BOOL is_22k_enable, MT_FE_LNB_VOLTAGE voltage_type, MT_FE_BOOL is_envelop_mode)
{
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0xa1, &val_0xa1);
	_mt_fe_dmd_get_reg_ss2(handle, 0xa2, &val_0xa2);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0xa2, val_0xa2);
	_mt_fe_dmd_set_reg_ss2(handle, 0xa1, val_0xa1);
...
/*************************************************************************************
** Function: mt_fe_dmd_DiSEqC_send_tone_burst_dm6k_ss2
**
**
...
MT_FE_RET  mt_fe_dmd_DiSEqC_send_tone_burst_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_DiSEqC_TONE_BURST mode, MT_FE_BOOL is_envelop_mode)
{
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0xa2, &val);
	val &= ~0xc0;
	if(is_envelop_mode != MtFe_True)
	{
		val &= ~0x20;
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0xa2, val);


	if (mode == MtFeDiSEqCToneBurst_Moulated)
		_mt_fe_dmd_set_reg_ss2(handle, 0xa1, 0x01);
	else
		_mt_fe_dmd_set_reg_ss2(handle, 0xa1, 0x02);
	...
	do
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0xa1, &val);
		if ((val & 0x40) == 0)
			break;
...
/*****************************************************************************
** Function: mt_fe_dmd_DiSEqC_send_receive_msg_dm6k_ss2
**
**
...
MT_FE_RET mt_fe_dmd_DiSEqC_send_receive_msg_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_DiSEqC_MSG *msg)
{
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0xa2, &tmp);
	tmp &= ~0xc0;
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0xa2, tmp);


	for (i = 0; i < msg->size_send; i ++)
	{
		_mt_fe_dmd_set_reg_ss2(handle, (U8)(0xa3 + i), msg->data_send[i]);
	}

	_mt_fe_dmd_get_reg_ss2(handle, 0xa1, &tmp);
	tmp &= ~0x38;
	tmp &= ~0x40;
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0xa1, tmp);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0xa1, 0x40);

	for (i = 0; i < msg->size_receive; i ++)
	{
		_mt_fe_dmd_get_reg_ss2(handle, (U8)(0xa3 + i), &(msg->data_receive[i]));
	}



	/*	Indicates the parity error occurs	*/
	_mt_fe_dmd_get_reg_ss2(handle, 0xab, &tmp);
...
/**********************************************************************
** Function: mt_fe_blindscan_abort_dm6k_ss2
**
**
...
/*********************************************************************************
** Function: mt_fe_dmd_register_blindscan_callback_dm6k_ss2
**
**
...
/******************************************************************************************
** Function: mt_fe_dmd_blindscan_dm6k_ss2
**
**
...
{
	U8 times = 0;
	U32 begin_freq_KHz = 0, end_freq_KHz = 0;
	...
	for(times = MT_FE_BS_TIMES_1ST; times < (p_bs_info->bs_times); times++)
	{
		...
		{
			_mt_fe_dmd_bs_A_dm6k_ss2(handle, begin_freq_KHz, end_freq_KHz, p_bs_info, times);
		}
		else if(p_bs_info->bs_algorithm == MT_FE_BS_ALGORITHM_B)
		{
			_mt_fe_dmd_bs_B_dm6k_ss2(handle, begin_freq_KHz, end_freq_KHz, p_bs_info, times);
		}
		else
		{
	...
	_mt_fe_dmd_bs_remove_unlocked_TP_dm6k_ss2(p_bs_info, (U32)FREQ_MAX_KHz);
...
MT_FE_RET _mt_fe_dmd_get_mclk_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 *p_MCLK_KHz)
{
	...
	_mt_fe_sys_get_reg(handle, 0x10, &reg10);
	_mt_fe_sys_get_reg(handle, 0x0F, &reg0F);
	_mt_fe_sys_get_reg(handle, 0x0E, &reg0E);
...
/******************************************************************
** Function: _mt_fe_dmd_set_mclk_dm6k_ss2
**
**
...
MT_FE_RET _mt_fe_dmd_set_mclk_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 MCLK_KHz)
{
	...
	{
		case 192000:
			_mt_fe_sys_set_reg(handle, 0x10, 0x24);
			_mt_fe_sys_set_reg(handle, 0x0f, 0x09);
			_mt_fe_sys_set_reg(handle, 0x0e, 0x90);
			break;

		case 144000:
			_mt_fe_sys_set_reg(handle, 0x10, 0x24);
			_mt_fe_sys_set_reg(handle, 0x0F, 0x0C);
			_mt_fe_sys_set_reg(handle, 0x0E, 0xC0);
			break;

		case 115200:
			_mt_fe_sys_set_reg(handle, 0x10, 0x26);
			_mt_fe_sys_set_reg(handle, 0x0F, 0x0A);
			_mt_fe_sys_set_reg(handle, 0x0E, 0xAA);
			break;

		case 72000:
			_mt_fe_sys_set_reg(handle, 0x10, 0x27);
			_mt_fe_sys_set_reg(handle, 0x0F, 0xCC);
			_mt_fe_sys_set_reg(handle, 0x0E, 0xCC);
			break;

		case 96000:
		default:
			_mt_fe_sys_set_reg(handle, 0x10, 0x27);
			_mt_fe_sys_set_reg(handle, 0x0F, 0x99);
			_mt_fe_sys_set_reg(handle, 0x0E, 0x99);
			break;
	}
...
/******************************************************************
** Function: _mt_fe_dmd_set_ts_divide_ratio_dm6k_ss2
**
**
...
/* Tscancode: duplicate branches for 'if' and 'else'. */
	//if(type == MtFeType_DVBS2)
	{
		...
		//_mt_fe_dmd_set_reg_ss2(handle, 0xfe, 0x20);	// default value

		_mt_fe_dmd_get_reg_ss2(handle, 0xfe, &val);		// ci_divrange_h_1 bits[5:2]
		val &= 0xF0;						// bits[3:0]
		val |= (tmp1 >> 2) & 0x0f;
		_mt_fe_dmd_set_reg_ss2(handle, 0xfe, val);

		val = (U8)((tmp1 & 0x03) << 6);		// ci_divrange_h_0 bits[1:0]
		val |= tmp2;						// ci_divrange_l   bits[5:0]
		_mt_fe_dmd_set_reg_ss2(handle, 0xea, val);
	}
/*	else	// DVB-S
	{
		tmp1 -= 1;
...
/******************************************************************
** Function: _mt_fe_dmd_set_clock_ratio_dm6k_ss2
**
**
...
MT_FE_RET _mt_fe_dmd_set_clock_ratio_dm6k_ss2(MT_FE_DM6K_Device_Handle handle)
{
	U8	mod_fac = 0, tmp1 = 0, tmp2 = 0, val = 0;
	U32	input_datarate = 0, locked_sym_rate_KSs = 0;
	U32 MClk_KHz = 96000;
	U16 divid_ratio = 0;
	MT_FE_CHAN_INFO_DVBS2 p_info;
	...
	_mt_fe_dmd_get_sym_rate_dm6k_ss2(handle, &locked_sym_rate_KSs);
	...
	_mt_fe_dmd_get_current_ts_mode_dm6k_ss2(handle, &ts_mode);
	...
	if (g_current_type == MtFeType_DVBS2)			// for dvb-s2
	{
		...
		_mt_fe_dmd_get_mclk_dm6k_ss2(handle, &MClk_KHz);
		...
		if(ts_mode == MtFeTsOutMode_Serial)
		{
			...
			_mt_fe_dmd_get_mclk_dm6k_ss2(handle, &g_serial_mclk);

			if(g_serial_mclk > 116000)
			{
				_mt_fe_sys_set_reg(handle, 0x17, 0x70);
			}
			else
			{
				_mt_fe_sys_set_reg(handle, 0x17, 0x40);
			}
	...
	_mt_fe_dmd_set_ts_divide_ratio_dm6k_ss2(handle, g_current_type, tmp1, tmp2);
...
/******************************************************************
** Function: _mt_fe_dmd_set_ts_out_mode_dm6k_ss2
**
**
...
MT_FE_RET _mt_fe_dmd_set_ts_out_mode_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_TS_OUT_MODE mode)
{
	U8	tmp = 0, tmp1 = 0, tmp2 = 0, val_0x08 = 0, val = 0;


	_mt_fe_dmd_get_reg_ss2(handle, 0x08, &val_0x08);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x08, tmp);

	_mt_fe_dmd_set_demod_mode_dm6k_ss2(handle, MtFeType_DVBS);
	...
	_mt_fe_dmd_set_ts_divide_ratio_dm6k_ss2(handle, MtFeType_DVBS, tmp1, tmp2);
	...
	_mt_fe_dmd_set_demod_mode_dm6k_ss2(handle, MtFeType_DVBS2);
	...
	_mt_fe_dmd_set_ts_divide_ratio_dm6k_ss2(handle, MtFeType_DVBS2, tmp1, tmp2);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x08, val_0x08);
	...
	else
	{
		...
		_mt_fe_dm6k_set_reg(handle->sys_dev_addr, 0x06, 0x02);
		_mt_fe_dm6k_set_reg(handle->sys_dev_addr, 0x08, 0x11);

		_mt_fe_sys_set_reg(handle, 0x17, tmp);
	}
	_mt_fe_dmd_set_reg_ss2(handle, 0x20, val);
...
/*****************************************************************
** Function: _mt_fe_dmd_set_CCI_dm6k_ss2
**
**
...
MT_FE_RET  _mt_fe_dmd_set_CCI_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_ON_OFF is_cci_on)
{
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x56, &tmp);
	if (is_cci_on == MtFe_On)
		tmp &= ~0x01;
	else
		tmp |= 0x01;
	_mt_fe_dmd_set_reg_ss2(handle, 0x56, tmp);
...
/*****************************************************************
** Function: _mt_fe_dmd_check_CCI_dm6k_ss2
**
**
...
MT_FE_RET  _mt_fe_dmd_check_CCI_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_LOCK_STATE *p_state)
{
	U8 i = 0, cnt = 0, reg_0xb3 = 0, reg_0x59 = 0, CCI_on_flag_cnt = 0;
	S8 val_cci = 0;

	cnt = 0;

	_mt_fe_dmd_get_reg_ss2(handle, 0xb3, &reg_0xb3);
	...
	for(i = 0; i < 15; i++)
	{
		_mt_fe_dmd_get_reg_ss2(handle, 0x59, &reg_0x59);
		val_cci = (S8)reg_0x59;
	...
	if (CCI_on_flag_cnt < 10)
		_mt_fe_dmd_set_CCI_dm6k_ss2(handle, MtFe_Off);
...
/*****************************************************************************
** Function: _mt_fe_dmd_set_demod_dm6k_ss2
**
**
...
{
	MT_FE_RET	ret = MtFeErr_Ok;
	U8			val = 0, tmp = 0, tmp1 = 0, tmp2 = 0;
	U8			ts_mode = 0;// = MT_FE_TS_OUTPUT_MODE;
	...
	if (type == MtFeType_DVBS2)
	{
		...
		ret = _mt_fe_dmd_init_reg_dm6k_ss2(handle, reg_tbl_dvbs2_def_dm6k_ss2, sizeof(reg_tbl_dvbs2_def_dm6k_ss2)/2);
		...
		if(handle->m_device_ss2.board_cfg.bAGCPolar)
		{
			_mt_fe_dmd_get_reg_ss2(handle, 0x30, &val);
			val |= 0x10;
			_mt_fe_dmd_set_reg_ss2(handle, 0x30, val);
		...
		{
			_mt_fe_dmd_set_reg_ss2(handle, 0xc0, 0x04);
			_mt_fe_dmd_set_reg_ss2(handle, 0x8a, 0x09);
			_mt_fe_dmd_set_reg_ss2(handle, 0x8b, 0x22);
			_mt_fe_dmd_set_reg_ss2(handle, 0x8c, 0x88);
		}
	}
	else		// DVB-S
	{
		...
		ret = _mt_fe_dmd_init_reg_dm6k_ss2(handle, reg_tbl_dvbs_def_dm6k_ss2, sizeof(reg_tbl_dvbs_def_dm6k_ss2)/2);
	...
	if(ts_clk != 0)
	{
		divide_ratio = (U16)((target_mclk + ts_clk - 1) / ts_clk);
	...
	_mt_fe_dmd_set_ts_divide_ratio_dm6k_ss2(handle, type, tmp1, tmp2);
	_mt_fe_dmd_set_mclk_dm6k_ss2(handle, target_mclk);


	_mt_fe_dmd_get_reg_ss2(handle, 0xfd, &val);
	_mt_fe_dmd_get_reg_ss2(handle, 0xca, &tmp);
	tmp &= 0xFE;
	tmp |= (val >> 3) & 0x01;
	_mt_fe_dmd_set_reg_ss2(handle, 0xca, tmp);


#if 1//MT_FE_TN_SUPPORT_TS2022
	_mt_fe_dmd_set_reg_ss2(handle, 0x33, 0x99);
#else
	_mt_fe_dmd_set_reg_ss2(handle, 0x33, 0x35);
#endif

	_mt_fe_dmd_get_reg_ss2(handle, 0xC9, &tmp);
	tmp |= 0x08;
	_mt_fe_dmd_set_reg_ss2(handle, 0xC9, tmp);

	if(sym_rate_KSs <= 3000)
	{
		_mt_fe_dmd_set_reg_ss2(handle, 0xc3, 0x08); // 8 * 32 * 100 / 64 = 400
		_mt_fe_dmd_set_reg_ss2(handle, 0xc8, 0x20);
		_mt_fe_dmd_set_reg_ss2(handle, 0xc4, 0x08); // 8 * 0 * 100 / 128 = 0
		_mt_fe_dmd_set_reg_ss2(handle, 0xc7, 0x00);
	}
	else if(sym_rate_KSs <= 10000)
	{
		_mt_fe_dmd_set_reg_ss2(handle, 0xc3, 0x08); // 8 * 16 * 100 / 64 = 200
		_mt_fe_dmd_set_reg_ss2(handle, 0xc8, 0x10);
		_mt_fe_dmd_set_reg_ss2(handle, 0xc4, 0x08); // 8 * 0 * 100 / 128 = 0
		_mt_fe_dmd_set_reg_ss2(handle, 0xc7, 0x00);
	}
	else
	{
		_mt_fe_dmd_set_reg_ss2(handle, 0xc3, 0x08); // 8 * 6 * 100 / 64 = 75
		_mt_fe_dmd_set_reg_ss2(handle, 0xc8, 0x06);
		_mt_fe_dmd_set_reg_ss2(handle, 0xc4, 0x08); // 8 * 0 * 100 / 128 = 0
		_mt_fe_dmd_set_reg_ss2(handle, 0xc7, 0x00);
	}

	_mt_fe_dmd_set_sym_rate_dm6k_ss2(handle, sym_rate_KSs);

	_mt_fe_dmd_set_CCI_dm6k_ss2(handle, MtFe_On);
	_mt_fe_dmd_get_reg_ss2(handle, 0x76, &val);
	val &= ~0x80;
	_mt_fe_dmd_set_reg_ss2(handle, 0x76, val);
...
/*****************************************************************************
** Function: _mt_fe_dmd_set_sym_rate_dm6k_ss2
**
**
...
MT_FE_RET  _mt_fe_dmd_set_sym_rate_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 sym_rate_KSs)
{
	...
	tmp = (U32)(((sym_rate_KSs << 15) + (g_mclk_khz_dm6k_ss2 / 4)) / (g_mclk_khz_dm6k_ss2 / 2));

	reg_0x61 = (U8)(tmp & 0x00FF);
	reg_0x62 = (U8)((tmp & 0xFF00) >> 8);

	_mt_fe_dmd_set_reg_ss2(handle, 0x61, reg_0x61);
	_mt_fe_dmd_set_reg_ss2(handle, 0x62, reg_0x62);
...
/*****************************************************************************
** Function: _mt_fe_dmd_get_sym_rate_dm6k_ss2
**
**
 ...
 MT_FE_RET _mt_fe_dmd_get_sym_rate_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 *sym_rate_KSs)
{
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x6d, &val_0x6d);
	_mt_fe_dmd_get_reg_ss2(handle, 0x6e, &val_0x6e);

	tmp = (U16)((val_0x6e<<8) | val_0x6d);


	sym_rate_tmp = (U32)(tmp * g_mclk_khz_dm6k_ss2);
...
/*************************************************************************
** Function:  _mt_fe_dmd_set_carrier_offset_dm6k_ss2
**
**
...
MT_FE_RET _mt_fe_dmd_set_carrier_offset_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, S32 carrier_offset_KHz)
{
	...
	tmp = (S32)((2 * tmp + g_mclk_khz_dm6k_ss2) / (2 * g_mclk_khz_dm6k_ss2));

	if(tmp < 0)
		tmp += 65536;


	_mt_fe_dmd_set_reg_ss2(handle, 0x5f, (U8)(tmp >> 8));
	_mt_fe_dmd_set_reg_ss2(handle, 0x5e, (U8)(tmp & 0xFF));
...
/***********************************************************************
** Function: _mt_fe_dmd_get_carrier_offset_dm6k_ss2
**
**
...
MT_FE_RET _mt_fe_dmd_get_carrier_offset_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, S32 *carrier_offset_KHz)
{
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x5d, &tmp);
	tmp &= 0xf8;
	_mt_fe_dmd_set_reg_ss2(handle, 0x5d, tmp);

	_mt_fe_dmd_get_reg_ss2(handle, 0x5e, &val_0x5e);
	_mt_fe_dmd_get_reg_ss2(handle, 0x5f, &val_0x5f);
	...
	*carrier_offset_KHz = (S32)((val * g_mclk_khz_dm6k_ss2) / (1<<16));
...
/***********************************************************************
** Function: _mt_fe_dmd_get_total_carrier_offset_dm6k_ss2
**
**
...
MT_FE_RET _mt_fe_dmd_get_total_carrier_offset_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, S32 *carrier_offset_KHz)
{
	...
	*carrier_offset_KHz = (nval_1 - nval_2) * g_mclk_khz_dm6k_ss2 / (1 << 16);
...
/*************************************************************************
** Function:  _mt_fe_dmd_get_fec_dm6k_ss2
**
**
...
/*****************************************************************************
** Function: _mt_fe_dmd_get_current_ts_mode_dm6k_ss2
**
**
...
MT_FE_RET _mt_fe_dmd_get_current_ts_mode_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U8 *p_ts_mode)
{
	...
	*p_ts_mode = MtFeTsOutMode_Common;
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0xfd, &val_0xfd);
...
/**********************************************************************
** Function: _mt_fe_dmd_init_reg_dm6k_ss2
**
**
** Description:	initialize the register of DS3103B/DS3103/DS3002B/DS300X
**
**
** Inputs:
*
...
MT_FE_RET _mt_fe_dmd_init_reg_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, const U8 (*p_reg_tabl)[2], S32 size)
{
	...
	{
		ret = _mt_fe_dmd_set_reg_ss2(handle, p_reg_tabl[i][0], p_reg_tabl[i][1]);
...
/*******************************************************************
** Function: _mt_fe_dmd_download_fw_dm6k_ss2
**
**
** Description:	download the mcu code to DS3103B/DS3103/DS3002B/DS300X
**
**
** Inputs:
**
...
MT_FE_RET _mt_fe_dmd_download_fw_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, const U8* p_fw)
{
	...
	if (handle->m_device_ss2.mcu_status != 0x01)
	{
		_mt_fe_dmd_set_reg_ss2(handle, 0xb2, 0x01);

		for(i = 0; i < 128; i++)
		{
			ret = _mt_fe_dmd_write_fw_dm6k(handle->m_device_ss2.demod_dev_addr, 0xb0, (U8*)&(p_fw[64*i]), 64);
			if (ret != MtFeErr_Ok)
			{
				break;
			}
...
/*************************************************************************
** Function: _mt_fe_dmd_bs_set_reg_dm6k_ss2
**
**
** Description:	set blind scan registers
**
...
MT_FE_RET _mt_fe_dmd_bs_set_reg_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U8 bs_times)
{
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x4A, 0x00);


	_mt_fe_dmd_get_reg_ss2(handle, 0x4D, &tmp);
	tmp |= 0x91;
	_mt_fe_dmd_set_reg_ss2(handle, 0x4D, tmp);


	_mt_fe_dmd_get_reg_ss2(handle, 0x90, &tmp);
	tmp |= TMP1;
	_mt_fe_dmd_set_reg_ss2(handle, 0x90, tmp);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x91, tmp);

	tmp = (U8)(TMP3 + sm_buf - 1);
	_mt_fe_dmd_set_reg_ss2(handle, 0x92, tmp);


	_mt_fe_dmd_get_reg_ss2(handle, 0x93, &tmp);
	tmp &= 0x0F;
	tmp |= TMP4;
	_mt_fe_dmd_set_reg_ss2(handle, 0x93, tmp);



	_mt_fe_dmd_get_reg_ss2(handle, 0x94, &tmp);
	switch(bs_times)
	{
		case MT_FE_BS_TIMES_1ST:
			if(g_bs_time_total == 1)
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x94, tmp);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x95, tmp);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x97, tmp);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x99, tmp);

	_mt_fe_dmd_set_reg_ss2(handle, 0x30, (U8)((handle->m_device_ss2.board_cfg.bAGCPolar) ? 0x18 : 0x08));


	_mt_fe_dmd_set_reg_ss2(handle, 0x32, 0x44);
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x35, 0x7F);

	_mt_fe_dmd_set_reg_ss2(handle, 0x4B, 0x04);
	_mt_fe_dmd_set_reg_ss2(handle, 0x56, 0x01);
	_mt_fe_dmd_set_reg_ss2(handle, 0xA0, 0x44);
	_mt_fe_dmd_set_reg_ss2(handle, 0x08, 0x83);


	_mt_fe_dmd_set_reg_ss2(handle, 0x70, 0x00);
...
/*****************************************************************************
** Function: _mt_fe_dmd_bs_set_demod_dm6k_ss2
**
**
...
MT_FE_RET _mt_fe_dmd_bs_set_demod_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 sym_rate_KSs, MT_FE_TYPE type)
{
	U8			tmp1 = 0, tmp2 = 0, val = 0, tmp = 0;
	MT_FE_RET	ret = MtFeErr_Ok;
	U8			ts_mode = MtFeTsOutMode_Common;
	U32			target_mclk = MT_FE_MCLK_KHZ;
	U32			ts_clk = 24000;
	U16			divide_ratio = 0;
	...
	if(type == MtFeType_DVBS2)
	{
		...
		ret = _mt_fe_dmd_init_reg_dm6k_ss2(handle, reg_tbl_dvbs2_def_blindscan_dm6k_ss2, sizeof(reg_tbl_dvbs2_def_blindscan_dm6k_ss2)/2);

		//_mt_fe_dmd_set_reg_ss2(handle, 0xc6, 0x40);
	...
	else
	{
		...
		ret = _mt_fe_dmd_init_reg_dm6k_ss2(handle, reg_tbl_dvbs_def_blindscan_dm6k_ss2, sizeof(reg_tbl_dvbs_def_blindscan_dm6k_ss2)/2);
	...
	{
		_mt_fe_dmd_set_reg_ss2(handle, 0xc3, 0x08);
		_mt_fe_dmd_set_reg_ss2(handle, 0xc8, 0x00);
		_mt_fe_dmd_set_reg_ss2(handle, 0xc4, 0x04);
		_mt_fe_dmd_set_reg_ss2(handle, 0xc7, 0x1b);
	}
	else if(sym_rate_KSs <= 5000)
	{
		...
		_mt_fe_dmd_set_reg_ss2(handle, 0xc8, 0x00);
		_mt_fe_dmd_set_reg_ss2(handle, 0xc4, 0x04);
		_mt_fe_dmd_set_reg_ss2(handle, 0xc7, 0x0b);
	}
	/* Tscancode: duplicate branches for 'if' and 'else'. */
	//else if(sym_rate_KSs <= 20000)
	//{
		//_mt_fe_dmd_set_reg_ss2(handle, 0xc3, 0x08);
		//_mt_fe_dmd_set_reg_ss2(handle, 0xc8, 0x02);
		//_mt_fe_dmd_set_reg_ss2(handle, 0xc4, 0x04);
		//_mt_fe_dmd_set_reg_ss2(handle, 0xc7, 0x16);
	//}
	else
	{
		_mt_fe_dmd_set_reg_ss2(handle, 0xc3, 0x08);
...
/******************************************************************************************
** Function: _mt_fe_dmd_bs_save_scanned_TP_dm6k_ss2
**
**
											...
											U8  bs_times)
{
	...
	if((bs_times == MT_FE_BS_TIMES_1ST)||(g_bs_time_total == 1))
	{
		...
		tmp[g_scanned_tp_cnt-1].dvb_type		= MtFeType_DTV_Unknown;
...
/********************************************************************************************
** Function: _mt_fe_dmd_bs_remove_unlocked_TP_dm6k_ss2
**
**
...
/********************************************************************************************
** Function: _mt_fe_dmd_bs_compare_deal_TP_dm6k_ss2
**
**
...
**
********************************************************************************************/
MT_FE_RET _mt_fe_dmd_bs_compare_deal_TP_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, MT_FE_BS_TP_INFO *p_bs_info,
											U32 cur_scan_freq_KHz,
											U8  bs_times)
{
	MT_FE_RET	ret = MtFeErr_Ok;

	U8  tmp1 = 0, tmp2 = 0, tmp3 = 0, tmp4 = 0, covered_ratio = 0;
	U16	i = 0, last_check_index = 0;
	U32	centerfreqKHz_tpA = 0, symrateKSs_tpA = 0;
	U32	centerfreqKHz_tpB = 0, symrateKSs_tpB = 0;
	U32 left_boundary = 0, right_boundary = 0;
	S32 s_value = 0, delta_freq_KHz = 0, delta_symbol_rate_KSs = 0, freq_delta_KHz = 0;
	S32 similar_symbol_rate_KSs = 0, freq_offset_tmp = 0, symrate_offset_tmp = 0;
	...
	_mt_fe_dmd_set_reg_ss2(handle, 0x9A, 0x20);
	_mt_fe_dmd_get_reg_ss2(handle, 0x9B, &tmp1);
	_mt_fe_dmd_get_reg_ss2(handle, 0x9B, &tmp2);
	_mt_fe_dmd_get_reg_ss2(handle, 0x9B, &tmp3);
	_mt_fe_dmd_get_reg_ss2(handle, 0x9B, &tmp4);


	symrateKSs_tpB = (U32)((((tmp4 & 0x03) << 8) | tmp3) * g_mclk_khz_dm6k_ss2 / FFT_LENGTH);

	s_value = (S32)(((tmp2&0x03)<<8) | tmp1);
	if(s_value >= FFT_LENGTH)
		s_value -= 1024;

	centerfreqKHz_tpB = (U32)(cur_scan_freq_KHz + s_value * (g_mclk_khz_dm6k_ss2 / FFT_LENGTH));
	...
	{
		g_scanned_tp_cnt++;
		ret = _mt_fe_dmd_bs_save_scanned_TP_dm6k_ss2(handle, p_bs_info, centerfreqKHz_tpB, symrateKSs_tpB, bs_times);
		if(ret != MtFeErr_Ok)
			return ret;
...
/********************************************************************************************
** Function: _mt_fe_dmd_bs_process_scanned_TP_dm6k_ss2
**
**
												...
												U8  bs_times)
{
	...
	for(i = 0; i < 2; i++)
	{
		...
		_mt_fe_dmd_set_reg_ss2(handle, 0x9a, 0x80);

		cnt = 50;
		do
		{
			_mt_fe_dmd_get_reg_ss2(handle, 0x9a, &tmp);
		...
		{
			_mt_fe_dmd_set_reg_ss2(handle, 0x5f, 0x00);
			_mt_fe_dmd_set_reg_ss2(handle, 0x5e, 0x70);
		}
	}
	...
	{
		totaltpnum--;
		_mt_fe_dmd_bs_compare_deal_TP_dm6k_ss2(handle, p_bs_info, cur_scan_freq_KHz, bs_times);
	}


	if(bs_times == MT_FE_BS_TIMES_3RD)
	{
		//_mt_fe_dmd_bs_remove_unlocked_TP_dm6k_ss2(p_bs_info, g_cur_compare_TPA_KHz);
...
/******************************************************************************************
** Function: _mt_fe_dmd_bs_A_dm6k_ss2
**
**
...
MT_FE_RET _mt_fe_dmd_bs_A_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 start_freq_KHz,
							  ...
							  U8 bs_times)
{
	U8	val_0x95 = 0, val_0x96 = 0, end_flag = 0, TP_found_flag = 0;
	U32 freq_KHz = 0, tmp_freq_KHz = 0, tmp_tp_scanned = 0;
	MT_FE_RET	ret = MtFeErr_Ok;
	...
	{
		_mt_fe_dmd_bs_set_reg_dm6k_ss2(handle, bs_times);
		if(handle->m_device_ss2.lnb_cfg.bUnicable)
		{
			mt_fe_i2c_repeat_enable_dm6k(handle);
			mt_fe_unicable_set_tuner_dm6k_ss2(handle, freq_KHz, BLINDSCAN_SYMRATEKSs, &real_freq_KHz, handle->m_device_ss2.lnb_cfg.iUBIndex, handle->m_device_ss2.lnb_cfg.iBankIndex, handle->m_device_ss2.lnb_cfg.iUBFreqMHz);
		...
		_mt_fe_dmd_set_carrier_offset_dm6k_ss2(handle, tuner_offset_KHZ);
		...
		ret = _mt_fe_dmd_bs_process_scanned_TP_dm6k_ss2(handle, p_bs_info, freq_KHz, bs_times);
		if(ret != MtFeErr_Ok)
			return ret;

		_mt_fe_dmd_get_reg_ss2(handle, 0x95, &val_0x95);
		_mt_fe_dmd_get_reg_ss2(handle, 0x96, &val_0x96);

		tmp_freq_KHz = (U32)((((((val_0x95&0xc0)>>6) << 8) | val_0x96) * g_mclk_khz_dm6k_ss2) / FFT_LENGTH);
		...
		#if 1//(MT_FE_TN_SUPPORT_ST6110 || MT_FE_TN_SUPPORT_TS2022)
		if(tmp_freq_KHz == 0)
		{
			freq_KHz += 36000;
		}
		...
		if(tmp_tp_scanned < g_scanned_tp_cnt)
		{
			...
			_mt_fe_dmd_bs_connect_dm6k_ss2(handle, p_bs_info, 0, g_scanned_tp_cnt);
		}
...
/******************************************************************************************
** Function: _mt_fe_dmd_bs_B_dm6k_ss2
**
**
** Description:	scan the TP from the start_freq_KHz to end_freq_KHz
**
...
/************************************************************************************
** Function: _mt_fe_dmd_bs_connect_dm6k_ss2
**
**
									...
									U16 scanned_tp)
{
	...
	U8		j = 0, count = 0, timing_fail = 0, crl_fail, tmp = 0, same_locked_TP_flag = 0;
	...
	for(index = start_index; index < scanned_tp; index++)
	{
		...
		if ((sym_rate_KSs < 5000) && (handle->m_device_ss2.lnb_cfg.bUnicable == 0))
		{
		...
		for(j = 0; j < 2; j++)
		{
			...
			if(g_current_type!= handle->m_device_ss2.demod_current_type)
			{
				_mt_fe_dmd_set_demod_mode_dm6k_ss2(handle,g_current_type);
			}
			...
			{
				mt_fe_i2c_repeat_enable_dm6k(handle);
				ret = mt_fe_unicable_set_tuner_dm6k_ss2(handle, centerfreq_KHz,
			...
			_mt_fe_dmd_bs_set_demod_dm6k_ss2(handle, sym_rate_KSs, current_mode);
...
#if 1//((MT_FE_TN_SUPPORT_TS2022 != 0) || (MT_FE_TN_SUPPORT_AV2011 != 0) || (MT_FE_TN_SUPPORT_AV2026 != 0))
			if (handle->m_device_ss2.tuner_cfg.tuner_get_gain != NULL)
			{
				mt_fe_i2c_repeat_enable_dm6k(handle);
			...
			if(sym_rate_KSs >= 3000)
			{
				p_bs_info->iCurGain = gain_val;
			}

			mt_fe_print(("\tgain = %d, Freq = %d, SymRate = %d\n", gain_val, centerfreq_KHz, sym_rate_KSs));

			if((gain_val > 8800) && sym_rate_KSs >= 2500)
			{
				lockstate = MtFeLockState_Unlocked;			// Treat the TP as unlock

				p_scanned_tp_info[index].dvb_type = MtFeType_DTV_Checked;

				mt_fe_print(("\tDiscard!!! Gain > 8800, Symbol Rate = %dKSs\n", sym_rate_KSs));
				break;
			}

			if(!p_bs_info->bNewGain)
			{
				U32 gain_thr = 0;
				...
				gain_thr = 1400;
				#elif ((MT_FE_TN_SUPPORT_AV2011 != 0) || (MT_FE_TN_SUPPORT_AV2026 != 0))
				gain_thr = 2200;
				#endif
			...
			_mt_fe_dmd_check_CCI_dm6k_ss2(handle, &lockstate);
			...
			while((count > 0)&&(!g_blindscan_cancel))
			{
				...
				if(lockstate == MtFeLockState_Locked)
				{
					...
					_mt_fe_dmd_get_reg_ss2(handle, 0x0c, &reg_0x0c);
					if(((reg_0x0c & 0x04) == 0x00) && (!handle->m_device_ss2.lnb_cfg.bUnicable))
					{
						// AFC on
						_mt_fe_dmd_get_total_carrier_offset_dm6k_ss2(handle, &carrier_offset);
						if((carrier_offset > ((S32)sym_rate_KSs)) || (carrier_offset < -((S32)sym_rate_KSs)))
						{
							...
							_mt_fe_dmd_get_reg_ss2(handle, 0x0c, &reg_0x0c);
							reg_0x0c |= 0x04;
							_mt_fe_dmd_set_reg_ss2(handle, 0x0c, reg_0x0c);
							if (handle->m_device_ss2.tuner_cfg.tuner_get_offset != NULL)
							{
								mt_fe_i2c_repeat_enable_dm6k(handle);
								handle->m_device_ss2.tuner_cfg.tuner_get_offset(handle, &tuner_offset_KHZ);
			...
			if(lockstate == MtFeLockState_Locked)
			{
				_mt_fe_dmd_get_carrier_offset_dm6k_ss2(handle, &carrieroffset_KHz);
				if (handle->m_device_ss2.tuner_cfg.tuner_get_offset != NULL)
				{
					mt_fe_i2c_repeat_enable_dm6k(handle);
					handle->m_device_ss2.tuner_cfg.tuner_get_offset(handle, &tuner_offset_KHZ);
				...
				_mt_fe_dmd_get_sym_rate_dm6k_ss2(handle, &sym_rate_KSs);
				...
				_mt_fe_dmd_get_fec_dm6k_ss2(handle, &(p_bs_info->p_tp_info[index]), current_mode);
...
MT_FE_RET _mt_fe_dmd_get_CCI_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, S32 *pCCIFreq, S32 *pCCIAmp)
{
	U32	bit07_00 = 0;
	U32	bit15_08 = 0;
	U32	bit15_00 = 0;
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x5C, &val);
	bit07_00 = val;

	_mt_fe_dmd_get_reg_ss2(handle, 0x5B, &val);
	bit15_08 = val;
	...
	*pCCIFreq = x;
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x5A, &val);
	bit07_00 = val;

	_mt_fe_dmd_get_reg_ss2(handle, 0x59, &val);
	bit15_08 = val;
...
#if 0
MT_FE_BOOL mt_fe_unicable_scan_UB_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U32 startFreq, U32 *result_freq, S32 *pCCIAmp, U32 *pCCIGain)	// Unit: KHz
{
	U8 i = 0, cnt, reg_0xb3 = 0, reg_0x59 = 0, CCI_on_flag_cnt = 0;
	S8 val_cci = 0;
	...
	S32 CCIFreq = 0, CCIAmp = 0,tuner_offset_KHZ = 0;

	S32 MaxFreq = 0, MinFreq = 0;
	S32 MaxAmp = 0, MinAmp = 0;
	...
	*pCCIGain = 0;
	...
	//mt_fe_tn_set_tuner(handle, startFreq, 40000, 0);
	if(handle->m_device_ss2.tuner_cfg.tuner_set != NULL)
	{
		mt_fe_i2c_repeat_enable_dm6k(handle);
		handle->m_device_ss2.tuner_cfg.tuner_set(handle, startFreq, 40000, 0);
		mt_fe_i2c_repeat_disable_dm6k(handle);
	}
	...
	_mt_fe_dmd_init_reg_dm6k_ss2(handle, cci_detect_reg_tbl_def_dm6k_ss2, sizeof(cci_detect_reg_tbl_def_dm6k_ss2)/2);
	...
	_mt_fe_dmd_set_sym_rate_dm6k_ss2(handle, 40000);
	...
	_mt_fe_dmd_get_reg_ss2(handle, 0x5D, &Readval);
	Readval = (U8)(Readval & 0xF8);
	_mt_fe_dmd_set_reg_ss2(handle, 0x5D, Readval);

	_mt_fe_dmd_get_reg_ss2(handle, 0x5F, &Readval);
	bit15_08 = Readval << 8;

	_mt_fe_dmd_get_reg_ss2(handle, 0x5E, &Readval);
	...
	fTotalFO = x / 65536.0 * g_mclk_khz_dm6k_ss2;


	_mt_fe_dmd_get_reg_ss2(handle, 0xC9, &Readval);
	...
	for(i = 0; i < 5; i ++)
	{
		_mt_fe_dmd_get_CCI_dm6k_ss2(handle, &CCIFreq, &CCIAmp);
	...
	*pCCIAmp = CCIAmp;
	...
	fCCIFreq = (CCIFreq / 65536.0 * g_mclk_khz_dm6k_ss2) / (1 << DeciMode) - fTotalFO;
	if (handle->m_device_ss2.tuner_cfg.tuner_get_offset != NULL)
	{
		mt_fe_i2c_repeat_enable_dm6k(handle);
		handle->m_device_ss2.tuner_cfg.tuner_get_offset(handle, &tuner_offset_KHZ);
	...
	//mt_fe_print(("\tCCI Offset = [%d], TN_Offset = [%d]\n", (S32)fCCIFreq, tuner_offset_KHZ));


	//#if 0
	//fCCIFreq += mt_fe_tn_get_offset(handle);
	//#else
	if(handle->m_device_ss2.tuner_cfg.tuner_get_offset != NULL)
	{
		mt_fe_i2c_repeat_enable_dm6k(handle);
	...
	fCCIFreq -= tuner_offset_KHZ;
	//#endif

	*result_freq = startFreq - (S32)fCCIFreq;

	mt_fe_print(("\tAmp=[%d],Freq=[%d],CciFo=[%d],TnFo=[%d],Result=[%d]\n", *pCCIAmp, startFreq, (S32)fCCIFreq, tuner_offset_KHZ, *result_freq));
	...
	*result_freq /= 1000;
	...
	{
		mt_fe_i2c_repeat_enable_dm6k(handle);
		handle->m_device_ss2.tuner_cfg.tuner_get_gain(handle, pCCIGain);
		mt_fe_i2c_repeat_disable_dm6k(handle);
	}
...
MT_FE_BOOL _mt_fe_dmd_unicable_check_result_duplicate_dm6k_ss2(MT_FE_UNICABLE_DEVICE *p_ub_list, U16 count, U32 target_freq_MHz)
{
	U16 i = 0;
...
void mt_fe_dmd_unicable_blind_detect_dm6k_ss2(MT_FE_DM6K_Device_Handle handle, U16 start_freq_MHz, U16 stop_freq_MHz, MT_FE_UNICABLE_DEVICE *p_ub_list, MT_BOOL need_init)
{
	U16 cur_freq_MHz = 0;
	...
	if(need_init != FALSE)
	{
		...
		mt_fe_dmd_set_LNB_dm6k_ss2(handle, MtFe_True, MtFe_False, MtFeLNB_18V, MtFe_False);
		mt_fe_dmd_DiSEqC_send_receive_msg_dm6k_ss2(handle, &msg);
		_mt_sleep_dm6k(10);
	...
	for(cur_freq_MHz = start_freq_MHz + 15; cur_freq_MHz < stop_freq_MHz; cur_freq_MHz += 30)
	{
		...
		if(mt_fe_unicable_scan_UB_dm6k_ss2(handle, cur_freq_MHz * 1000, &CCI_result_MHz, &CCI_Amp, &CCI_Gain) == MtFe_True)
		{
			if(_mt_fe_dmd_unicable_check_result_duplicate_dm6k_ss2(p_ub_list, g_ub_count, CCI_result_MHz) == MtFe_False)
			{
				U32 Verify_MHz = 0;
				S32 Verify_Amp = 0;
				U32 Verify_Gain = 0;
				...
				if(mt_fe_unicable_scan_UB_dm6k_ss2(handle, (CCI_result_MHz + 5) * 1000, &Verify_MHz, &Verify_Amp, &Verify_Gain) == MtFe_True)
				{
