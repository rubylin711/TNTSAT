...
/******************************************************************************/
#ifndef _AUD_OUT_ARIA_REG_H
#define _AUD_OUT_ARIA_REG_H

/*!
  the enum of AUDOUT_ARIA registers
  */
enum
{
    REG_ARIA_AUD_CLK_ADJ              = 0x14,
    REG_ARIA_AUD_SAMP_FRM              = 0x90,
    REG_ARIA_AUD_INTR_SET              = 0xA0,
    REG_ARIA_AUD_FRM_INTR_CFG       = 0xD8,
    REG_ARIA_AUD_FRMINTR_CNT		= 0x130,
    REG_ARIA_AUD_FRM_CNT			= 0x140,
    REG_ARIA_AUD_FRM_CNT_2		= 0x144,
};

/*!
  the union of register reg_aria_aud_clk_adj
  */
typedef union reg_aria_aud_clk_adj
{
	mt_u32 all;
	struct
	{
...
} reg_aria_aud_clk_adj_t;

/*!
  the union of register reg_aria_aud_samp_frm
  */
typedef union reg_aria_aud_samp_frm
{
	mt_u32 all;
	struct
	{
...
} reg_aria_aud_samp_frm_t;

/*!
  the union of register reg_aria_aud_intr_set
  */
typedef union reg_aria_aud_intr_set
{
	mt_u32 all;
	struct
	{
...
} reg_aria_aud_intr_set_t;

/*!
  the union of register reg_aria_aud_frm_intr_cfg
  */
typedef union reg_aria_aud_frm_intr_cfg
{
    mt_u32 all;
    struct
    {
...
} reg_aria_aud_frm_intr_cfg_t;

/*!
  the union of register reg_aria_aud_frmintr_cnt
  */
typedef union reg_aria_aud_frmintr_cnt
{
    mt_u32 all;
    struct
    {
...
} reg_aria_aud_frmintr_cnt_t;

/*!
  the union of register reg_aria_aud_frm_cnt
  */
typedef union reg_aria_aud_frm_cnt
{
    mt_u32 all;
    struct
    {
...
} reg_aria_aud_frm_cnt_t;

/*!
  the union of register reg_aria_aud_frm_cnt
  */
typedef union reg_aria_aud_frm_cnt_2
{
    mt_u32 all;
    struct
    {
