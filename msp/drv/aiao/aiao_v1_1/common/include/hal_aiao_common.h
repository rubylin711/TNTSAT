...
#ifndef __MT_HAL_AIAO_COMMON_H__
#define __MT_HAL_AIAO_COMMON_H__
...
#if    defined(CMTP_TYPE_hi3716cv200)   \
    || defined(CMTP_TYPE_hi3716mv400)   \
    || defined(CMTP_TYPE_hi3718cv100)   \
    || defined(CMTP_TYPE_hi3719cv100)   \
    || defined(CMTP_TYPE_hi3718mv100)   \
    || defined(CMTP_TYPE_hi3719mv100)   \
    || defined(CMTP_TYPE_hi3719mv100_a) \
    || defined(CMTP_TYPE_hi3796cv100_a) || defined(CMTP_TYPE_hi3796cv100) || defined(CMTP_TYPE_hi3798cv100_a) || defined(CMTP_TYPE_hi3798cv100) \
    || defined(CMTP_TYPE_hi3751v100)\
    || defined(CMTP_TYPE_hi3798mv100_a)|| defined(CMTP_TYPE_hi3798mv100)
...
#elif defined (CMTP_TYPE_hi3716cv200es)   /* S40V200 asic */
#define AIAO_PLL_600MHZ 1
#else
#define AIAO_PLL_600MHZ 1//minnan
#endif
...
#define AIAO_TXINT0_BUF_TRANSFINISH_MASK (1 << ((mt_u32)AIAO_TXINT0_BUF_TRANSFINISH))
#define AIAO_TXINT1_BUF_EMPTY_MASK (1 << ((mt_u32)AIAO_TXINT1_BUF_EMPTY))
#define AIAO_TXINT2_BUF_AEMPTY_MASK (1 << ((mt_u32)AIAO_TXINT2_BUF_AEMPTY))
#define AIAO_TXINT3_BUF_FIFOEMPTY_MASK (1 << ((mt_u32)AIAO_TXINT3_BUF_FIFOEMPTY))
#define AIAO_TXINT4_IF_FIFOEMPTY_MASK (1 << ((mt_u32)AIAO_TXINT4_IF_FIFOEMPTY))
#define AIAO_TXINT5_STOP_DONE_MASK (1 << ((mt_u32)AIAO_TXINT5_STOP_DONE))
#define AIAO_TXINT6_MUTEFADE_DONE_MASK (1 << ((mt_u32)AIAO_TXINT6_MUTEFADE_DONE))
#define AIAO_TXINT7_DATA_BROKEN_MASK (1 << ((mt_u32)AIAO_TXINT7_DATA_BROKEN))
...
#define AIAO_RXINT0_BUF_TRANSFINISH_MASK (1 << ((mt_u32)AIAO_RXINT0_BUF_TRANSFINISH))
#define AIAO_RXINT1_BUF_FULL_MASK (1 << ((mt_u32)AIAO_RXINT1_BUF_FULL))
#define AIAO_RXINT2_BUF_AFULL_MASK (1 << ((mt_u32)AIAO_RXINT2_BUF_AFULL))
#define AIAO_RXINT3_BUF_FIFOFULL_MASK (1 << ((mt_u32)AIAO_RXINT3_BUF_FIFOFULL))
#define AIAO_RXINT4_IF_FIFOFULL_MASK (1 << ((mt_u32)AIAO_RXINT4_IF_FIFOFULL))
#define AIAO_RXINT5_STOP_DONE_MASK (1 << ((mt_u32)AIAO_RXINT5_STOP_DONE))
...
typedef enum
{
    ...
    AIAO_SAMPLE_RATE_64K  = 64000,
    AIAO_SAMPLE_RATE_88K  = 88200,
    AIAO_SAMPLE_RATE_96K  = 96000,
    AIAO_SAMPLE_RATE_128K = 128000,
...
typedef mt_void AIAO_IsrFunc (AIAO_PORT_ID_E enPortID, mt_u32 u32IntRawStatus,void *);//MT_ALSA_AI_SUPPORT
...
typedef mt_void AIAO_TimerIsrFunc (AIAO_TIMER_ID_E enTimerID);
#endif
...
typedef struct
{
    ...
    mt_u32 u32PeriodNumber;         /* 2/4/8 */
} AIAO_BufAttr_S;

typedef struct
{
    mt_u32 u32BUFF_SADDR;
    mt_u32 u32BUFF_SIZE;
    mt_u32 u32BUFF_WPTR;
    mt_u32 u32BUFF_RPTR;
    mt_u32 u32PeriodBufSize;
    mt_u32 u32ThresholdSize;
} AIAO_BufInfo_S;
...
typedef struct
{
    ...
    ulong  u32BufVirAddr;
    mt_u32 u32BufSize;           //pcm buf + pp buf
    mt_u32 u32bufszperch;        //for audio in: ppbuf one channel size: samplecntoneframe * 2 * 6
    mt_u32 u32samplecntoneframe; //for audio in:smaple cnt in one frame
    mt_u32 u32bitdepth;          //for audio in: framesize
...
typedef struct
{
    ...
    void *substream;  //only for alsa isr MT_ALSA_AI_SUPPORT
...
typedef struct
{
    ...
    mt_u32  u32BufPhyWptr;
    mt_u32  u32BufPhyRptr;
    mt_u32  u32BufVirAddr;
    mt_u32  u32BufVirWptr;
    mt_u32  u32BufVirRptr;
    mt_u32  u32BufSize;
} AIAO_RBUF_ATTR_S;
...
typedef struct
{
    /* Tx/RX */
    mt_u32 uDMACnt;
    mt_u32 uBusTimeOutCnt;        /* update at isr */

    /* Rx only */
    mt_u32 uTotalByteRead;
    mt_u32 uTryReadCnt;
    mt_u32 uBufFullCnt;            /* update at rx isr */
    mt_u32 uBufFullWarningCnt;     /* update at rx isr */
    mt_u32 uBusFiFoFullCnt;        /* update at rx isr */
    mt_u32 uInfFiFoFullCnt;        /* update at rx isr */

    /* tx only */
    mt_u32 uTotalByteWrite;
    mt_u32 uTryWriteCnt;
    mt_u32 uBufEmptyCnt;          /* update at tx isr */
    mt_u32 uBufEmptyWarningCnt;   /* update at tx isr */
    mt_u32 uBusFiFoEmptyCnt;      /* update at tx isr */
    mt_u32 uInfFiFoEmptyCnt;      /* update at tx isr */
    mt_u32 uInfEmptyCntReal;      /* update at tx isr */
} AIAO_PROC_STAUTS_S;
...
typedef mt_void AIAO_ISR (mt_void * handle, mt_u32 status);

//#define PORT2CMTD(x) (((mt_u32)(x)) & 0x0f)

static inline mt_u32 PORT2CMTD(AIAO_PORT_ID_E enPortID)
{
...
static inline mt_u32 AIAOFrameSize(AIAO_I2S_CHNUM_E enCh, AIAO_BITDEPTH_E enBitDepth)
{
    mt_u32 uFrameSize = 0;
    ...
    case AIAO_BIT_DEPTH_8:
        uFrameSize = ((mt_u32)enCh) * sizeof(mt_u8);
        break;
    case AIAO_BIT_DEPTH_16:
        uFrameSize = ((mt_u32)enCh) * sizeof(mt_u16);
        break;
    case AIAO_BIT_DEPTH_24:
        uFrameSize =  ((mt_u32)enCh) * sizeof(mt_u32);
        break;
    }
...
static inline mt_u32  PORT2ID(AIAO_PORT_ID_E enPortID)
{
    mt_u32 ChnId = PORT2CMTD(enPortID);

    if (!((mt_u32)enPortID & 0x30))
    {
        ChnId += (mt_u32)AIAO_RX_INT0;
    }
    else if (((mt_u32)enPortID & 0x10))
    {
        ChnId += (mt_u32)AIAO_TX_INT0;
    }
    else if (((mt_u32)enPortID & 0x20))
    {
        ChnId += (mt_u32)AIAO_SPDIFTX_INT0;
    }
    else
    {
        ChnId = 0;   /* avoid TQE */
...
static inline AIAO_PORT_ID_E  ID2PORT(mt_u32 ID)
{
    AIAO_PORT_ID_E     enPortID;

    if (ID<=AIAO_RX_INT7)
    {
        ID  -= (mt_u32)AIAO_RX_INT0;
        enPortID = (AIAO_PORT_ID_E)(ID);
    }
    else if (ID<=AIAO_TX_INT7 && ID>=AIAO_TX_INT0)
    {
        ID -= (mt_u32)AIAO_TX_INT0;
        ID += 0x10;
        enPortID = (AIAO_PORT_ID_E)(ID);
    }
#ifdef MT_AIAO_TIMER_SUPPORT
...
static inline mt_s32  PORT2DIR(AIAO_PORT_ID_E enPortID)
{
    if (0 == ((mt_u32)enPortID & 0x30))
    {
        return AIAO_DIR_RX;
    }
    else
...
static inline mt_s32  Port2IntStatus(AIAO_PORT_ID_E enPortID, mt_u32 IntStatus)
{
...
#ifdef MT_AIAO_TIMER_SUPPORT
static inline mt_u32 TIMER2CMTD(AIAO_TIMER_ID_E enTimerID)
{
...
static inline mt_u32  TIMER2ID(AIAO_TIMER_ID_E enTimerID)
{
    mt_u32 ChnId = TIMER2CMTD(enTimerID);
    //if ((enTimerID <=AIAO_TIMER_1)&&(enTimerID >=AIAO_TIMER_0))
    if (enTimerID <= AIAO_TIMER_1)
    {
        ChnId += (mt_u32)AIAO_TIMER_INT0;
    }
    else
    {
        ChnId = 0;   /* avoid TQE */
...
static inline AIAO_TIMER_ID_E  ID2TIMER(mt_u32 ID)
{
    AIAO_TIMER_ID_E enTimerID;
    if (ID <= AIAO_TIMER_INT1 && ID >= AIAO_TIMER_INT0)
    {
        ID -= (mt_u32)AIAO_TIMER_INT0;
...
static inline mt_s32  Timer2IntStatus(AIAO_TIMER_ID_E enTimerID, mt_u32 IntStatus)
{
    mt_u32 ID = TIMER2ID(enTimerID);
    return (IntStatus >> ID) & 0x01;
}
typedef struct mtAO_TIMER_Enable_S
{
    AIAO_TIMER_ID_E  enTimerID;
    MT_BOOL         bEnable;
} AIAO_TIMER_Enable_S;
typedef struct mtAO_TIMER_Status_S
{
    AIAO_TIMER_ID_E enTimerID;
    MT_BOOL         bEnable;
    mt_u32          u32IsrCnt;
...
typedef struct mtAIAO_Timer_Create_S
{
    mt_handle             handle;
    AIAO_TIMER_ID_E       enTimerID;
    AIAO_TimerIsrFunc    *pTimerIsrFunc;
} AIAO_Timer_Create_S;
typedef struct mtAIAO_Timer_Destroy_S
{
    AIAO_TIMER_ID_E       enTimerID;
} AIAO_Timer_Destroy_S;
#endif

typedef struct mtAIAO_Port_GetCapability_S
{
    mt_u32 u32Capability;
} AIAO_Port_GetCapability_S;

typedef struct mtAIAO_Port_Open_S
{
    AIAO_PORT_ID_E              enPortID;
    AIAO_PORT_USER_CFG_S *pstConfig;
} AIAO_Port_Open_S;

typedef struct mtAIAO_Port_Close_S
{
    AIAO_PORT_ID_E enPortID;
} AIAO_Port_Close_S;

typedef struct mtAIAO_Port_Start_S
{
    AIAO_PORT_ID_E enPortID;
} AIAO_Port_Start_S;

typedef struct mtAIAO_Port_SelectSpdifSource_S
{
    AIAO_PORT_ID_E       enPortID;
    AIAO_SPDIFPORT_SOURCE_E eSrcChnId;
} AIAO_Port_SelectSpdifSource_S;

typedef struct mtAIAO_Port_SetSpdifOutPort_S
{
    AIAO_PORT_ID_E       enPortID;
    mt_s32 bEn;
} AIAO_Port_SetSpdifOutPort_S;

typedef struct mtAIAO_Port_Stop_S
{
    AIAO_PORT_ID_E       enPortID;
...
typedef struct mtAIAO_Port_Mute_S
{
    AIAO_PORT_ID_E enPortID;
    MT_BOOL        bMute;
} AIAO_Port_Mute_S;

typedef struct mtAIAO_Port_Volume_S
{
    AIAO_PORT_ID_E enPortID;
    mt_u32         u32VolumedB;
} AIAO_Port_Volume_S;

typedef struct mtAIAO_Port_TrackMode_S
{
    AIAO_PORT_ID_E    enPortID;
    AIAO_TRACK_MODE_E enTrackMode;
} AIAO_Port_TrackMode_S;

typedef struct mtAIAO_Port_GetUserConfig_S
{
    AIAO_PORT_ID_E       enPortID;
    AIAO_PORT_USER_CFG_S stUserConfig;
} AIAO_Port_GetUserConfig_S;

typedef struct mtAIAO_Port_GetSTATUS_S
{
    AIAO_PORT_ID_E     enPortID;
    AIAO_PORT_STAUTS_S stStatus;
} AIAO_Port_GetSTATUS_S;

typedef struct mtAIAO_Port_ReadData_S
{
    AIAO_PORT_ID_E enPortID;
    mt_u8 *        pu32Dest;
    mt_u32         u32DestSize;
...
typedef struct mtAIAO_Port_WriteData_S
{
    AIAO_PORT_ID_E enPortID;
    mt_u8 *        pu32Src;
    mt_u32         u32SrcLen;
    mt_u32         u32WriteBytes;
} AIAO_Port_WriteData_S;

typedef struct mtAIAO_Port_BufStatus_S
{
    AIAO_PORT_ID_E enPortID;
    mt_u32         u32DataSize;
    mt_u32         u32FreeSize;
...
typedef struct mtAIAO_Dbg_Reg_S
{
    mt_s32 isRead;
    mt_u32 u32RegAddrBase;
    mt_u32 u32RegAddrOffSet;
    mt_u32 u32RegValue;
} AIAO_Dbg_Reg_S;

typedef struct mtAIAO_I2SDataSel_S
{
    AIAO_I2S_SD_E     enSD0;
    AIAO_I2S_SD_E     enSD1;
    AIAO_I2S_SD_E     enSD2;
...
typedef struct mtAIAO_Port_I2SDataSel_S
{
    AIAO_PORT_ID_E     enPortID;
...
typedef struct 
{
    mt_u32 u32InitFlag; /* bit0: rx, bit1: tx */   //MT_BOOL u32InitFlag;  
...
typedef struct
{
    ...
    CIRC_BUF_S         stCB;
    AIAO_BufInfo_S     stBuf;
    mt_s32             bStopFadeOutMute;
    mt_char            szProcMmzName[16];
} AIAO_PORT_CTX_S, *AIAO_PORT_S;

#endif  // __MT_HAL_AIAO_COMMON_H__
