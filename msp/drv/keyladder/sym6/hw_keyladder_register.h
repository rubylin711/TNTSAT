...
#define KEYLADDER_REG_SIGNATURE_KEYSRC                       (handle->base_address + 0xb8)
#define KEYLADDER_REG_SIGNATURE_KEYSRC_LOCK                  (handle->base_address + 0xbc)
#define KEYLADDER_REG_UPDATE_MODE                           (handle->base_address + 0xF4)
...
typedef enum {
	...
	KL_CMD_MOVE_SRC_SM4_DOUT		 = (0x3 << KL_RAM_CMD_SRC_SHIFT),
...
typedef enum {
	...
	KL_CMD_MOVE_DST_SM4_KEY          = (0xc << KL_RAM_CMD_DST_SHIFT),
	KL_CMD_MOVE_DST_SM4_DIN 		 = (0xd << KL_RAM_CMD_DST_SHIFT),
...
typedef enum {
	...
	KL_CMD_RESTORE_SRC_SM4_DOUT		 = (0x16 << KL_RAM_CMD_SRC_SHIFT)
...
typedef enum {
	...
	KL_CMD_EXPORT_SRC_SM4_DOUT		= (0x1e << KL_RAM_CMD_SRC_SHIFT),
