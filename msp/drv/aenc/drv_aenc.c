...
static mt_device_s g_sAencDevice;
...
/* Register AENC Dev                                                         */
static HI_S32 AENCRegisterDevice(struct file_operations *drvFops, baseops_s *drvops)
{
...
*****************************************************************************/
static int aenc_pm_suspend(basedev_s *pdev, pm_message_t state)
{
    int ret;
...
/*****************************************************************************
 ...
 Called By    :
  ...
  1.Date         : 2010/5/15
    ...
    Modification : Created function
*****************************************************************************/
static int aenc_pm_resume(basedev_s *pdev)
{
#if 0
