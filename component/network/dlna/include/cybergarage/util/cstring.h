...
MT_BOOL cg_streq(char *str1, char *str2);
MT_BOOL cg_strcaseeq(char *str1, char *str2);
...
MT_BOOL cg_string_tokenizer_hasmoretoken(CgStringTokenizer *strToken);
