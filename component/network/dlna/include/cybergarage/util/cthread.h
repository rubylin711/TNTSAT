...
/* instead of joining */
#else
#define CG_THREAD_MIN_SLEEP 100
 ...
 */
MT_BOOL cg_thread_delete(CgThread *thread);
 ...
 */
MT_BOOL cg_thread_start(CgThread *thread);
 ...
 */
MT_BOOL cg_thread_stop(CgThread *thread);

/**
 * Stop the running thread and signal the given CGCond.
 */
MT_BOOL cg_thread_stop_with_cond(CgThread *thread, CgCond *cond);
 ...
 */
MT_BOOL cg_thread_restart(CgThread *thread);
 ...
 */
MT_BOOL cg_thread_isrunnable(CgThread *thread);
 ...
 * \param threadList The thread list in question
 */
MT_BOOL cg_threadlist_start(CgThreadList *threadList);
 ...
 * \param threadList The thread list in question
 */
MT_BOOL cg_threadlist_stop(CgThreadList *threadList);
