...
MT_BOOL cg_http_packet_read_body(
							  CgHttpPacket *httpPkt, CgSocket *sock, char *lineBuf, int lineBufSize);
MT_BOOL cg_http_packet_read(CgHttpPacket *httpPkt, CgSocket *sock, MT_BOOL onlyHeader, char *lineBuf, int lineBufSize);
...
#endif
MT_BOOL cg_http_request_read(CgHttpRequest *httpReq, CgSocket *sock);
MT_BOOL cg_http_request_postresponse(CgHttpRequest *httpReq, CgHttpResponse *httpRes);
MT_BOOL cg_http_request_poststatuscode(CgHttpRequest *httpReq, int httpStatCode);
MT_BOOL cg_http_request_postdata(CgHttpRequest *httpReq, void *data, int dataLen);
MT_BOOL cg_http_request_postchunkedsize(CgHttpRequest *httpReq, int dataLen);
MT_BOOL cg_http_request_postchunkeddata(CgHttpRequest *httpReq, void *data, int dataLen);
MT_BOOL cg_http_request_postlastchunk(CgHttpRequest *httpReq);
...
MT_BOOL cg_http_response_read(CgHttpResponse *httpRes, CgSocket *sock, MT_BOOL onlyHeader);
...
MT_BOOL cg_http_server_open(CgHttpServer *httpServer, int bindPort, char *bindAddr);
MT_BOOL cg_http_server_close(CgHttpServer *httpServer);
MT_BOOL cg_http_server_accept(CgHttpServer *httpServer);
MT_BOOL cg_http_server_start(CgHttpServer *httpServer);
MT_BOOL cg_http_server_stop(CgHttpServer *httpServer);
...
MT_BOOL cg_http_serverlist_open(CgHttpServerList *httpServerList, int port);
MT_BOOL cg_http_serverlist_close(CgHttpServerList *httpServerList);
MT_BOOL cg_http_serverlist_start(CgHttpServerList *httpServerList);
MT_BOOL cg_http_serverlist_stop(CgHttpServerList *httpServerList);
...
MT_BOOL cg_http_persistentconnection_init(void);
...
MT_BOOL cg_http_persistentconnection_put(char *host, int port, void *data);
