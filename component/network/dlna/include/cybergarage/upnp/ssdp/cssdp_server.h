...
MT_BOOL cg_upnp_httpmu_socket_bind(CgUpnpHttpMuSocket *sock, char *mcastAddr, int port, char *bindAddr);
...
MT_BOOL cg_upnp_ssdp_packet_isrootdevice(CgUpnpSSDPPacket *ssdpPkt);
...
MT_BOOL cg_upnp_ssdp_server_open(CgUpnpSSDPServer *server, char *bindAddr);
MT_BOOL cg_upnp_ssdp_server_close(CgUpnpSSDPServer *server);
...
MT_BOOL cg_upnp_ssdp_server_start(CgUpnpSSDPServer *server);
MT_BOOL cg_upnp_ssdp_server_stop(CgUpnpSSDPServer *server);
...
MT_BOOL cg_upnp_ssdp_serverlist_open(CgUpnpSSDPServerList *ssdpServerList);
MT_BOOL cg_upnp_ssdp_serverlist_close(CgUpnpSSDPServerList *ssdpServerList);
MT_BOOL cg_upnp_ssdp_serverlist_start(CgUpnpSSDPServerList *ssdpServerList);
MT_BOOL cg_upnp_ssdp_serverlist_stop(CgUpnpSSDPServerList *ssdpServerList);
...
MT_BOOL cg_upnp_ssdpresponse_server_open(CgUpnpSSDPResponseServer *server, int bindPort, char *bindAddr);
MT_BOOL cg_upnp_ssdpresponse_server_close(CgUpnpSSDPResponseServer *server);
...
MT_BOOL cg_upnp_ssdpresponse_server_start(CgUpnpSSDPResponseServer *server);
MT_BOOL cg_upnp_ssdpresponse_server_stop(CgUpnpSSDPResponseServer *server);

MT_BOOL cg_upnp_ssdpresponse_server_post(CgUpnpSSDPResponseServer *server, CgUpnpSSDPRequest *ssdpReq);
...
MT_BOOL cg_upnp_ssdpresponse_serverlist_open(CgUpnpSSDPResponseServerList *ssdpServerList, int bindPort);
MT_BOOL cg_upnp_ssdpresponse_serverlist_close(CgUpnpSSDPResponseServerList *ssdpServerList);
MT_BOOL cg_upnp_ssdpresponse_serverlist_start(CgUpnpSSDPResponseServerList *ssdpServerList);
MT_BOOL cg_upnp_ssdpresponse_serverlist_stop(CgUpnpSSDPResponseServerList *ssdpServerList);
...
MT_BOOL cg_upnp_ssdpresponse_serverlist_post(CgUpnpSSDPResponseServerList *ssdpServerList, CgUpnpSSDPRequest *ssdpReq);
