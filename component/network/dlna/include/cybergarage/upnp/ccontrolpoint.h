 ...
 *
 */
MT_BOOL cg_upnp_controlpoint_start(CgUpnpControlPoint *ctrlPoint);
 ...
 *
 */
MT_BOOL cg_upnp_controlpoint_stop(CgUpnpControlPoint *ctrlPoint);
...
*
*/
MT_BOOL cg_upnp_controlpoint_isrunning(CgUpnpControlPoint *ctrlPoint);
...
#else
MT_BOOL cg_upnp_controlpoint_lock(CgUpnpControlPoint *ctrlPoint);
#endif
/**
...
#else
MT_BOOL cg_upnp_controlpoint_unlock(CgUpnpControlPoint *ctrlPoint);
#endif
 ...
 */
MT_BOOL cg_upnp_controlpoint_search(CgUpnpControlPoint *ctrlPoint, char *target);
 ...
 * @return TRUE if successful; otherwise FALSE
 */
MT_BOOL cg_upnp_controlpoint_parsescservicescpd(CgUpnpService *service);
 ...
 */
MT_BOOL cg_upnp_controlpoint_parseservicesfordevice(CgUpnpDevice *dev, CgUpnpSSDPPacket *ssdpPkt);
 ...
 * @return TRUE if successful; otherwise FALSE
 */
MT_BOOL cg_upnp_controlpoint_subscribe(CgUpnpControlPoint *ctrlPoint, CgUpnpService *service, long timeout);
 ...
 * @return TRUE if successful; otherwise FALSE
 */
MT_BOOL cg_upnp_controlpoint_resubscribe(CgUpnpControlPoint *ctrlPoint, CgUpnpService *service, long timeout);
 ...
 * @return TRUE if successful; otherwise FALSE
 */
MT_BOOL cg_upnp_controlpoint_unsubscribe(CgUpnpControlPoint *ctrlPoint, CgUpnpService *service);
 ...
 * @return TRUE if successful; otherwise FALSE
 */
MT_BOOL cg_upnp_controlpoint_subscribeall(CgUpnpControlPoint *ctrlPoint, CgUpnpDevice *dev, long timeout);
 ...
 * @return TRUE if successful; otherwise FALSE
 */
MT_BOOL cg_upnp_controlpoint_resubscribeall(CgUpnpControlPoint *ctrlPoint, CgUpnpDevice *dev, long timeout);
 ...
 * @return TRUE if successful; otherwise FALSE
 */
MT_BOOL cg_upnp_controlpoint_unsubscribeall(CgUpnpControlPoint *ctrlPoint, CgUpnpDevice *dev);
 ...
 */
MT_BOOL cg_upnp_controlpoint_ipchanged(CgUpnpControlPoint *ctrlpoint);
