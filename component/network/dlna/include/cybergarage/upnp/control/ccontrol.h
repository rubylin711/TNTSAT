 ...
 */
MT_BOOL cg_upnp_action_performlistner(CgUpnpAction *action, CgUpnpActionRequest *actionReq);
 ...
 */
MT_BOOL cg_upnp_statevariable_performlistner(CgUpnpStateVariable *statVar, CgUpnpQueryRequest *queryReq);
 ...
 * @param action UPnP action
 */
MT_BOOL cg_upnp_control_action_response_getresult(CgUpnpActionResponse *actionRes, CgUpnpAction *action);
 ...
 * @param action UPnP action
 */
MT_BOOL cg_upnp_control_action_response_geterror(CgUpnpActionResponse *actionRes, CgUpnpAction *action);
 ...
 * @param action Action
 */
MT_BOOL cg_upnp_action_post(CgUpnpAction *action);
 ...
 * @param statVar State variable
 */
MT_BOOL cg_upnp_statevariable_post(CgUpnpStateVariable *statVar);
