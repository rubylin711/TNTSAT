...
typedef struct _CgUpnpAction {
	...
	/**** Execution Data ****/
	MT_BOOL (*listener)(struct _CgUpnpAction *);
	CgUpnpStatus *upnpStatus;
	void *userData;
} CgUpnpAction, CgUpnpActionList;

typedef MT_BOOL (*CG_UPNP_ACTION_LISTNER)(CgUpnpAction *);
 ...
 */
MT_BOOL cg_upnp_action_setargumentvaluebyname(CgUpnpAction *action, char *name, char *value);
 ...
 *
 * @param action The action in question
 * @param func The listener function of type: MT_BOOL (*CG_UPNP_ACTION_LISTNER)(CgUpnpAction *)
 */
 ...
 *
 * @param action The action in question
 * @return MT_BOOL (*CG_UPNP_ACTION_LISTNER)(CgUpnpAction *)
 */
