...
#define CG_UPNP_DEVICE_M_SEARCH_FILTER_INTERVAL 2

/** Definition for Notify  interval */
#define CG_UPNP_DEVICE_NOTIFY_INTERVAL 15
 ...
 */
MT_BOOL cg_upnp_device_parsedescription(CgUpnpDevice *dev, char *desciption, int descriptionLen);
 ...
 * \return TRUE, if the buffer was successfully parsed; otherwise FALSE
 */
MT_BOOL cg_upnp_device_parsedescriptionurl(CgUpnpDevice *dev, CgNetURL *url);
 ...
 * \return TRUE, if the buffer was successfully parsed; otherwise FALSE
 */
MT_BOOL cg_upnp_device_loaddescriptionfile(CgUpnpDevice *dev, char *fileName);
#endif
 ...
 */
MT_BOOL cg_upnp_device_updatefromssdppacket(CgUpnpDevice* dev,
					 CgUpnpSSDPPacket* ssdpPkt);
 ...
 *
 * \return MT_BOOL: TRUE if device matches given type; otherwise FALSE
 */
 ...
 *
 */
MT_BOOL cg_upnp_device_start(CgUpnpDevice *dev);
 ...
 *
 */
MT_BOOL cg_upnp_device_stop(CgUpnpDevice *dev);
 ...
 */
MT_BOOL cg_upnp_device_isrunning(CgUpnpDevice *dev);
 ...
 */
MT_BOOL cg_upnp_device_getabsoluteiconurl(CgUpnpDevice *dev, CgUpnpIcon *icon, CgString *buf);
 ...
 *
 */
MT_BOOL cg_upnp_device_addicon(CgUpnpDevice *dev, CgUpnpIcon *icon);
 ...
 *
 */
MT_BOOL cg_upnp_device_postsearchresponse(CgUpnpDevice *dev, CgUpnpSSDPPacket *ssdpPkt, char *st, char *usn);
 ...
 */
MT_BOOL cg_upnp_device_ipchanged(CgUpnpDevice *dev);
 ...
 * \param dev The device in question
 */
MT_BOOL cg_upnp_device_advertiser_start(CgUpnpDevice *dev);
 ...
 * \param dev The device in question
 */
MT_BOOL cg_upnp_device_advertiser_stop(CgUpnpDevice *dev);
 ...
 * \param dev Device that is being advertised
 */
MT_BOOL cg_upnp_device_advertiser_isrunning(CgUpnpDevice *dev);
...
MT_BOOL cg_upnp_device_announcefrom(CgUpnpDevice *dev, char *bindAddr);
MT_BOOL cg_upnp_device_byebyefrom(CgUpnpDevice *dev, char *bindAddr);
