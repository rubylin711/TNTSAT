 ...
 */
MT_BOOL cg_upnp_service_parsedescription(CgUpnpService *service, char *description, int descriptionLen);
 ...
 */
MT_BOOL cg_upnp_service_parsedescriptionurl(CgUpnpService *service, CgNetURL *url);
 ...
 */
MT_BOOL cg_upnp_service_isscpdurl(CgUpnpService *service, char *url);
 ...
 */
MT_BOOL cg_upnp_service_announcefrom(CgUpnpService *service, char *bindAddr);
 ...
 * @param bindAddr The address to attach to the announcement
 */
MT_BOOL cg_upnp_service_byebyefrom(CgUpnpService *service, char *bindAddr);
 ...
 */
MT_BOOL cg_upnp_service_addsubscriber(CgUpnpService *service, CgUpnpSubscriber *sub);
 ...
 */
MT_BOOL cg_upnp_service_removesubscriber(CgUpnpService *service, CgUpnpSubscriber *sub);
 ...
 */
MT_BOOL cg_upnp_service_notify(CgUpnpService *service, CgUpnpStateVariable *statVar);
 ...
 * @param service The service in question
 */
MT_BOOL cg_upnp_service_notifyall(CgUpnpService *service, MT_BOOL doBracket );
