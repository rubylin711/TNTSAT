...
MT_BOOL cg_soap_request_sethttprequest(CgSoapRequest *soapReq, CgHttpRequest *httpReq);
...
MT_BOOL cg_soap_request_parsemessage(CgSoapRequest *soapReq, char *msg, int msgLen);
