...
MT_BOOL cg_socket_isbound(CgSocket *socket);
MT_BOOL cg_socket_close(CgSocket *socket);

MT_BOOL cg_socket_listen(CgSocket *socket);

MT_BOOL cg_socket_bind(CgSocket *sock, int bindPort, char *bindAddr, MT_BOOL bindFlag, MT_BOOL reuseFlag);
MT_BOOL cg_socket_accept(CgSocket *sock, CgSocket *clientSock);
...
MT_BOOL cg_socket_setreuseaddress(CgSocket *socket, MT_BOOL flag);
