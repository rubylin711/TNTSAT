...
MT_BOOL cg_upnpav_dms_condir_actionreceived(CgUpnpAction *action);
MT_BOOL cg_upnpav_dms_conmgr_actionreceived(CgUpnpAction *action);
MT_BOOL cg_upnpav_dms_medrec_actionreceived(CgUpnpAction *action);
MT_BOOL cg_upnpav_dms_condir_queryreceived(CgUpnpStateVariable *var);

/****************************************
* cg_upnpav_dms_actionreceived
****************************************/

MT_BOOL cg_upnpav_dms_actionreceived(CgUpnpAction *action)
{
	CgUpnpDevice *dev;
...
MT_BOOL cg_upnpav_dms_queryreceived(CgUpnpStateVariable *statVar)
{
	CgUpnpDevice *dev;
	CgUpnpService *service;
	CgUpnpAvServer *dms;
...
static void cg_upnpav_free_content(CgUpnpAvContent *con)
{
	CgUpnpAvContent* s_con;

	if (!con)
		return;
	
	for (s_con=cg_upnpav_content_getchildcontents(con); s_con; s_con=cg_upnpav_content_next(con)) 
		cg_upnpav_free_content(s_con);
	printf("\n[DMS DBG]In %s at %d\n", __func__, __LINE__);
	
	cg_upnpav_content_delete(con);
	printf("\n[DMS DBG]In %s at %d\n", __func__, __LINE__);
}
...
#else
	if (dms->rootContent)
		cg_upnpav_free_content(dms->rootContent);
#endif
...
MT_BOOL cg_upnpav_dms_updatenetworkinterfaces(CgUpnpAvServer *dms)
{
