...
CgUpnpAvContent *cg_upnpav_content_findbyuserfunc
(CgUpnpAvContent *con, CG_UPNPAV_CONTENT_COMPARE_FUNC userFunc, void *userData)
{
...
static MT_BOOL cg_upnpav_content_comparebyid(CgUpnpAvContent *con, void *userData)
{
	if (!userData)
		return FALSE;
...
static MT_BOOL cg_upnpav_content_comparebytitle(CgUpnpAvContent *con, void *userData)
{
	if (!userData)
		return FALSE;
...
MT_BOOL cg_upnpav_content_iscontentnode(CgXmlNode *node)
{
...
MT_BOOL cg_upnpav_content_haschildcontents(CgUpnpAvContent *con)
{
	CgXmlNode *childNode;
	for (childNode = cg_xml_node_getchildnodes(con); childNode; childNode=cg_xml_node_next(childNode)) {
		if (cg_upnpav_content_iscontentnode(childNode))
