...
MT_BOOL cg_upnpav_dmr_renderingctrl_init(CgUpnpAvRenderer *dmr);
...
MT_BOOL cg_upnpav_dmr_renderingctrl_actionreceived(CgUpnpAction *action);
...
MT_BOOL cg_upnpav_dmr_renderingctrl_queryreceived(CgUpnpStateVariable *statVar);
...
MT_BOOL cg_upnpav_dmr_actionreceived(CgUpnpAction *action)
{
	CgUpnpDevice *dev;
	CgUpnpService *service;
...
MT_BOOL cg_upnpav_dmr_queryreceived(CgUpnpStateVariable *statVar)
{
	CgUpnpDevice *dev;
	CgUpnpService *service;
	CgUpnpAvRenderer *dmr;
