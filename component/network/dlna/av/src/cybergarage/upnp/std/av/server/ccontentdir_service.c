...
static MT_BOOL cg_upnpav_dms_condir_browsemetadata(CgUpnpAvServer *dms, CgUpnpAction *action)
{
	char *objectID;
...
static MT_BOOL cg_upnpav_dms_condir_browsedirectchildren(CgUpnpAvServer *dms, CgUpnpAction *action)
{
	char *objectID;
	CgUpnpAvContent *objectContent;
