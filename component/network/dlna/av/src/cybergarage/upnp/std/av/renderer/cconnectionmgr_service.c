...
MT_BOOL cg_upnpav_dmr_conmgr_actionreceived(CgUpnpAction *action)
{
...
MT_BOOL cg_upnpav_dmr_conmgr_queryreceived(CgUpnpStateVariable *statVar)
{
	return FALSE;
}
...
MT_BOOL cg_upnpav_dmr_conmgr_init(CgUpnpAvRenderer *dmr)
{
	CgUpnpDevice *dev;
    ...
    service = cg_upnp_device_getservicebyexacttype(dmr->dev, 
		CG_UPNPAV_DMR_CONNECTIONMANAGER_SERVICE_TYPE);

	cg_upnp_statevariable_setvaluewithoutnotify(
		cg_upnp_service_getstatevariablebyname(service, 
		CG_UPNPAV_DMR_CONNECTIONMANAGER_A_ARG_TYPE_RCS_ID),
		"-1");
	cg_upnp_statevariable_setvaluewithoutnotify(
		cg_upnp_service_getstatevariablebyname(service, 
		CG_UPNPAV_DMR_CONNECTIONMANAGER_A_ARG_TYPE_AVTRANSPORT_ID),
		"-1");
	cg_upnp_statevariable_setvaluewithoutnotify(
		cg_upnp_service_getstatevariablebyname(service, 
		CG_UPNPAV_DMR_CONNECTIONMANAGER_A_ARG_TYPE_CONNECTION_MANAGER),
		"");
	cg_upnp_statevariable_setvaluewithoutnotify(
		cg_upnp_service_getstatevariablebyname(service, 
		CG_UPNPAV_DMR_CONNECTIONMANAGER_A_ARG_TYPE_CONNECTION_ID),
		"-1");
	cg_upnp_statevariable_setvaluewithoutnotify(
		cg_upnp_service_getstatevariablebyname(service, 
		CG_UPNPAV_DMR_CONNECTIONMANAGER_A_ARG_TYPE_DIRECTION),
		"Input");
	cg_upnp_statevariable_setvaluewithoutnotify(
		cg_upnp_service_getstatevariablebyname(service, 
		CG_UPNPAV_DMR_CONNECTIONMANAGER_A_ARG_TYPE_CONNECTION_STATUS),
		"OK");
	cg_upnp_statevariable_setvaluewithoutnotify(
		cg_upnp_service_getstatevariablebyname(service, 
		CG_UPNPAV_DMR_CONNECTIONMANAGER_CURRENTCONNECTIONIDS),
		"0");
