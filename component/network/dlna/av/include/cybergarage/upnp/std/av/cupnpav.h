...
typedef MT_BOOL (*CG_UPNPAV_HTTP_LISTENER)(CgHttpRequest *);
typedef MT_BOOL (*CG_UPNPAV_ACTION_LISTNER)(CgUpnpAction *);
typedef MT_BOOL (*CG_UPNPAV_STATEVARIABLE_LISTNER)(CgUpnpStateVariable *);
