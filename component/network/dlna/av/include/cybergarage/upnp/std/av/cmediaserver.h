...
void *userData;
} CgUpnpAvServer, CgUpnpMediaServer;
...
MT_BOOL cg_upnpav_dms_conmgr_init(CgUpnpAvServer *dms);
...
MT_BOOL cg_upnpav_dms_condir_init(CgUpnpAvServer *dms);
...
MT_BOOL cg_upnpav_dms_medrec_init(CgUpnpAvServer *dms);
