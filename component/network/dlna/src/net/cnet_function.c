...
static MT_BOOL CG_NET_USE_ONLY_IPV4_ADDR = FALSE;
static MT_BOOL CG_NET_USE_ONLY_IPV6_ADDR = FALSE;

////////////////////////////////////////////////
//	cg_net_isuseaddress
////////////////////////////////////////////////

MT_BOOL cg_net_isuseaddress(char *addr)
{
...
MT_BOOL cg_net_isipv6address(char *addr)
{
	cg_log_debug_l4("Entering...\n");
