...
extern long cg_http_packet_read_chunk(CgHttpPacket *httpPkt, 
		CgSocket *sock, char *lineBuf, int lineBufSize);
...
long cg_http_packet_read_chunk(CgHttpPacket *httpPkt, 
		CgSocket *sock, char *lineBuf, int lineBufSize)
{
	long readLen = 0;
	long conLen = 0;
...
MT_BOOL cg_http_packet_read_body(CgHttpPacket *httpPkt, CgSocket *sock, char *lineBuf, int lineBufSize)
{
	long readLen;
	int conLen;
	char *content;
