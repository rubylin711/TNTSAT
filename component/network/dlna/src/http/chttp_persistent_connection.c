...
extern CgHttpPersistentConnection *cg_http_persistentconnection_new(void);
extern void cg_http_persistentconnection_delete(CgHttpPersistentConnection *node);
