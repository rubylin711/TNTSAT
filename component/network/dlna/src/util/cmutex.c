...
MT_BOOL cg_mutex_delete(CgMutex *mutex)
{
	if (!mutex)
		return FALSE;
...
MT_BOOL cg_mutex_lock_trace(	const char *file, 
				int line, 
				const char *function,
				CgMutex *mutex)
{
...
MT_BOOL cg_mutex_unlock_trace(	const char *file, 
				int line, 
				const char *function,
				CgMutex *mutex)
{
...
#else
MT_BOOL cg_mutex_lock(CgMutex *mutex)
{
	if (!mutex)
		return FALSE;
...
MT_BOOL cg_mutex_unlock(CgMutex *mutex)
{
	if (!mutex)
		return FALSE;
