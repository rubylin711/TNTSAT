...
MT_BOOL cg_cond_delete(CgCond *cond)
{
	cg_log_debug_l4("Entering...\n");
...
MT_BOOL cg_cond_wait(CgCond *cond, CgMutex *mutex, unsigned long timeout)
{
#if defined(WIN32) && !defined(ITRON)
...
MT_BOOL cg_cond_signal(CgCond *cond)
{
	MT_BOOL success = FALSE;
