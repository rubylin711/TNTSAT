...
extern MT_BOOL cg_upnp_service_notifyallbracket(CgUpnpService *service);

/****************************************
* cg_upnp_service_notifymain
****************************************/

static MT_BOOL cg_upnp_service_notifymain(CgUpnpService *service, CgUpnpStateVariable *statVar)
{
...
MT_BOOL cg_upnp_service_notifyallbracket(CgUpnpService *service)
{
