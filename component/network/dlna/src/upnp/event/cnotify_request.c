...
extern CgXmlNode *cg_upnp_event_notify_request_getvariablenode
			(CgUpnpNotifyRequest *nofityReq);
...
****************************************/
MT_BOOL cg_upnp_event_notify_request_setpropertysetnode(CgUpnpNotifyRequest *notifyReq, CgUpnpSubscriber *sub, /* CgUpnpService */void *pservice, CgUpnpStateVariable *statVar)
{
...
CgXmlNode *cg_upnp_event_notify_request_getvariablenode
			(CgUpnpNotifyRequest *nofityReq)
{
	CgXmlNode *propSetNode;
	CgXmlNode *propNode;
