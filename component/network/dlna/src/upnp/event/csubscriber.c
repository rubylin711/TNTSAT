 ...
 */
MT_BOOL cg_upnp_subscriber_isexpired(CgUpnpSubscriber *sub)
{
	CgSysTime currTime;
	CgSysTime timeout;
 ...
 */
static MT_BOOL cg_upnp_subscriber_notifymain(CgUpnpSubscriber *sub, CgUpnpService *service, CgUpnpStateVariable *statVar)
{
	char *host;
	int port;
	CgUpnpNotifyRequest *notifyReq;
	CgUpnpNotifyResponse *notifyRes;
	MT_BOOL notifySuccess;
 ...
 * @return TRUE if succesful; otherwise FALSE
 */
MT_BOOL cg_upnp_subscriber_notify(CgUpnpSubscriber *sub, CgUpnpStateVariable *statVar)
{
 ...
 * @return TRUE if succesful; otherwise FALSE
 */
MT_BOOL cg_upnp_subscriber_notifyall(CgUpnpSubscriber *sub, /* CgUpnpService */ void *service)
{
