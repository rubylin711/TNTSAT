...
CPPFLAGS = -I$(BUILDROOT_SYSROOT_USR_INC_DIR) -P
CFLAGS += $(CPPFLAGS)
...
ifeq ($(COPY_SOURCECODE),y)
	...
	cd $(MT_BUILD_DIR)/$(SRC_PATH); ./configure --host=${HOST} --prefix=/usr --with-shared --disable-stripping;
else
	cd $(MT_BUILD_DIR)/$(SRC_PATH); $(MT_SRC_DIR)/$(SRC_PATH)/configure --host=${HOST} --prefix=/usr --with-termlib --with-shared --disable-stripping;
endif
