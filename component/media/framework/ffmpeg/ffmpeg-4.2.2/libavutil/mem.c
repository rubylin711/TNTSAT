...
extern void * malloc33(u32 size);
extern void * realloc33(void * old_ptr, u32 size);
extern void free33(void * ptr);
extern void * calloc33(u32 n, u32 size);
#endif
...
#else
    return realloc33(ptr, size + !size);
#endif
}
