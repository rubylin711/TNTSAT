...
typedef struct MOVContext {
    ...
    int duration_type;    ///< AVFormatContext *fc duration caculate methond, some deemed unreliable
    int found_moov;       ///< 'moov' atom has been found
    int found_mdat;       ///< 'mdat' atom has been found
    int found_hdlr_mdta;  ///< 'hdlr' atom with type 'mdta' has been found
    int found_moof;       ///< 'moof' atom has been found, for segment
	...
	int stream_seek_type;  ///< seek stream type,default 0, 1 seek fragment only
    ...
    int max_opti_index_entries;
    AVEncryptionInitInfo *default_encryption_info;
} MOVContext;
...
#define MOV_DUR_CACAL_TYPE_NONE       0
#define MOV_DUR_CACAL_TYPE_CACAL      1
#define MOV_DUR_CACAL_TYPE_MVHD       2
#define MOV_DUR_CACAL_TYPE_MEHD       3
...
void set_encrypt_mp4_key(char *p_key, int key_len);
