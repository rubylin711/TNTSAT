...
#define VERSION "2.2.8d685df.20240515-145138"
...
extern void drv_gpio_io_enable(u8 gpio, int enable);
extern void drv_gpio_set_dir(u8 gpio, int dir);
extern void drv_gpio_get_dir(u8 gpio, int *dir);
extern void drv_gpio_set_value(u8 gpio, int val);
extern void drv_gpio_get_value(u8 gpio, int *val);
