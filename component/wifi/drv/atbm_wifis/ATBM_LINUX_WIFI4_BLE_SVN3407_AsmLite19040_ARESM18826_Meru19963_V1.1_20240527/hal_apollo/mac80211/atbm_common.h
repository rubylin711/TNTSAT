...
typedef struct _best_channel_info_new_
{
	u8 ssid[32];
	u8 mac_addr[ETH_ALEN];
	u8 channel;
	...
	u8 enc_type;
	u32 enc_type_name;
}BEST_CHANNEL_INFO_NEW;
enum ap_list_arol_scan_mode{
	SCAN_ALL_CHANNEL = 0,
	SCAN_2_4G_CHANNEL,
	SCAN_5G_CHANNEL,
	SCAN_FAST_ALL_CHANNEL,
	SCAN_FAST_2_4G_CHANNEL,
	SCAN_FAST_5G_CHANNEL,
	SCAN_CUSTOMER_CHANNEL,
};


typedef struct _ap_list_arol_
{
	/*
	scan_mode:
		0:all channel scan 
		1:2.4G channel scan 
		2:5G channel scan
		3:all fast channel scan 
			2.4GHz channel：1、6、11
			5GHz channel：36、40、44、48、149、153、157、161、165（no DFS）
		4:fast 2.4G channel scan
		5:fast 5G channel scan
		6:customer set scan channel
			scan_channel[] & scan_n_channel
