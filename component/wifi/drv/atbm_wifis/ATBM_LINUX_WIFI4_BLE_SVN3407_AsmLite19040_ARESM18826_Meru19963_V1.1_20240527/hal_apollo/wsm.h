...
#define WSM_MIB_ID_SET_RATE_TX_POWER_5G			0x106a
...
struct cfg_txpower_v2_t{
	s8 set_txpwr_delta_gain[13];
	s8 set_b_txpwr_delta_gain[13];
	s8 set_gn_txpwr_delta_gain[13];
	s8 different_rate_txpower_mode[11];
	s8 different_rate_txpower_mode_40M[11];
	s8 different_rate_txpower_mode_5g[11];
	s8 different_rate_txpower_mode_40M_5g[11];
	s8 reserve;
};
...
#define WSM_SET_MDNS_OFFLOAD		(0x29)
#define WSM_SET_MDNS_OFFLOAD_RESP	(0x429)
