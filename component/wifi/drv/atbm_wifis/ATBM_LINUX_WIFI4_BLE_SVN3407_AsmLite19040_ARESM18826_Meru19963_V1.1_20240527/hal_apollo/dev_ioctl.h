...
enum atbm_msg_type{
    ...
    ATBM_DEV_IO_GET_CHIP_TEMPERATURE	= 51,
#ifdef ATBM_EVIZE_CUSTOMER_FUNC
    ATBM_DEV_IO_GET_EVIZE_WIFI_STATE	=52,
    ATBM_DEV_IO_GET_EVIZE_REASON_CODE	=53,
#endif
	ATBM_DEV_IO_GET_AP_LIST_NEW   = 54,
	ATBM_DEV_IO_SET_SCAN_CHANNEL_LIMIT   = 55,
	ATBM_DEV_IO_SET_SND_PROBE_REQ_MUTIL_IE = 68,
	ATBM_DEV_IO_GET_AP_AROL   = 69,
};




struct altm_snd_mutil_ie{
	u8 n_ssid;
	u8 ssids[5][32];
	u8 channels[14];
	u8 n_channels;
