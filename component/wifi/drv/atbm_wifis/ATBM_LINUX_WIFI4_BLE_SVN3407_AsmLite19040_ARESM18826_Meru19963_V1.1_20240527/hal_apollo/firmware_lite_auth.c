...
#ifdef USB_BUS
#include "firmware_lite_auth_usb.h"
#endif
#ifdef SDIO_BUS
#include "firmware_lite_auth_sdio.h"
#endif
#ifdef SPI_BUS
#include "firmware_lite_auth_spi.h"
#endif




int load_usb_lite_bt_firmware_auth(struct firmware_altobeam *fw_altobeam)
{
