...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5,16,0) && PLATFORM_MONTAGE)
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 0)) /* Montage, Wliao Added */
  .ndo_siocdevprivate = rtw_priv_ioctl
#endif  
};
#endif
...
#ifdef CONFIG_RTW_NAPI
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 1, 1) && PLATFORM_MONTAGE)
