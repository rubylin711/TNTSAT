...
#define DESC_TYPE_RSN			BIT(0)
#define WPA_PTK_VALID			BIT(1)
#define WPA_GTK_VALID			BIT(2)
#define	WPA_GTK_UPDATING		BIT(3)
#define WPA_REPLAY_COUNTER		BIT(4)
#define WPA_PTK_NEGOTIATING		BIT(5)
