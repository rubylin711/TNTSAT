 ...
 */
static inline int ieee80211_is_robust_mgmt_frame(struct sk_buff *skb)
{
	if (skb->len < 25)
		return 0;
 ...
 */
static inline int ieee80211_is_public_action(struct ieee80211_hdr *hdr, size_t len)
{
 ...
 */
static inline int ieee80211_check_tim(const struct ieee80211_tim_ie *tim,
				       u8 tim_len, u16 aid)
{
	u8 mask;
