...
static int ath9k_init_channels_rates(struct ath_softc *sc)
{
	...
	if (sc->sc_ah->caps.hw_caps & ATH9K_HW_CAP_2GHZ) {
		...
		sc->sbands[NL80211_BAND_2GHZ].channels = channels;
		sc->sbands[NL80211_BAND_2GHZ].band = NL80211_BAND_2GHZ;
		sc->sbands[NL80211_BAND_2GHZ].n_channels =
			ARRAY_SIZE(ath9k_2ghz_chantable);
		sc->sbands[NL80211_BAND_2GHZ].bitrates = ath9k_legacy_rates;
		sc->sbands[NL80211_BAND_2GHZ].n_bitrates =
...
void ath9k_reload_chainmask_settings(struct ath_softc *sc)
{
	...
	if (sc->sc_ah->caps.hw_caps & ATH9K_HW_CAP_2GHZ)
		setup_ht_cap(sc, &sc->sbands[NL80211_BAND_2GHZ].ht_cap);
	if (sc->sc_ah->caps.hw_caps & ATH9K_HW_CAP_5GHZ)
