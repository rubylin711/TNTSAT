...
static const struct proc_ops onedev_apps_proc_fops = {
     .proc_open    = onedev_apps_proc_open,
     .proc_read    = seq_read,
     .proc_lseek   = seq_lseek,
     .proc_release = seq_release,
};

static const struct proc_ops onedev_stat_proc_fops = {
     .proc_open    = onedev_stat_proc_open,
     .proc_read    = seq_read,
     .proc_lseek   = seq_lseek,
     .proc_release = seq_release,
};
