...
ifeq ($(COPY_SOURCECODE),y)
	...
	cd $(MT_BUILD_DIR)/$(SRC_PATH); autoreconf -f -i; ./configure --host=${HOST} --prefix=/usr $(CONFIGURE_ARGS_EXTRA);
else
	cd $(MT_BUILD_DIR)/$(SRC_PATH); autoreconf -f -i; $(MT_SRC_DIR)/$(SRC_PATH)/configure --host=${HOST} --prefix=/usr $(CONFIGURE_ARGS_EXTRA);
endif
