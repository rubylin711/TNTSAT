...
CPPFLAGS = -I$(BUILDROOT_SYSROOT_USR_INC_DIR) -I$(BUILDROOT_SYSROOT_USR_INC_DIR)/ncurses
CFLAGS += $(CPPFLAGS)
...
ifeq ($(MT_BUILD_DIR)/$(SRC_PATH)/makefile-done,$(wildcard $(MT_BUILD_DIR)/$(SRC_PATH)/makefile-done))
	...
	@echo -e "\033[32m copy specific file in $(MT_BUILD_DIR)/$(SRC_PATH) by yourself please \033[0m"
