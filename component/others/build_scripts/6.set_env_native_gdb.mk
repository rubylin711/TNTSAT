...
CFLAGS += $(CPPFLAGS)
LDFLAGS = -L$(BUILDROOT_SYSROOT_USR_LIB_DIR) -static
...
CXXFLAGS = $(CFLAGS)
CONFIGURE_ARGS = --disable-gdbtk --disable-tui --disable-sim --without-included-regex --without-included-gettext --without-x
...
ifeq ($(MT_BUILD_DIR)/$(SRC_PATH)/makefile-done,$(wildcard $(MT_BUILD_DIR)/$(SRC_PATH)/makefile-done))
	...
	cd $(MT_BUILD_DIR)/$(SRC_PATH); ./configure --host=${HOST} --prefix=/usr $(CONFIGURE_ARGS);
	...
	rm -f $(BUILDROOT_SYSROOT_USR_DIR)/bin/gdbserver
