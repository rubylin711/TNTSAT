...
//-------------------------------------------------------------------------------------------------
#define SII_LIB_OBJ_MODULE_DEF(str)        static const char* sSiiLibObjClassStr = SII_DEF2STR(str); SiiLibObjList_t SiiLibObjList_##str = NULL; \
	static SiiLibObjList_t* spSiiLibObjList = &SiiLibObjList_##str
#define SII_LIB_OBJ_MODULE_DEF_NOCREATE(str)        static const char* sSiiLibObjClassStr = SII_DEF2STR(str); SiiLibObjList_t SiiLibObjList_##str = NULL
...
typedef ulong SiiInst_t;
typedef void*    SiiLibObjList_t;
typedef uint16_t SiiLibObjSize_t;
