...
//-------------------------------------------------------------------------------------------------
//! @brief      Finds out if MilliTO Object has been expired by 'timeout' milli seconds
//!
//! @param[in]  pMilliTO - pointer to 'MilliTO' object.
//! @param[in]	timeout  - Number of milli seconds.
//!
//! @return     true if 'MilliTO' object has been expired by 'timeout' milli seconds.
//-------------------------------------------------------------------------------------------------
...
//!
//! @param[in]  milliDelay - Number of micro seconds.
//-------------------------------------------------------------------------------------------------
