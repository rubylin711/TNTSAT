...
//
// Copyright 2002-2009, Deco, Inc.  All rights reserved.
//***************************************************************************/
...
typedef enum _SiiCecOpcodes_t {     // CEC Messages
	...
	CECOP_SET_AUDIO_VOLUME_LEVEL     = 0x73,     // Spec 2.0
	...
	CECOP_GIVE_FEATURES			= 0xA5,      // Spec 2.0
	CECOP_REPORT_FEATURES			= 0xA6,      // Spec 2.0
	CECOP_REQUEST_CURRENT_LATENCY	= 0xA7,      // Spec 2.0
	CECOP_REPORT_CURRENT_LATENCY		= 0xA8,      // Spec 2.0
