1. 整体介绍
该sample包含多个基本文件
sample_split_search.c
该文件是关于异频搜索节目的主要步骤以及涉及函数。
...
make
3. 使用
拷贝 sample_split_search 到u盘，linux\out\general\breif_sample\split_freq_search\sample_split_search
...
cd /mnt
./sample_split_search -b 1 -s 950 -t 1000 -k 1 -p 0

4.流程介绍
  1) MT_SYS_Init()  //系统初始化
  2) MTADP_Fe_Init()  //初始化tuner
  3) MT_Split_Search_Blindscan()  //盲扫频点
