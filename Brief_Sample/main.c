...
//    MTSampleCommandRegister("download", MT_DownloadMain, "download sample command.", MT_RESOURCE_NO);
	...
	MTSampleCommandRegister("audio_vvid", MT_AudioVIVIDMain, "Audio VIVID sample command.", MT_RESOURCE_NO);
    ...
    MTSampleCommandRegister("hmac-sha1", MT_HmacSha1Main, "hmac sha1 sample command.", MT_RESOURCE_NO);
...
#else
	MTSampleCommandRegister("ird", MT_CaIrdMain, "IRD sample command.", MT_RESOURCE_NO);
#endif	
	...
	MTSampleCommandRegister("tts", MT_EAAMain, "TTS sample command.", MT_RESOURCE_NO);
