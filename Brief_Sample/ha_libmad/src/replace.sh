...
sed -i "s/mt_malloc/mt_malloc/g" *.*
sed -i "s/mt_free/mt_free/g" *.*
sed -i "s/mt_mmz_buf_s/mt_mmz_buf_s/g" *.*
sed -i "s/mt_mmz_new/mt_mmz_new/g" *.*
sed -i "s/mt_mmz_map/mt_mmz_map/g" *.*
sed -i "s/mt_mmz_unmap/mt_mmz_unmap/g" *.*
sed -i "s/mt_mmz_delete/mt_mmz_delete/g" *.*
sed -i "s/mt_mmap/mt_mmap/g" *.*
sed -i "s/mt_munmap/mt_munmap/g" *.*
sed -i "s/mt_mem_map/mt_mem_map/g" *.*
sed -i "s/mt_mem_unmap/mt_mem_unmap/g" *.*
sed -i "s/mt_sys_get_time_stamp_ms/mt_sys_get_time_stamp_ms/g" *.*
sed -i "s/mt_proc_read_func/mt_proc_read_func/g" *.*
sed -i "s/mt_drv_proc_write_func/mt_drv_proc_write_func/g" *.*
sed -i "s/mt_proc_entry_t/mt_proc_entry_t/g" *.*
sed -i "s/mt_device_s/mt_device_s/g" *.*
sed -i "s/mt_drv_module_register/mt_drv_module_register/g" *.*
sed -i "s/mt_drv_module_unregister/mt_drv_module_unregister/g" *.*
sed -i "s/mt_drv_dev_register/mt_drv_dev_register/g" *.*
sed -i "s/mt_drv_dev_unregister/mt_drv_dev_unregister/g" *.*
sed -i "s/SYNC_BUF_STATE_HIGH/SYNC_BUF_STATE_HIGH/g" *.*
sed -i "s/u32ZmeFrmHIn/u32ZmeFrmHIn/g" *.*
