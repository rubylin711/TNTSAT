1. 整体介绍
该sample包含多个基本文件
sample_dvbs_diseqc.c
该文件是关于dvbs_diseqc的主要步骤以及涉及函数。
...
make
3. 使用
拷贝 sample_blindscan 到u盘，linux\out\general\breif_sample\dvbs_diseqc
...
cd /mnt
./sample_dvbs_diseqc -b 1 -s 950 -t 1000 -k 1 -p 0
...
4.流程介绍
  ...
  5) mt_unf_fe_diseqc_switch4port()  //选择端口
  6) DVB_DmxDeInit()  //dmx去初始化
  7) MTADP_Fe_Deinit()  //去初始化tuner
