#ifndef _SAMPLE_MT_DATA_H
#define _SAMPLE_MT_DATA_H
...
{
    mt_char multiIPAddr[20];
    mt_u32  port;
} FE_TYPE_IP_S;

typedef struct hiFE_TYPERF_S
{
    mt_u32 u32TunerPort; /*Tuner port*/
    mt_u32 u32Frequency;  /*unit:MHZ */
    mt_u32 u32SymbolRate; /*unit:KHZ*/
    mt_u32 u32Modulation;  /* 0:16QAM 1:32QAM 2:64QAM 3:128QAM 4:256QAM*/
} FE_TYPE_RF_S;
...
typedef struct  hiDB_PROGRAM_S
{
    ...
    mt_s8 ProgramName[MAX_PROGNAME_LENGTH];

    mt_u16 u16PmtPid;
    mt_u16 u16PcrPid;

    mt_u32 u16ProgProperty;

    mt_u16 u16AudioVol;
    mt_u8  u8AudioChannel;
    mt_u8  u8VideoChannel;
