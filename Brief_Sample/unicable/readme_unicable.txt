...
make
3. 使用
拷贝 sample_unicable 到u盘，linux\out\general\breif_sample\unicable\sample_unicable
...
cd /mnt
./sample_unicable -b 1 -s 950 -t 2150 -k 1 -p 0 -u 1210 -i 0 -v 1
