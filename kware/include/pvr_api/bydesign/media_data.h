...
//(4 * 512 * 188)
//#define FILE_WRITE_MIN_SIZE (481280)
#define FILE_WRITE_MIN_SIZE (385024)
/*!
  timeshift min unit
  */
#define TS_AUDIO_STREAM_RW_UNIT (64 * 188)
...
/*!
  sample context split file flag
  */
#define SAMPLE_CONTEXT_SPLIT_FILE_FLAG (0x30)

#define MAX_STORE_INFO_LEN (16)
/*!
  dynamic rec info
  */
...
/*!
  dynamic rec info
  */
typedef struct tag_dynamic_rec_info2
{
  /*!
    unit data lengh = sizeof(dynamic_rec_info_t)
    */
  ...
  /*!
    store_info
    */
  u8 store_info[MAX_STORE_INFO_LEN];
}dynamic_rec_info2_t;
/*!
  static record info
  */
...
/*
  save user data length
*/
//#define IDX_INFO_USER_DATA_MAX (1024 - IDX_INFO_OFFSET - 4 * REC_MAX_EXTERN_PID - 4)

/*!
  dynamic_info_save_mode
  */
typedef enum tag_dynamic_info_save_mode
{
  /*!
    save default struct
    */
  DYNAMIC_DEFAULT_STRUCT = 0,
  /*!
    save fixed len
    */
  DYNAMIC_FIXED_LEN,
...
typedef struct tag_idx_extern_info
{
  ...
  */
  ...
  /*!
    dynamic_info_save_mode_t
  */
  u32 dynamic_info_save_mode : 8;
  /*!
    dynamic_info_len for mode DYNAMIC_FIXED_LEN
  */
  u32 dynamic_info_len : 8;
  /*!
    extern pid num
    */
  u32 extern_num : 16;
...
/*!
  idx info lock flag offset for old version
  */
...
typedef struct tag_media_idx_interface
{
  MT_BOOL (*load)(void *p_handle, u32 start, MT_BOOL first_load);

  void (*destory)(void *p_handle);


  dynamic_rec_info_t* (*read_by_index)(void *p_handle, u32 index);


  dynamic_rec_info_t* (*found_by_pts)(void *p_handle, u32 pts);

  dynamic_rec_info_t* (*found_by_pts_ex)(void *p_handle,\
    u32 pts, u32 start_index, MT_BOOL b_forward);

  dynamic_rec_info_t* (*found_by_ms)(void *p_handle, u32 ms);


  void (*write_extern_info)(void *p_handle, idx_extern_info_t *p_extern_info);


  s32 (*check_index_range)(void *p_handle, u32 index);

  u32 (*write)(void *p_handle, void *p_dy_info);


  MT_BOOL (*reload)(void *p_handle, u32 start_index);


  u32 (*split_file)(void *p_handle, u16 *p_name);


  void (*flush)(void *p_handle);
}media_idx_interface_t;
...
/*!
  ...
  */
MT_BOOL unpacket_rec_info(u8 *p_packet, u8 *p_rec_info, u32 *p_payload);
...
/*!
  ...
  */
MT_BOOL parse_pcr(u8 *p_data, unsigned long long *p_pcr);
...
void get_dat_info_file(const u16 *p_ts_file_name, u16 *p_dat_file_name, u32 dat_name_len);
...
/*!
  ...
  */
MT_BOOL parse_record_info(rec_info_t *p_rec_info, u16 *p_name);
...
/*!
  ...
  \param[in] p_name file name to be parsed
  */
MT_BOOL parse_record_info_idx(rec_info_t *p_rec_info, u16 *p_idx_name);
...
/*!
  ...
  */
MT_BOOL media_idx_create(media_idx_t **pp_array,
...
/*!
  ...
  \param[in] ridx_buf_size ridx_buf_size
  */
MT_BOOL media_idx_load(media_idx_t **pp_array,
  u32 unit_total, u16 *p_name, u8 *p_ridx_buf, u32 ridx_buf_size);
...
/*!
  ...
  return index
  */
u32 media_idx_write(media_idx_t *p_array, dynamic_rec_info2_t *p_item);
...
/*!
  ...
  \param[in] p_name save file
  */
MT_BOOL media_idx_reload(media_idx_t *p_array, u32 start_index);
...
void utc_time_to_code(vfs_time_t *p_time, u8 *p_utc_code);
