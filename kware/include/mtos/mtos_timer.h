...
/*!
  Init a software timer
  \param[in] prio the timer task priority
  \param[in] stack_size the the timer task stack size

  \return success, return 0; failed, return < 0
  */
...
/*!
  Initialize the software mtos timer module
  */
s32 mtos_soft_timer_init(void);

/*!
  De-initialize the software mtos timer module
  */
s32 mtos_soft_timer_deinit(void);
