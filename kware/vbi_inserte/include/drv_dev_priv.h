...
#define DEV_ID_FIND_BY_LLD(LLD_PTR) \
  (((mt_u32)(((device_base_t *)((unsigned int)LLD_PTR - sizeof(device_base_t)))->type)) << 16) \
  | ((mt_u32)(((device_base_t *)((unsigned int)LLD_PTR - sizeof(device_base_t)))->indx))
