...
/*!
  ...
  */
#define VBI_INSERTION_CC                ((mt_u32)1 << 0)
/*!
  bit field of WWS
  */
#define VBI_INSERTION_WSS               ((mt_u32)1 << 1)
/*!
  bit field of Teletext
  */
#define VBI_INSERTION_TTX               ((mt_u32)1 << 2)
/*!
  bit field of VPS
  */
#define VBI_INSERTION_VPS               ((mt_u32)1 << 3)
/*!
  bit field of ATSC
  */
#define VBI_INSERTION_ATSC               ((mt_u32)1 << 4)
/*!
  bit field of software closed caption
  */
#define VBI_INSERTION_CC_SW              ((mt_u32)1<<5)
/*!
  bit field of software Teletext
  */
#define VBI_INSERTION_TTX_SW              ((mt_u32)1<<6)

/*!
  bit field of all VBI function
  */
#define VBI_ALL_INSERTION               ((mt_u32)0x7f)
...
typedef struct
{
    /*!
      ...
      */
    mt_u32 vbi_pes_buf_addr;
    /*!
      vbi buf size, for concerto
      */
    mt_u32 vbi_pes_buf_size;
}vbi_cfg_t;
...
/*!
   ...
   \return
  */
void vbi_inserter_fifo_init(vbi_fifo_t *p_fifo, mt_u8 *p_buf, mt_u32 buf_size);
...
/*!
  ...
  */
MT_BOOL vbi_inserter_fifo_put(vbi_fifo_t *p_fifo, mt_u8 *p_data, mt_u8 size);
...
/*!
   ...
   \return  TRUE for success
  */
MT_BOOL vbi_inserter_fifo_get(vbi_fifo_t *p_fifo, mt_u8 *p_data_buf);
...
/*!
   ...
   \return
  */
MT_BOOL vbi_inserter_fifo_is_critical(vbi_fifo_t *p_fifo);
...
/*!
   ...
   \return Return 0 for success and others for failure.
  */
mt_s32 vbi_inserter_dev_set_vid_std(vbi_inserter_device_t *p_dev, video_std_t std);
...
/*!
   ...
   \return Return 0 for success and others for failure.
  */
mt_s32 vbi_inserter_dev_inserte_data(vbi_inserter_device_t *p_dev, mt_u32 pts, mt_u8 *p_pes_data_filed, mt_u8 *p_pes_last_byte);
