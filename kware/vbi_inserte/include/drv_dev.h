...
typedef struct
{
  /*!
    ...
    */
  mt_u32 media_i[MEDIA_TYPE_NUM >> 5];
  /*!
      Device output media type bit mask
    */
  mt_u32 media_o[MEDIA_TYPE_NUM >> 5];
}dev_media_cap_t;
...
/*!
  ...
  */
typedef mt_s32 (*dev_string_push_cb_t)(void *p_dev, mt_u8 ipin_id, struct meml_buf *p_lbuf);
...
typedef enum
{
  ...
  /*!
      Command for get the err packet cnt
    */
  DEV_IOCTRL_GET_ERR_PACKET_CNT,
}dev_ioctrl_cmd_t;
...
/*!
  ...
  */
void *dev_find_identifier(void *p_sdev, int ident_type, mt_u32 ident);
...
/*!
  ...
  \return Return non-NULL for the device handle if success and NULL if failure.
  */
void *dev_allocate(const char *p_name, mt_u16 type, mt_u32 dev_size, mt_u32 priv_size);
...
/*!
  ...
  \return void
  */
void dev_set_state(void *p_dev, mt_u8 state);
...
/*!
  ...
  */
mt_u8 dev_get_state(void *p_dev);
...
/*!
  ...
  */
mt_s32 dev_open(void *p_dev, void *p_param);
...
/*!
  ...
  \return Return 0 for success and others for failure.
  */
mt_s32 dev_io_ctrl(void *p_dev, mt_u32 cmd, mt_u32 param);
...
/*!
  ...
  */
mt_s32 drv_check_cond(void *p_dev);
...
/*!
  ...
  */
extern mt_s32 dev_stream_media_enable(void *p_dev, dev_media_cap_t *p_media_cap);
...
/*!
  ...
  \Return The operation success or not.
  */
extern mt_s32 dev_stream_src_link(void *p_dev, mt_u32 media,
  dev_string_push_cb_t *p_push_cb, mt_u8 *p_ipin_id);
...
/*!
  ...
  \Return The operation success or not.
  */
extern mt_s32 dev_stream_src_unlink(void *p_dev, mt_u8 ipin_id);
...
/*!
  ...
  */
extern mt_s32 dev_stream_dst_link(void *p_dev, mt_u32 media,
  dev_string_push_cb_t push_cb, mt_u8 *p_opin_id);
...
/*!
  ...
  \Return The operation success or not.
  */
extern mt_s32 dev_stream_dst_unlink(void *p_dev, mt_u8 opin_id);
...
/*!
  ...
  \Return The operation success or not.
  */
extern mt_s32 dev_stream_bridge_append(dev_stream_bridge_t *p_bridge);
...
/*!
  ...
  \Return The operation success or not.
  */
extern mt_s32 dev_stream_bridge_remove(dev_stream_bridge_t *p_bridge);
...
/*!
  ...
  \Return The operation success or not.
  */
extern mt_s32 dev_stream_chain_create(dev_stream_bridge_t *p_chain_header, mt_u16 len);
...
/*!
  ...
  \Return The operation success or not.
  */
extern mt_s32 dev_stream_chain_destroy(dev_stream_bridge_t *p_chain_header, mt_u16 len);
...
/*!
  ...
  \Return The operation success or not.
  */
extern mt_s32 dev_stream_opin_get(void *p_dev, mt_u8 opin_id, dev_output_pin_t *p_opin_info);
