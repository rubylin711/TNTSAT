...
void * ts_seq_init(u8 *p_fifo, u32 fifo_size,
                  MT_BOOL isForward, u8 *p_buf, u32 buffer_size);
...
/*!
  ...
  */
void ts_seq_reset_play_direction(void * pHandle , MT_BOOL isForward , video_codec_type_t type);
/*!
  select a parser
  */
