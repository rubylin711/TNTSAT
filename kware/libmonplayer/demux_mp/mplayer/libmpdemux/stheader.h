...
#define SH_COMMON \
  ...
  int default_track; \
  unsigned char *codec_extradata; /* extra header data passed from demuxer */ \
...
typedef struct sh_video {
  ...
  m_rational_t fps;              // frames per second (set only if constant fps)
  ...
  sh_h264header_t sh;
  MT_UNF_VIDEO_DISP_HDR_INFO_S hdr;
