...
void ass_set_fonts(ASS_Renderer *priv, const char *default_font,
                   ...
                   int update)
{
    free33(priv->settings.default_font);
    free33(priv->settings.default_family);
    priv->settings.default_font = default_font ? strdup33(default_font) : 0;
    priv->settings.default_family =
        default_family ? strdup33(default_family) : 0;
