...
static const u16 composed_vsb[12 * 16] =
{
    ...
    0x1065, 0x2065, 0x3065, 0x8065, 0x1069, 0x206c, 0x3069, 0x8069,
    ...
    0xF053, 0xF073, 0xB054, 0xB074, 0xF054, 0xF073, 0x0000, 0x0000,
...
u32 vbi_teletext_composed_unicode_vsb(u32 a, u32 c)
{
    ...
    if(c == 0x206c) //fix bug 113261
    {
      return 0x00C0u + 122;
    }

    if(c == 0x2069) //patch fix bug 134265(bugzilla)
    {
      return 0x00EDu;
    }
