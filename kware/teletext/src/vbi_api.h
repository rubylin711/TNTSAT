...
RET_CODE vbi_pes_parse_vsb(unsigned char *p_pes_pkt);
...
/*!
   Set the language_code of VBI PES

   \param[in] language_code
...
/*!
    set vbi's current pid in parameter
*/
RET_CODE vbi_set_current_pid_vsb(u16 *pid);
/*!
    set ttx/ttx-subt page draw mode
    draw_mode : 0,character draw one bye one 
    draw_mode : 1,character draw whole page.     
*/
void vbi_set_ttx_page_draw_mode(u8 draw_mode);

/*!
    get ttx/ttx-subt page draw mode 
*/
