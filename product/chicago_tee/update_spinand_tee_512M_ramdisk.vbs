...
Sub Main
	...
	If InStr(receivedData, "DDR4") > 0  Then
		...
		crt.Screen.Send "fatload usb 0 0x04000000 "&imageDir&"/CHIP_OF/OTP_FTA_TEE/symphony6_pkg_ddr4_2133_2DCDCxHz_spi_nand_tee_all.img" & chr(13)
	Else
		crt.Screen.Send "echo DDR3" & chr(13)
		crt.Screen.Send "fatload usb 0 0x04000000 "&imageDir&"/CHIP_OF/OTP_FTA_TEE/symphony6_pkg_ddr3_1866_2DCDCxHz_spi_nand_tee_all.img" & chr(13)
	End If
	...
	crt.Screen.Send "fatload usb 0 0x04000000 "&imageDir&"/uboot_symphony_demo_unified_512M.scr" & chr(13)
	crt.Screen.WaitForString "bytes read"
	crt.Sleep 100
	...
	If InStr(receivedData, "128") > 0  Then
		...
		crt.Screen.Send "snf erase 0x1E00000 0x200000" & chr(13)
		crt.Screen.WaitForString "snf erase successfully"
		crt.Sleep 100
		crt.Screen.Send "snf burn 0x04000000 0x1E00000 $filesize" & chr(13)
		crt.Screen.WaitForString "snf burn successfully"
		crt.Sleep 100
		...
		crt.Screen.Send "snf erase 0x2000000 0x1000000" & chr(13)
		crt.Screen.WaitForString "snf erase successfully"
		crt.Sleep 100
		crt.Screen.Send "snf burn 0x04000000 0x2000000 $filesize" & chr(13)
		crt.Screen.WaitForString "snf burn successfully"
		crt.Sleep 100

		'rootfs: 24M (48-72)
		crt.Screen.Send "fatload usb 0 0x04000000 "&imageDir&"/rootfs.squashfs" & chr(13)
		crt.Screen.WaitForString "bytes read"
		crt.Sleep 100

		crt.Screen.Send "snf erase 0x3000000 0x1800000" & chr(13)
		crt.Screen.WaitForString "snf erase successfully"
		crt.Sleep 100
		...
		'usrfs: 46M (72-118)
		crt.Screen.Send "fatload usb 0 0x04000000 "&imageDir&"/usrfs.bin" & chr(13)
		crt.Screen.WaitForString "bytes read"
		crt.Sleep 100
