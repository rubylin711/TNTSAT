...
Sub Main
	...
	Else
		...
		crt.Screen.Send "fatload usb 0 0x04000000 "&imageDir&"/CHIP_OF/OTP_FTA_TEE/symphony6_pkg_ddr3_1066_2DCDCxHz_spi_nand_tee_all.img" & chr(13)
	End If
	...
	If InStr(receivedData, "128") > 0  Then
		...
		'dtb: 2M (30-32)
		crt.Screen.Send "fatload usb 0 0x04000000 "&imageDir&"/symphony6-rawnand-ciplus.dtb" & chr(13)
		crt.Screen.WaitForString "bytes read"
		crt.Sleep 100
