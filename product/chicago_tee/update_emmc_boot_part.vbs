...
Sub Main
	...
	If InStr(receivedData, "DDR4") > 0  Then
		...
		' fta otp
		crt.Screen.Send "fatload usb 0 0x03000000 "&imageDir&"/CHIP_OF/OTP_FTA_TEE/symphony6_pkg_ddr4_2133_2DCDCxHz_emmc_tee_all.img" & chr(13)
	Else
		crt.Screen.Send "echo DDR3" & chr(13)
		' fta otp
		crt.Screen.Send "fatload usb 0 0x03000000 "&imageDir&"/CHIP_OF/OTP_FTA_TEE/symphony6_pkg_ddr3_1866_2DCDCxHz_emmc_tee_all.img" & chr(13)
	End If
