...
ifeq ($(CONFIG_MT_GSTPLAYER_ENABLE),y)
	include ${SDK_DIR}/image/$(MFRS)/usrfs_gstreamer.mk
endif
...
ifeq ($(CONFIG_MT_USB3G_SUPPORT),y)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/drivers/usb/serial/usb_wwan.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/drivers/usb/serial/option.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/drivers/net/ppp/ppp_generic.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/drivers/net/slip/slhc.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(SDK_DIR)/image/$(MFRS)/rootfs/usr/sbin; ln -sf ../local/bin/chat ./chat; ln -sf ../local/bin/pppd ./pppd
	rm -rf $(SDK_DIR)/image/$(MFRS)/rootfs/etc/ppp/peers; mkdir -p $(SDK_DIR)/image/$(MFRS)/rootfs/etc/ppp/peers;
	ls -l $(SDK_DIR)/image/$(MFRS)/rootfs/etc/ppp/peers
	cp -arf $(BIN_DIR)/gprs-*dial $(SDK_DIR)/image/$(MFRS)/rootfs/etc/ppp/peers
endif
...
ifeq ($(CONFIG_MT_VPN_SUPPORT),y)
ifeq ($(CONFIG_MT_VPN_SUPPORT_OPENVPN),y)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/drivers/net/tun.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)	
endif
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv6/ipv6.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
ifeq ($(CONFIG_MT_VPN_IPSEC_ENABLE),y)
	#-cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/ipsec $(SDK_DIR)/image/$(MFRS)/rootfs/usr/lib/ -af
	-cd $(SDK_DIR)/image/$(MFRS)/rootfs/usr/lib; ln -sf ../local/lib/ipsec ./ipsec
	@-cp $(BUILDROOT_SYSROOT_DIR)/etc/strongswan.conf ${SDK_DIR}/image/$(MFRS)/rootfs/etc -af
	#IPV4
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv4/ah4.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv4/esp4.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv4/ipip.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv4/ip_tunnel.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv4/tunnel4.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv4/xfrm4_tunnel.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/xfrm/xfrm_algo.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/xfrm/xfrm_user.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/key/af_key.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	#IPV6
ifeq ($(CONFIG_MT_VPN_SUPPORT_IPV6),y)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv4/ah6.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv6/esp6.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)	
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv6/tunnel6.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv4/xfrm6_tunnel.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
endif#CONFIG_MT_VPN_SUPPORT_IPV6
endif#CONFIG_MT_VPN_IPSEC_ENABLE
ifeq ($(CONFIG_MT_VPN_SUPPORT_L2TP),y)
	-cd $(SDK_DIR)/image/$(MFRS)/rootfs/usr/sbin; ln -sf ../local/bin/chat ./chat; ln -sf ../local/bin/pppd ./pppd;
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/lib/crc-ccitt.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/drivers/net/slip/slhc.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)	
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/drivers/net/ppp/ppp_generic.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/drivers/net/ppp/pppox.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/drivers/net/ppp/ppp_async.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)	
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv6/ip6_udp_tunnel.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/ipv4/udp_tunnel.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/l2tp/l2tp_core.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	#-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/l2tp/l2tp_ip.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/l2tp/l2tp_netlink.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/l2tp/l2tp_ppp.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
endif
endif#CONFIG_MT_VPN_SUPPORT
ifeq ($(CONFIG_MT_VLAN_SUPPORT),y)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/8021q/8021q.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/802/mrp.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/802/garp.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/802/stp.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
	-cd $(MODULE_DIR_STRIPED)/lib/modules/$(CFG_MT_KERNEL_VERSION); cp --remove-destination -arf --parents kernel/net/llc/llc.ko ${SDK_DIR}/image/$(MFRS)/rootfs/lib/modules/$(CFG_MT_KERNEL_VERSION)
endif
...
usrfs:
	...
	@mkdir -p $(USR_FS_DIR)/stb/espeak-data
#
...
ifeq ($(CONFIG_MT_TEE_SUPPORT),y)
	#copy ta - no dolby
#when no dolby, don't copy ta file
	rm -f $(USR_FS_DIR)/lib/optee_armtz/ea38a79f-b962-487c-86d3-b3d1d94383f9.*
#	cp --remove-destination -f $(TEE_AUDIO_TA_DIR)/nodolby_nowma/fta/ea38a79f-b962-487c-86d3-b3d1d94383f9.* $(USR_FS_DIR)/lib/optee_armtz/
endif
...
ifeq ($(CONFIG_MT_USB3G_SUPPORT),y)
	-cp --remove-destination ${BIN_DIR_STRIPED}/sbin/chat $(USR_FS_DIR)/bin -af
	-cp --remove-destination ${BIN_DIR_STRIPED}/sbin/pppd $(USR_FS_DIR)/bin -af
	-cp --remove-destination ${SDK_DIR}/component/wifi/tools/libusb_modeswitch_ppp/usb_modeswitch.sh $(USR_FS_DIR)/bin
	-cp --remove-destination ${SDK_DIR}/component/wifi/tools/libusb_modeswitch_ppp/usb3g_ppp_dial/* $(USR_FS_DIR)/stb
	rm -rf $(SDK_DIR)/image/$(MFRS)/rootfs/etc/ppp/peers; #For rebuild
endif
...
ifneq (,$(findstring rtl88x2cs,$(BOARD_WIFI_MODULE)))
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/external-ko/88x2cs.ko $(USR_FS_DIR)/stb/external-ko
endif
...
ifneq (,$(findstring rtl88x2cu,$(BOARD_WIFI_MODULE)))
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/external-ko/88x2cu.ko $(USR_FS_DIR)/stb/external-ko
endif
...
ifneq (,$(findstring aic8800,$(BOARD_WIFI_MODULE)))
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/external-ko/aic8800_fdrv.ko $(USR_FS_DIR)/stb/external-ko
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/external-ko/aic_load_fw.ko $(USR_FS_DIR)/stb/external-ko
	#aic8800DC
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/firmware/aic8800DC $(USR_FS_DIR)/stb/fw
	#aic8800D80
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/firmware/aic8800D80 $(USR_FS_DIR)/stb/fw
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/firmware/fw_patch_table_8800d80_u02.bin $(USR_FS_DIR)/stb/fw
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/firmware/fw_adid_8800d80_u02.bin $(USR_FS_DIR)/stb/fw
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/firmware/fw_patch_8800d80_u02.bin $(USR_FS_DIR)/stb/fw
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/firmware/fw_patch_8800d80_u02_ext0.bin $(USR_FS_DIR)/stb/fw
	-cp --remove-destination -af $(MODULE_DIR_STRIPED)/firmware/fmacfw_8800d80_u02.bin $(USR_FS_DIR)/stb/fw
...
ifeq ($(CONFIG_MT_VPN_SUPPORT),y)
	-cp --remove-destination $(BIN_DIR_STRIPED)/bin/mt/vpn.sh $(USR_FS_DIR)/stb/ -af
ifeq ($(CONFIG_MT_VPN_SUPPORT_OPENVPN),y)
#install openvpn
	@echo "==> install openvpn to userfs"
	-cp --remove-destination -af $(BIN_DIR_STRIPED)/sbin/openvpn $(USR_FS_DIR)/bin -af
	-cp --remove-destination -af $(SHARED_LIB_DIR_STRIPED)/liblz4.so* $(USR_FS_DIR)/lib -af
	-cp --remove-destination -af $(SHARED_LIB_DIR_STRIPED)/liblzo2.so* $(USR_FS_DIR)/lib -af
endif
ifeq ($(CONFIG_MT_VPN_SUPPORT_L2TP),y)
	-cp --remove-destination $(BIN_DIR_STRIPED)/sbin/xl2tpd  $(USR_FS_DIR)/bin -af
	-cp --remove-destination ${BIN_DIR_STRIPED}/sbin/chat $(USR_FS_DIR)/bin -af
	-cp --remove-destination ${BIN_DIR_STRIPED}/sbin/pppd $(USR_FS_DIR)/bin -af
	#strongswan plugins for IPSec
ifeq ($(CONFIG_MT_VPN_IPSEC_ENABLE),y)
	#strongswan & xl2tp librarys
	-cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/ipsec $(USR_FS_DIR)/lib -af
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-attr.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-cmac.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-constraints.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-counters.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-drbg.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-led.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-pgp.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-pkcs1*.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-revocation.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-sshkey.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-xauth-generic.so -rf
	@-rm $(USR_FS_DIR)/lib/ipsec/plugins/libstrongswan-xcbc.so -rf

	-cp --remove-destination $(BIN_DIR_STRIPED)/bin/ipsec/charon $(USR_FS_DIR)/bin/ -af
	-cp --remove-destination $(BIN_DIR_STRIPED)/sbin/swanctl $(USR_FS_DIR)/bin/ -af
	-cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/libvici*.so* $(USR_FS_DIR)/lib -af
	-cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/libstrongswan*.so* $(USR_FS_DIR)/lib -af
	-cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/libcap*.so* $(USR_FS_DIR)/lib -af
	-cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/libcharon*.so* $(USR_FS_DIR)/lib -af
	-cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/libelf*.so* $(USR_FS_DIR)/lib -af
	-cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/libtls*.so* $(USR_FS_DIR)/lib -af
	#strongswan program
	mkdir -p $(USR_FS_DIR)/usr/libexec
	-cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/libtls*.so* $(USR_FS_DIR)/lib -af
endif

ifeq ($(CONFIG_MT_VPN_SUPPORT_IKEV2),y)
	echo "Not support IKEv2 yet!!"
endif
endif #BOARD_VPN_SUPPORT
endif #CONFIG_MT_VPN_SUPPORT
...
ifeq ($(BOARD_BLUEZ_SUPPORT),y)
	...
	-cp --remove-destination $(BIN_DIR)/bluez.conf $(USR_FS_DIR)/stb/bluez.conf -af
	-cp --remove-destination $(BIN_DIR)/bluetooth.sh $(USR_FS_DIR)/stb/bluetooth.sh -af
	-chmod +x $(USR_FS_DIR)/stb/bluetooth.sh
endif

ifeq ($(CONFIG_TEE_XTEST),y)
	-cp --remove-destination -af ${SDK_DIR}/tee/xtest/usr/bin/xtest ${USR_FS_DIR}/bin/
	-cp --remove-destination -af ${SDK_DIR}/tee/xtest/usr/local/lib/optee_armtz/* ${USR_FS_DIR}/lib/optee_armtz/
	-cp --remove-destination -af ${SDK_DIR}/tee/xtest/usr/local/lib/tee-supplicant/* ${USR_FS_DIR}/lib/tee-supplicant/
endif
	...
	@cp --remove-destination $(SHARED_LIB_DIR_STRIPED)/mt/libespeak.so $(USR_FS_DIR)/lib -af
	@cp --remove-destination $(MSP_DIR)/api/eaa/espeak-data/* $(USR_FS_DIR)/stb/espeak-data -af
#
...
ifneq ($(CONFIG_MT_VDEC_4K),y)
	sed -i 's|#vdec4k_dis=1|vdec4k_dis=1|g' $<
endif
...
ifeq ($(CONFIG_TEE_XTEST),y)
	cp --remove-destination -f ${SDK_DIR}/tee/xtest/image/teeos.bin ${SDK_DIR}/image/$(MFRS)/update/
endif
