...
DEPEND_LIBS := $(SYS_LIBS) $(MT_LIBS) -lmt_sample_common -lssl -lcrypto -lWorker -lteec -ltalts.nagrata-mps-reeworker.release.aarch64-none-linux-gnu-gcc -lmt_nocsapi_impl -lsmpc
#DEPEND_LIBS := $(SYS_LIBS) $(MT_LIBS) -lmt_sample_common -lssl -lcrypto -lWorker -lteec -ltalts.nagrata-mps-reeworker.release.aarch64-none-linux-gnu-gcc -lmt_nocsapi_impl 
