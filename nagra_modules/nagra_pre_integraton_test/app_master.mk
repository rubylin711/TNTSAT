...
DEPEND_LIBS := $(SYS_LIBS) $(MT_LIBS) -lmt_sample_common -lssl -lcrypto -lMaster -lteec -ltalts.nagrata-mps-ree.release.aarch64-none-linux-gnu-gcc -lmt_nocsapi_impl_talts -lsmpc
