...
CFG_MT_SAMPLE_CFLAGS+= -D_LARGEFILE_SOURCE
CFG_MT_SAMPLE_CFLAGS+= -D_FILE_OFFSET_BITS=64
CFG_MT_SAMPLE_CFLAGS+= -D_LARGEFILE64_SOURCE
...
TEEC_LIBS := -lteec -lsmpc

NOCSAPI_LIB := -lmt_nocsapi_impl
...
MT_LIBS += -lpng
ifeq ($(CFG_MT_CHIP),symphony4 symphony6)
MT_LIBS += -lmt_png
endif
