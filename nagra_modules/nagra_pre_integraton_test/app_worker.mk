...
DEPEND_LIBS := $(SYS_LIBS) $(MT_LIBS) -lmt_sample_common -lssl -lcrypto -lWorker -lteec -ltalts.nagrata-mps-reeworker.release.aarch64-none-linux-gnu-gcc -lmt_nocsapi_impl_talts -lsmpc
#DEPEND_LIBS := $(SYS_LIBS) $(MT_LIBS) -lmt_sample_common -lssl -lcrypto -lWorker -lteec -ltalts.nagrata-mps-reeworker.release.aarch64-none-linux-gnu-gcc -lmt_nocsapi_impl_talts 
...
DEPEND_LIBS_PATH += -L$(SDK_DIR)/nagra_modules/nagra_pre_integraton_test/prebuilt_libs/libs_talts
DEPEND_LIBS_PATH += -L$(SDK_DIR)/nagra_modules/nagra_pre_integraton_test/prebuilt_libs/libs_simbad

APP = nagra_talts_worker
